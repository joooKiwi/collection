...
|-----------------------------------------------------------------------------|---------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [1.5.0](https://github.com/joooKiwi/collection/releases/tag/v1.5.0-js)      | September 28, 2023  | The `RangeError` and `ReferenceError` has been changed to custom exceptions<br/>The [lazy](https://github.com/joookiwi/lazy) dependency has been updated from 1.1.0 to 1.2.0                                                                                                           |
