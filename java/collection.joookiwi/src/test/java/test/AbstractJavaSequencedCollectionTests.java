...
@NotNullByDefault
public abstract class AbstractJavaSequencedCollectionTests {
    ...
    public <T extends @Nullable Object> SequencedCollection<T> newInstance(final T @Unmodifiable [] values) {
        try {
            return (SequencedCollection<T>) instanceClass.getConstructor(Object[].class).newInstance((Object) values);
