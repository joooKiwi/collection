...
/// A class to exclusively test the extension methods for a `null` `array`
///
/// @param <T> The type
@NotNullByDefault
public final class CollectionHolder_FromNullArrayExtensionFunction<T extends @Nullable Object>
        extends AbstractNullCollectionHolderForTest<T, T @Unmodifiable [], CollectionHolder_FromNullArrayExtensionFunction<T>> {
    ...
    public static final String SIMPLIFIED_NAME = Types.NULL_ARRAY_EXTENSION;

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public CollectionHolder_FromNullArrayExtensionFunction() { super(); }
    ...
    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEach(final ObjIntConsumer<? super T> action) {
        OnEach.onEach(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEach(final Consumer<? super T> action) {
        OnEach.onEach(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEach(final Runnable action) {
        OnEach.onEach(instance, action);
        return this;
    }


    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEachIndexed(final IntObjConsumer<? super T> action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEachIndexed(final IntConsumer action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullArrayExtensionFunction<T> onEachIndexed(final Runnable action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }
