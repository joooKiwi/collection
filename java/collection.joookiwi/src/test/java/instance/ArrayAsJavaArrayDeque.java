...
/// A Java [ArrayDeque] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaArrayDeque<T>
        extends ArrayDeque<T> {

    @Serial private static final long serialVersionUID = 1974097567125320926L;
    public final T[] array;
    public @Nullable ArrayDeque<T> reference;

    public ArrayAsJavaArrayDeque(final T[] array) {
        super();
        this.array = array;
    }
    ...
    public ArrayDeque<T> get() {
        ...
        if (value != null)
            return value;
        return reference = new ArrayDeque<>(Arrays.asList(array));
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaArrayDeque<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
