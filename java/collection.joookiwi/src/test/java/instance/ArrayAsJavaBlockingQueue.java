...
/// A Java [BlockingQueue] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaBlockingQueue<T>
        implements BlockingQueue<T> {

    public final T[] array;
    public @Nullable BlockingQueue<T> reference;

    public ArrayAsJavaBlockingQueue(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaBlockingQueue<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
