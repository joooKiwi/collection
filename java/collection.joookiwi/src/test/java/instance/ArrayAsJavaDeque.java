...
/// A Java [Deque] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaDeque<T extends @Nullable Object>
        implements Deque<T> {

    public final T[] array;
    public @Nullable Deque<T> reference;

    public ArrayAsJavaDeque(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaDeque<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
