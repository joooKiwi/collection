...
/// A Java [BlockingDeque] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaBlockingDeque<T>
        implements BlockingDeque<T> {

    public final T[] array;
    public @Nullable BlockingDeque<T> reference;

    public ArrayAsJavaBlockingDeque(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaBlockingDeque<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
