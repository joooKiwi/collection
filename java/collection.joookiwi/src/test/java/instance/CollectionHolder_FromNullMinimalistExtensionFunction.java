...
/// A class to exclusively test the extension methods for a `null`  [MinimalistCollectionHolder]
///
/// @param <T> The type
@NotNullByDefault
public final class CollectionHolder_FromNullMinimalistExtensionFunction<T extends @Nullable Object>
        extends AbstractNullCollectionHolderForTest<T, MinimalistCollectionHolder<T>, CollectionHolder_FromNullMinimalistExtensionFunction<T>> {
    ...
    public static final String SIMPLIFIED_NAME = Types.NULL_MINIMALIST_EXTENSION;

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public CollectionHolder_FromNullMinimalistExtensionFunction() { super(); }
    ...
    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEach(final ObjIntConsumer<? super T> action) {
        OnEach.onEach(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEach(final Consumer<? super T> action) {
        OnEach.onEach(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEach(final Runnable action) {
        OnEach.onEach(instance, action);
        return this;
    }


    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEachIndexed(final IntObjConsumer<? super T> action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEachIndexed(final IntConsumer action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public CollectionHolder_FromNullMinimalistExtensionFunction<T> onEachIndexed(final Runnable action) {
        OnEachIndexed.onEachIndexed(instance, action);
        return this;
    }
