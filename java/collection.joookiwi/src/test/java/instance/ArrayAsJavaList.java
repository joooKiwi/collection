...
/// A Java [List] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaList<T extends @Nullable Object>
        implements List<T> {

    public final T[] array;
    public @Nullable List<T> reference;

    public ArrayAsJavaList(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaList<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
