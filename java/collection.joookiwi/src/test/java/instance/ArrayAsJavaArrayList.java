...
/// A Java [ArrayList] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaArrayList<T extends @Nullable Object>
        extends ArrayList<T> {

    @Serial private static final long serialVersionUID = 4291486043919057109L;
    public final T[] array;
    public @Nullable ArrayList<T> reference;

    public ArrayAsJavaArrayList(final T[] array) {
        super();
        this.array = array;
    }
    ...
    public ArrayList<T> get() {
        ...
        if (value != null)
            return value;
        return reference = new ArrayList<>(Arrays.asList(array));
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaArrayList<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
