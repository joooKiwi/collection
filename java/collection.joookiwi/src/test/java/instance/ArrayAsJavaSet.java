...
/// A Java [Set] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaSet<T extends @Nullable Object>
        implements Set<T> {

    public final T[] array;
    public @Nullable Set<T> reference;

    public ArrayAsJavaSet(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaSet<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
