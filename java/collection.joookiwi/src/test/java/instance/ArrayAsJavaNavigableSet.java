...
/// A Java [NavigableSet] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaNavigableSet<T extends @Nullable Object>
        implements NavigableSet<T> {

    public final T[] array;
    public @Nullable NavigableSet<T> reference;

    public ArrayAsJavaNavigableSet(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaNavigableSet<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
