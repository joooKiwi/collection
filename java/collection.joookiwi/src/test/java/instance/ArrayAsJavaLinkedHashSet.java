...
/// A Java [LinkedHashSet] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaLinkedHashSet<T extends @Nullable Object>
        extends LinkedHashSet<T> {

    @Serial private static final long serialVersionUID = -6178993377998368458L;
    public final T[] array;
    public @Nullable LinkedHashSet<T> reference;

    public ArrayAsJavaLinkedHashSet(final T[] array) {
        super();
        this.array = array;
    }
    ...
    public LinkedHashSet<T> get() {
        ...
        if (value != null)
            return value;
        return reference = new LinkedHashSet<>(Arrays.asList(array));
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaLinkedHashSet<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
