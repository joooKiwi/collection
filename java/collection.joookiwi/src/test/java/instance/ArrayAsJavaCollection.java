...
/// A Java [Collection] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaCollection<T extends @Nullable Object>
        implements Collection<T> {

    public final T[] array;
    public @Nullable Collection<T> reference;

    public ArrayAsJavaCollection(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaCollection<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
