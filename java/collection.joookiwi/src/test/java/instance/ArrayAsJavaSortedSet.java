...
/// A Java [SortedSet] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaSortedSet<T extends @Nullable Object>
        implements SortedSet<T> {

    public final T[] array;
    public @Nullable SortedSet<T> reference;

    public ArrayAsJavaSortedSet(final T[] array) {
        super();
        this.array = array;
    }
    ...
    @Override public SortedSet<T> reversed() { return get().reversed(); }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaSortedSet<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
