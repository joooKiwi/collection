...
/// A Java [LinkedList] adaptor class from an array
///
/// @param <T> The type
@NotNullByDefault
public final class ArrayAsJavaLinkedList<T extends @Nullable Object>
        extends LinkedList<T> {

    @Serial private static final long serialVersionUID = 4291486043919057109L;
    public final T[] array;
    public @Nullable LinkedList<T> reference;

    public ArrayAsJavaLinkedList(final T[] array) {
        super();
        this.array = array;
    }
    ...
    public LinkedList<T> get() {
        ...
        if (value != null)
            return value;
        return reference = new LinkedList<>(Arrays.asList(array));
    }
    ...
    @Override public LinkedList<T> reversed() { return get().reversed(); }
    ...
    @Contract(ALWAYS_FAIL_0) @Override public ArrayAsJavaLinkedList<T> clone() { throw new RuntimeException("The method “clone” was not expected to be called in a test."); }
