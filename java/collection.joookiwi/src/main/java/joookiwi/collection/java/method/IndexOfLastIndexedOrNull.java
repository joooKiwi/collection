...
public final class IndexOfLastIndexedOrNull
    ...
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfLastIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfLastIndexedOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                  final @NotNull IntObjPredicate<? super T> predicate) {
        if (collection == null)
            return null;
        return __core(collection, predicate);
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfLastIndexedOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                                  final @NotNull IntObjPredicate<? super T> predicate) {
        if (collection == null)
            return null;
        return __core(collection, predicate);
