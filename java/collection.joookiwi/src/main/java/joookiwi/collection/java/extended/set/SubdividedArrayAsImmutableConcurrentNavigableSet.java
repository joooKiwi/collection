...
/// An implementation of a subdivided-[ImmutableConcurrentNavigableSet] similar to the [ArrayAsImmutableConcurrentNavigableSet] in its behaviour.
...
///                           (generally a [ArrayAsImmutableConcurrentNavigableSet], [SubdividedArrayAsImmutableConcurrentNavigableSet] or [ReversedArrayAsImmutableConcurrentNavigableSet])
/// @param <SUBDIVIDED_ARRAY> The array that should contain the new reference
/// @see ArrayAsImmutableConcurrentNavigableSet
/// @see ReversedArrayAsImmutableConcurrentNavigableSet
@NotNullByDefault
public class SubdividedArrayAsImmutableConcurrentNavigableSet<T extends @Nullable Object,
        SOURCE extends ImmutableConcurrentNavigableSet<? super T>,
        SUBDIVIDED_ARRAY extends SubdividedArray<? extends T>>
        extends AbstractArrayAsImmutableConcurrentNavigableSet<T> {
    ...
    public SubdividedArrayAsImmutableConcurrentNavigableSet(final SOURCE source,
    ...
    @Override public SubdividedArrayAsImmutableConcurrentNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY> clone() { return (SubdividedArrayAsImmutableConcurrentNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY>) super.clone(); }
