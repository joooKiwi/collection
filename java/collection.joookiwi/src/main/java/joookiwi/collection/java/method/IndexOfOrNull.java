...
public final class IndexOfOrNull
    ...
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                       final T element) { return FirstIndexOfOrNull.firstIndexOfOrNull(collection, element); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T> @Range(from = 0, to = MAX_VALUE) @Nullable Integer indexOfOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                       final T element) { return FirstIndexOfOrNull.firstIndexOfOrNull(collection, element); }
