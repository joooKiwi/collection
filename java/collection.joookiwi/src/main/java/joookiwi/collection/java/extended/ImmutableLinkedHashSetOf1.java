...
@NotNullByDefault
public class ImmutableLinkedHashSetOf1<T extends @Nullable Object>
        extends ImmutableLinkedHashSet<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = -1273207110917128113L;
    ...
    public ImmutableLinkedHashSetOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_THIS_0) @Override public ImmutableLinkedHashSetOf1<T> reversed() { return this; }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableLinkedHashSetOf1<T> clone() {
        return (ImmutableLinkedHashSetOf1<T>) super.clone();
    }
