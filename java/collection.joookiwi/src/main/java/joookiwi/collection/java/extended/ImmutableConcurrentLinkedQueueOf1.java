...
@NotNullByDefault
public class ImmutableConcurrentLinkedQueueOf1<T>
        extends ImmutableConcurrentLinkedQueue<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = 1734869346127147903L;
    ...
    public ImmutableConcurrentLinkedQueueOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableConcurrentLinkedQueueOf1<T> clone() {
        return (ImmutableConcurrentLinkedQueueOf1<T>) super.clone();
    }
