...
/// An implementation of a subdivided-[MutableConcurrentNavigableSet] similar to the [ArrayAsMutableConcurrentNavigableSet] in its behaviour.
...
@NotNullByDefault
public class SubdividedArrayAsMutableConcurrentNavigableSet<T extends @Nullable Object,
    ...
    public SubdividedArrayAsMutableConcurrentNavigableSet(final SOURCE source,
    ...
    @Override public SubdividedArrayAsMutableConcurrentNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY> clone() { return (SubdividedArrayAsMutableConcurrentNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY>) super.clone(); }
