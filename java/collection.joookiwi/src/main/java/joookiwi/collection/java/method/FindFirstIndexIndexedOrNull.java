...
@NotNullByDefault
public final class FindFirstIndexIndexedOrNull
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindFirstIndexIndexedOrNull() { throw new ImpossibleConstructionException("The utility class “FindFirstIndexIndexedOrNull” cannot be constructed.", FindFirstIndexIndexedOrNull.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final IntPredicate predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final BooleanSupplier predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  ...
                                                                                                                                  final int from) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate,
                                                                                                                                  final @Nullable Integer from) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate,
                                                                                                                                  final int from,
                                                                                                                                  final int to) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate, from, to); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findFirstIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                                                  final IntObjPredicate<? super T> predicate,
                                                                                                                                  final int from,
                                                                                                                                  final @Nullable Integer to) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate, from, to); }
