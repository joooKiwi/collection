...
import joookiwi.collection.java.callback.OptionalSupplier;
import joookiwi.collection.java.callback.TupleSupplier;
...
/// An instance of [CollectionHolder] with only 3 possible inner-collection.
/// The first as [EmptyCollectionHolder], the second as [CollectionHolderOf1] and the third as [CollectionHolderOf2].
/// Plus, the inner-collection is lazily retrieved.
///
/// @param <T> The type
@NotNullByDefault
public class LazyCollectionHolderOf0Or1Or2<T extends @Nullable Object>
        extends AbstractUnimplementedCollectionHolder<T>
        implements ClassWith2Values<T, T, T> {
    ...
    private Supplier<? extends @Nullable Couple<? extends Optional<? extends T>, ? extends Optional<? extends T>, ? extends Optional<? extends T>>> __latePossibleValue;
    ...
    public LazyCollectionHolderOf0Or1Or2(final Supplier<? extends java.util.@Nullable Optional<? extends Couple<? extends java.util.Optional<? extends T>, ? extends java.util.Optional<? extends T>, ? extends java.util.Optional<? extends T>>>> latePossibleValue) {
        super();
        // README: We just re-encapsulate into the framework "Couple?" instead of the java.util.Optional
        __latePossibleValue = () -> {
            final var possibleValue = latePossibleValue.get();
            if (possibleValue == null)
                return null;
            if (possibleValue.isEmpty())
                return null;

            final var couple = possibleValue.get();
            final var value1 = couple.value1();
            final var value2 = couple.value2();
            if (value1.isEmpty())
                if (value2.isEmpty())
                    return null;
                else
                    return new Couple<>(new Optional<>(value2.get()), EmptyOptional.getInstance());
            if (value2.isEmpty())
                return new Couple<>(new Optional<>(value1.get()), EmptyOptional.getInstance());
            return new Couple<>(new Optional<>(value1.get()), new Optional<>(value2.get()));
        };
    }

    public LazyCollectionHolderOf0Or1Or2(final OptionalSupplier<? extends @Nullable Optional<? extends Couple<? extends Optional<? extends T>, ? extends Optional<? extends T>, ? extends Optional<? extends T>>>> latePossibleValue) {
        super();
    ...
    public LazyCollectionHolderOf0Or1Or2(final TupleSupplier<? extends @Nullable Couple<? extends Optional<? extends T>, ? extends Optional<? extends T>, ? extends Optional<? extends T>>> latePossibleValue) {
        super();
    ...
    ///
    /// @return Either [EmptyCollectionHolder], [CollectionHolderOf1] or [CollectionHolderOf2]
    ...
    protected CollectionHolder<T> _innerCollection() {
        ...
        __latePossibleValue = (Supplier<? extends Couple<? extends Optional<? extends T>, ? extends Optional<? extends T>, ? extends Optional<? extends T>>>) FAIL_CALLBACK; // We do not need the callback anymore once the value has been retrieved
        if (couple == null)
        ...
        if (value1.isEmpty())
            if (value2.isEmpty())
                return __innerCollection = EmptyCollectionHolder.getInstance(); // Even though not efficient, it is still possible
            else
                return __innerCollection = new CollectionHolderOf1<>(value2.get());
        if (value2.isEmpty())
            return __innerCollection = new CollectionHolderOf1<>(value1.get());
        return __innerCollection = new CollectionHolderOf2<>(value1.get(), value2.get());
    }

    @Override public T value1() {
        ...
        return __value1 = innerCollection.getFirst();
    }

    @Override public T value2() {
        if (__isValue2Initialized)
            return __value2;

        final var innerCollection = _innerCollection();
        if (innerCollection.isEmpty())
            throw new IndexOutOfBoundsException("The inner collection received in the “" + getClass().getSimpleName() + "” does not have an existing value.", 1);
        if (innerCollection.hasExactly1Element())
            throw new IndexOutOfBoundsException("The inner collection received in the “" + getClass().getSimpleName() + "” does not have an existing second value.", 1);
        __isValue2Initialized = true;
        return __value2 = innerCollection.getLast();
    }

    //#region -------------------- Size methods --------------------

    @Override public @Range(from = 0, to = 2) int size() { return _innerCollection().size(); }
    ...
    @Override public boolean hasAtMost1Element() { return _innerCollection().hasAtMost1Element(); }

    @Override public boolean hasAtLeast2Elements() { return _innerCollection().hasAtLeast2Elements(); }
    @Override public boolean hasExactly2Elements() { return _innerCollection().hasExactly2Elements(); }
    ...
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element                                                          ) { return _innerCollection().firstIndexOf(element); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final int               from                            ) { return _innerCollection().firstIndexOf(element, from); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final @Nullable Integer from                            ) { return _innerCollection().firstIndexOf(element, from); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final int               from, final int               to) { return _innerCollection().firstIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final int               from, final @Nullable Integer to) { return _innerCollection().firstIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final @Nullable Integer from, final int               to) { return _innerCollection().firstIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int firstIndexOf(final T element, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().firstIndexOf(element, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element                                                          ) { return _innerCollection().firstIndexOfOrNull(element); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final int               from                            ) { return _innerCollection().firstIndexOfOrNull(element, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final @Nullable Integer from                            ) { return _innerCollection().firstIndexOfOrNull(element, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final int               from, final int               to) { return _innerCollection().firstIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final int               from, final @Nullable Integer to) { return _innerCollection().firstIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final @Nullable Integer from, final int               to) { return _innerCollection().firstIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer firstIndexOfOrNull(final T element, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().firstIndexOfOrNull(element, from, to); }

    //#endregion -------------------- First index --------------------
    //#region -------------------- Last index --------------------

    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element                                                          ) { return _innerCollection().lastIndexOf(element); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final int               from                            ) { return _innerCollection().lastIndexOf(element, from); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final @Nullable Integer from                            ) { return _innerCollection().lastIndexOf(element, from); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final int               from, final int               to) { return _innerCollection().lastIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final int               from, final @Nullable Integer to) { return _innerCollection().lastIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final @Nullable Integer from, final int               to) { return _innerCollection().lastIndexOf(element, from, to); }
    @Override public @Range(from = 0, to = 1) int lastIndexOf(final T element, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().lastIndexOf(element, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element                                                          ) { return _innerCollection().lastIndexOfOrNull(element); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final int               from                            ) { return _innerCollection().lastIndexOfOrNull(element, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final @Nullable Integer from                            ) { return _innerCollection().lastIndexOfOrNull(element, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final int               from, final int               to) { return _innerCollection().lastIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final int               from, final @Nullable Integer to) { return _innerCollection().lastIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final @Nullable Integer from, final int               to) { return _innerCollection().lastIndexOfOrNull(element, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer lastIndexOfOrNull(final T element, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().lastIndexOfOrNull(element, from, to); }

    //#endregion -------------------- Last index --------------------

    //#region -------------------- Index of first --------------------

    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfFirst(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate                                                          ) { return _innerCollection().indexOfFirst(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfFirst(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final int               from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirst(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final int               from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final Predicate<? super T>       predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirst(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirst(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfFirstOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate                                                          ) { return _innerCollection().indexOfFirstOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfFirstOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final int               from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstOrNull(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfFirstIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate                                                          ) { return _innerCollection().indexOfFirstIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfFirstIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final IntPredicate               predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfFirstIndexed(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexed(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate                                                          ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfFirstIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfFirstIndexedOrNull(predicate, from, to); }

    //#endregion -------------------- Index of first --------------------
    //#region -------------------- Index of last --------------------

    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfLast(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate                                                          ) { return _innerCollection().indexOfLast(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfLast(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final int               from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLast(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final int               from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final Predicate<? super T>       predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLast(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLast(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfLastOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate                                                          ) { return _innerCollection().indexOfLastOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfLastOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final int               from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final int               from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final ObjIntPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final Predicate<? super T>       predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastOrNull(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfLastIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate                                                          ) { return _innerCollection().indexOfLastIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfLastIndexed(predicate); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexed(predicate, from); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final IntPredicate               predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) int indexOfLastIndexed(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexed(predicate, from, to); }

    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate                                                          ) { return _innerCollection().indexOfLastIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate                                                          ) { return _innerCollection().indexOfLastIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate                                                          ) { return _innerCollection().indexOfLastIndexedOrNull(predicate); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final int               from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from                            ) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final int               from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final int               from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final int               to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntObjPredicate<? super T> predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final IntPredicate               predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    @Override public @Range(from = 0, to = 1) @Nullable Integer indexOfLastIndexedOrNull(final BooleanSupplier            predicate, final @Nullable Integer from, final @Nullable Integer to) { return _innerCollection().indexOfLastIndexedOrNull(predicate, from, to); }
    ...
    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEach(final ObjIntConsumer<? super T> action) {
        _innerCollection().forEach(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEach(final Consumer<? super T> action) {
        _innerCollection().forEach(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEach(final Runnable action) {
        _innerCollection().forEach(action);
        return this;
    }


    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEachIndexed(final IntObjConsumer<? super T> action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEachIndexed(final IntConsumer action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf0Or1Or2<T> onEachIndexed(final Runnable action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }
    ...
    @Override public                              ImmutableSortedCollection<T> toSortedCollection(                                                      ) { return _innerCollection().toSortedCollection(); }
    @Override public <U extends @Nullable Object> ImmutableSortedCollection<U> toSortedCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toSortedCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableSortedCollection<U> toSortedCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toSortedCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableSortedCollection<U> toSortedCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toSortedCollection(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public                              MutableSortedCollection<T> toMutableSortedCollection(                                                      ) { return _innerCollection().toMutableSortedCollection(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableSortedCollection<U> toMutableSortedCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableSortedCollection(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableSortedCollection<U> toMutableSortedCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toMutableSortedCollection(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableSortedCollection<U> toMutableSortedCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toMutableSortedCollection(transform); }

    //#endregion -------------------- To sorted collection --------------------
    //#region -------------------- To navigable collection --------------------

    @Override public                              ImmutableNavigableCollection<T> toNavigableCollection(                                                      ) { return _innerCollection().toNavigableCollection(); }
    @Override public <U extends @Nullable Object> ImmutableNavigableCollection<U> toNavigableCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toNavigableCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableNavigableCollection<U> toNavigableCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toNavigableCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableNavigableCollection<U> toNavigableCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toNavigableCollection(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public                              MutableNavigableCollection<T> toMutableNavigableCollection(                                                      ) { return _innerCollection().toMutableNavigableCollection(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableNavigableCollection<U> toMutableNavigableCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableNavigableCollection(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableNavigableCollection<U> toMutableNavigableCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toMutableNavigableCollection(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableNavigableCollection<U> toMutableNavigableCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toMutableNavigableCollection(transform); }

    //#endregion -------------------- To navigable collection --------------------
    //#region -------------------- To concurrent collection --------------------

    @Override public ImmutableConcurrentCollection<T> toConcurrentCollection(                                                      ) { return _innerCollection().toConcurrentCollection(); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentCollection<U> toConcurrentCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toConcurrentCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentCollection<U> toConcurrentCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toConcurrentCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentCollection<U> toConcurrentCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toConcurrentCollection(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public MutableConcurrentCollection<T> toMutableConcurrentCollection(                                                      ) { return _innerCollection().toMutableConcurrentCollection(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentCollection<U> toMutableConcurrentCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableConcurrentCollection(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentCollection<U> toMutableConcurrentCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toMutableConcurrentCollection(transform); }
    ...
    @Override public <U extends @Nullable Object> ImmutableConcurrentNavigableCollection<U> toConcurrentNavigableCollection(final Function<? super T, ? extends U>       transform) { return _innerCollection().toConcurrentNavigableCollection(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentNavigableCollection<U> toConcurrentNavigableCollection(final Supplier<? extends U>                  transform) { return _innerCollection().toConcurrentNavigableCollection(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public MutableConcurrentNavigableCollection<T> toMutableConcurrentNavigableCollection(                                                      ) { return _innerCollection().toMutableConcurrentNavigableCollection(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentNavigableCollection<U> toMutableConcurrentNavigableCollection(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableConcurrentNavigableCollection(transform); }
    ...
    @Override public ImmutableConcurrentSet<T> toConcurrentSet(                                                      ) { return _innerCollection().toConcurrentSet(); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentSet<U> toConcurrentSet(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toConcurrentSet(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentSet<U> toConcurrentSet(final Supplier<? extends U>                  transform) { return _innerCollection().toConcurrentSet(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentSet<U> toConcurrentSet(final Function<? super T, ? extends U>       transform) { return _innerCollection().toConcurrentSet(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public MutableConcurrentSet<T> toMutableConcurrentSet(                                                      ) { return _innerCollection().toMutableConcurrentSet(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentSet<U> toMutableConcurrentSet(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableConcurrentSet(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentSet<U> toMutableConcurrentSet(final Supplier<? extends U>                  transform) { return _innerCollection().toMutableConcurrentSet(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentSet<U> toMutableConcurrentSet(final Function<? super T, ? extends U>       transform) { return _innerCollection().toMutableConcurrentSet(transform); }

    //#endregion -------------------- To concurrent set --------------------
    //#region -------------------- To concurrent navigable set --------------------

    @Override public ImmutableConcurrentNavigableSet<T> toConcurrentNavigableSet(                                                      ) { return _innerCollection().toConcurrentNavigableSet(); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentNavigableSet<U> toConcurrentNavigableSet(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toConcurrentNavigableSet(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentNavigableSet<U> toConcurrentNavigableSet(final Supplier<? extends U>                  transform) { return _innerCollection().toConcurrentNavigableSet(transform); }
    @Override public <U extends @Nullable Object> ImmutableConcurrentNavigableSet<U> toConcurrentNavigableSet(final Function<? super T, ? extends U>       transform) { return _innerCollection().toConcurrentNavigableSet(transform); }

    @Contract(value = ALWAYS_NEW_0, pure = true) @Override public MutableConcurrentNavigableSet<T> toMutableConcurrentNavigableSet(                                                      ) { return _innerCollection().toMutableConcurrentNavigableSet(); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentNavigableSet<U> toMutableConcurrentNavigableSet(final ObjIntFunction<? super T, ? extends U> transform) { return _innerCollection().toMutableConcurrentNavigableSet(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentNavigableSet<U> toMutableConcurrentNavigableSet(final Supplier<? extends U>                  transform) { return _innerCollection().toMutableConcurrentNavigableSet(transform); }
    @Contract(value = ALWAYS_NEW_1, pure = true) @Override public <U extends @Nullable Object> MutableConcurrentNavigableSet<U> toMutableConcurrentNavigableSet(final Function<? super T, ? extends U>       transform) { return _innerCollection().toMutableConcurrentNavigableSet(transform); }
    ...
    @Override public ImmutableMap<Integer, T> toMap() { return _innerCollection().toMap(); }

    @Override public MutableMap<Integer, T> toMutableMap() { return _innerCollection().toMutableMap(); }

    //#endregion -------------------- To map --------------------
    //#region -------------------- To sequenced map --------------------

    @Override public ImmutableSequencedMap<Integer, T> toSequencedMap() { return _innerCollection().toSequencedMap(); }

    @Override public MutableSequencedMap<Integer, T> toMutableSequencedMap() { return _innerCollection().toMutableSequencedMap(); }

    //#endregion -------------------- To sequenced map --------------------
    //#region -------------------- To sorted map --------------------

    @Override public ImmutableSortedMap<Integer, T> toSortedMap() { return _innerCollection().toSortedMap(); }

    @Override public MutableSortedMap<Integer, T> toMutableSortedMap() { return _innerCollection().toMutableSortedMap(); }

    //#endregion -------------------- To sortedMap --------------------
    //#region -------------------- To navigable map --------------------

    @Override public ImmutableNavigableMap<Integer, T> toNavigableMap() { return _innerCollection().toNavigableMap(); }

    @Override public MutableNavigableMap<Integer, T> toMutableNavigableMap() { return _innerCollection().toMutableNavigableMap(); }

    //#endregion -------------------- To navigable map --------------------
    //#region -------------------- To concurrent map --------------------

    @Override public ImmutableConcurrentMap<Integer, T> toConcurrentMap() { return _innerCollection().toConcurrentMap(); }

    @Override public MutableConcurrentMap<Integer, T> toMutableConcurrentMap() { return _innerCollection().toMutableConcurrentMap(); }

    //#endregion -------------------- To concurrent map --------------------
    //#region -------------------- To concurrent navigable map --------------------

    @Override public ImmutableConcurrentNavigableMap<Integer, T> toConcurrentNavigableMap() { return _innerCollection().toConcurrentNavigableMap(); }

    @Override public MutableConcurrentNavigableMap<Integer, T> toMutableConcurrentNavigableMap() { return _innerCollection().toMutableConcurrentNavigableMap(); }

    //#endregion -------------------- To concurrent navigable map --------------------
    //#region -------------------- To concurrent hash map --------------------

    @Override public ImmutableConcurrentHashMap<Integer, T> toConcurrentHashMap() { return _innerCollection().toConcurrentHashMap(); }

    @Override public MutableConcurrentHashMap<Integer, T> toMutableConcurrentHashMap() { return _innerCollection().toMutableConcurrentHashMap(); }

    //#endregion -------------------- To concurrent hash map --------------------
    //#region -------------------- To concurrent skip list map --------------------

    @Override public ImmutableConcurrentSkipListMap<Integer, T> toConcurrentSkipListMap() { return _innerCollection().toConcurrentSkipListMap(); }

    @Override public MutableConcurrentSkipListMap<Integer, T> toMutableConcurrentSkipListMap() { return _innerCollection().toMutableConcurrentSkipListMap(); }

    //#endregion -------------------- To concurrent skip list map --------------------
    //#region -------------------- To enum map --------------------

    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final ObjIntFunction<? super T, Entry<K, V>>                                                       transform) { return _innerCollection().toEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Function<? super T, Entry<K, V>>                                                             transform) { return _innerCollection().toEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Function<? super T, K>                 keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Function<? super T, K>                 keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Function<? super T, K>                 keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Supplier<Entry<K, V>>                                                                        transform) { return _innerCollection().toEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Supplier<K>                            keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Supplier<K>                            keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> ImmutableEnumMap<K, V> toEnumMap(final Supplier<K>                            keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toEnumMap(keyTransform, valueTransform); }

    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final ObjIntFunction<? super T, Entry<K, V>>                                                       transform) { return _innerCollection().toMutableEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final ObjIntFunction<? super T, K>           keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Function<? super T, Entry<K, V>>                                                             transform) { return _innerCollection().toMutableEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Function<? super T, K>                 keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Function<? super T, K>                 keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Function<? super T, K>                 keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Supplier<Entry<K, V>>                                                                        transform) { return _innerCollection().toMutableEnumMap(transform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Supplier<K>                            keyTransform, final ObjIntFunction<? super T, V> valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Supplier<K>                            keyTransform, final Function<? super T, V>       valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }
    @Override public <K extends Enum<K>, V extends @Nullable Object> MutableEnumMap<K, V> toMutableEnumMap(final Supplier<K>                            keyTransform, final Supplier<V>                  valueTransform) { return _innerCollection().toMutableEnumMap(keyTransform, valueTransform); }

    //#endregion -------------------- To enum map --------------------
    //#region -------------------- To hash map --------------------

    @Override public ImmutableHashMap<Integer, T> toHashMap() { return _innerCollection().toHashMap(); }

    @Override public MutableHashMap<Integer, T> toMutableHashMap() { return _innerCollection().toMutableHashMap(); }

    //#endregion -------------------- To hash map --------------------
    //#region -------------------- To hashtable --------------------

    @Override public ImmutableHashtable<Integer, T> toHashtable() { return _innerCollection().toHashtable(); }

    @Override public MutableHashtable<Integer, T> toMutableHashtable() { return _innerCollection().toMutableHashtable(); }

    //#endregion -------------------- To hashtable --------------------
    //#region -------------------- To identity hash map --------------------

    @Override public ImmutableIdentityHashMap<Integer, T> toIdentityHashMap() { return _innerCollection().toIdentityHashMap(); }

    @Override public MutableIdentityHashMap<Integer, T> toMutableIdentityHashMap() { return _innerCollection().toMutableIdentityHashMap(); }

    //#endregion -------------------- To identity hash map --------------------
    //#region -------------------- To linked hash map --------------------

    @Override public ImmutableLinkedHashMap<Integer, T> toLinkedHashMap() { return _innerCollection().toLinkedHashMap(); }

    @Override public MutableLinkedHashMap<Integer, T> toMutableLinkedHashMap() { return _innerCollection().toMutableLinkedHashMap(); }

    //#endregion -------------------- To linked hash map --------------------
    //#region -------------------- To tree map --------------------

    @Override public ImmutableTreeMap<Integer, T> toTreeMap() { return _innerCollection().toTreeMap(); }

    @Override public MutableTreeMap<Integer, T> toMutableTreeMap() { return _innerCollection().toMutableTreeMap(); }

    //#endregion -------------------- To tree map --------------------
    //#region -------------------- To weak hash map --------------------

    @Override public ImmutableWeakHashMap<Integer, T> toWeakHashMap() { return _innerCollection().toWeakHashMap(); }

    @Override public MutableWeakHashMap<Integer, T> toMutableWeakHashMap() { return _innerCollection().toMutableWeakHashMap(); }
    ...
    @Override public boolean equals(final @Nullable Object other) {
        ...
        if (hasExactly1Element())
            if (other instanceof CollectionHolder<?> otherConverted2)
                if (otherConverted2.hasExactly1Element())
                    return Objects.deepEquals(getFirst(), otherConverted2.getFirst());
                else
                    return false;
            else if (otherConverted.size() == 1)
                return Objects.deepEquals(getFirst(), otherConverted.get(0));
            else
                return false;

        if (other instanceof CollectionHolder<?> otherConverted2)
            if (otherConverted2.hasExactly2Elements())
                return Objects.deepEquals(getFirst(), otherConverted2.getFirst()) && Objects.deepEquals(getLast(), otherConverted2.getLast());
            else
                return false;
        if (otherConverted.size() == 2)
            return Objects.deepEquals(getFirst(), otherConverted.get(0)) && Objects.deepEquals(getLast(), otherConverted.get(1));
        return false;
    }
    ...
    @Override public LazyCollectionHolderOf0Or1Or2<T> clone() { return (LazyCollectionHolderOf0Or1Or2<T>) super.clone(); }
