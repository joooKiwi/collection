...
/// An implementation of a reversed-order [ImmutableNavigableMap] similar to the [ArrayAsImmutableNavigableMap] in its behaviour.
...
@NotNullByDefault
public class ReversedArrayAsImmutableNavigableMap<K extends @Nullable Object,
        V extends @Nullable Object,
        SOURCE extends ImmutableNavigableMap<K, V>,
    ...
    public ReversedArrayAsImmutableNavigableMap(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableNavigableMap<K, V, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableNavigableMap<K, V, SOURCE, REVERSED_ARRAY>) super.clone(); }
