...
/// A bare-bone implementation of a [MutableConcurrentNavigableSet]
...
/// @see ReversedArrayAsMutableConcurrentNavigableSet
@NotNullByDefault
public class ArrayAsMutableConcurrentNavigableSet<T extends @Nullable Object>
    ...
    /// Create an instance of a [MutableConcurrentNavigableSet] from an [empty array][joookiwi.collection.java.CollectionConstants#emptyArray]
    public ArrayAsMutableConcurrentNavigableSet() {
        super();
        __reference = emptyArray();
        __comparator = null;
    }

    /// Create an instance of a [MutableConcurrentNavigableSet] from the `reference`
    ...
    public ArrayAsMutableConcurrentNavigableSet(final @Nullable Comparator<? super T> comparator) {
        super();
        __reference = emptyArray();
    ...
    public ArrayAsMutableConcurrentNavigableSet(final T[] reference) {
        super();
    ...
    /// @throws ClassCastException If the `comparator` was `null`, at least one value was not [Comparable]
    /// @implNote If the `comparator` is `null`, then use a [Comparable] type on [T] to avoid [ClassCastException]
    public ArrayAsMutableConcurrentNavigableSet(final T[] reference, final @Nullable Comparator<? super T> comparator) {
        super();
    ...
    @Override public ArrayAsMutableConcurrentNavigableSet<T> clone() { return (ArrayAsMutableConcurrentNavigableSet<T>) super.clone(); }
