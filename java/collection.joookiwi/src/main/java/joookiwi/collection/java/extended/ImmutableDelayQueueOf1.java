...
@NotNullByDefault
public class ImmutableDelayQueueOf1<T extends Delayed>
    ...
    public ImmutableDelayQueueOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableDelayQueueOf1<T> clone() {
        return (ImmutableDelayQueueOf1<T>) super.clone();
    }
