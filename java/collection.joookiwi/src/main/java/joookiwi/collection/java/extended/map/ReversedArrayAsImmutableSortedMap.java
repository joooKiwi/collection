...
/// An implementation of a reversed-order [ImmutableSortedMap] similar to the [ArrayAsImmutableSortedMap] in its behaviour.
...
/// @see SubdividedArrayAsImmutableSortedMap
@NotNullByDefault
public class ReversedArrayAsImmutableSortedMap<K extends @Nullable Object,
        V extends @Nullable Object,
        SOURCE extends ImmutableSortedMap<K, V>,
    ...
    public ReversedArrayAsImmutableSortedMap(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableSortedMap<K, V, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableSortedMap<K, V, SOURCE, REVERSED_ARRAY>) super.clone(); }
