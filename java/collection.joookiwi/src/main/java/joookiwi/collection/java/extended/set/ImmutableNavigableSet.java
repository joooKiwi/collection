...
public interface ImmutableNavigableSet<T extends @Nullable Object>
    ...
    /// @see <a href="https://learn.microsoft.com/dotnet/api/system.linq.enumerable.reverse">C# Reverse()</a>
    @Alias("reversed")
    @Override default ImmutableNavigableSet<T> descendingSet() { return reversed(); }
    ...
    /// Fail to add a `value` to the current [instance][ImmutableNavigableSet]
    ///
    ...
    /// Fail to add the `values` in the current [instance][ImmutableNavigableSet]
    ///
    ...
    /// Fail to clear the current [instance][ImmutableNavigableSet]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    ...
    /// Fail to remove a `value` in the current [instance][ImmutableNavigableSet]
    ///
    ...
    /// Fail to remove the first value in the current [instance][ImmutableNavigableSet]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to retrieve and remove the first value in the current [instance][ImmutableNavigableSet]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove the last value in the current [instance][ImmutableNavigableSet]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to retrieve and remove the last value in the current [instance][ImmutableNavigableSet]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove the `values` in the current [instance][ImmutableNavigableSet]
    ///
    ...
    /// Fail to remove anything to the current [instance][ImmutableNavigableSet]
    ///
    ...
    /// Fail to keep the `values` in the current [instance][ImmutableNavigableSet]
    ///
