...
@NotNullByDefault
public final class ToNavigableSet
        extends UtilityWithTable {

    @Contract(ALWAYS_FAIL_0)
    private ToNavigableSet() { throw new ImpossibleConstructionException("The utility class “ToNavigableSet” cannot be constructed.", ToNavigableSet.class); }
    ...
    /// @param <U>        The new type
    @ExtensionFunction
    public static <T extends @Nullable Object, U extends @Nullable Object> @Unmodifiable NavigableSet<U> toNavigableSet(final @Nullable T @Nullable @Unmodifiable [] collection,
                                                                                                                        final ObjIntFunction<? super T, ? extends U> transform) {
        if (collection == null)
            return emptyNavigableSet();
    ...
    private static <T extends @Nullable Object> @Unmodifiable NavigableSet<T> __withNoDuplicate(final CollectionHolder<? extends T> collection,
                                                                                                final int size) {
        return new ArrayAsNavigableSet<>(_orderedValues(collection, size));
    }


    private static <T extends @Nullable Object> @Unmodifiable NavigableSet<T> __withNoTransform(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                final int size) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size));
    }

    private static <T extends @Nullable Object> @Unmodifiable NavigableSet<T> __withNoTransform(final T @Unmodifiable [] collection,
                                                                                                final int size) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size));
    }


    private static <U extends @Nullable Object> @Unmodifiable NavigableSet<U> __with0Argument(final int size,
                                                                                              final Supplier<? extends U> transform) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(size, transform));
    }


    private static <T extends @Nullable Object, U extends @Nullable Object> @Unmodifiable NavigableSet<U> __with1Argument(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                                          final int size,
                                                                                                                          final Function<? super T, ? extends U> transform) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size, transform));
    }

    private static <T extends @Nullable Object, U extends @Nullable Object> @Unmodifiable NavigableSet<U> __with1Argument(final T @Unmodifiable [] collection,
                                                                                                                          final int size,
                                                                                                                          final Function<? super T, ? extends U> transform) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size, transform));
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> @Unmodifiable NavigableSet<U> __with2Argument(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                                          final int size,
                                                                                                                          final ObjIntFunction<? super T, ? extends U> transform) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size, transform));
    }

    private static <T extends @Nullable Object, U extends @Nullable Object> @Unmodifiable NavigableSet<U> __with2Argument(final T @Unmodifiable [] collection,
                                                                                                                          final int size,
                                                                                                                          final ObjIntFunction<? super T, ? extends U> transform) {
        return new ArrayAsNavigableSet<>(_orderedUniqueValues(collection, size, transform));
    }
