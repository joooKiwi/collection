...
public class MutableConcurrentSkipListSet<T>
    ...
    /// A view of a subdivided or reversed [MutableConcurrentSkipListSet]
    ///
    /// @param <T> The type
    @NotNullByDefault
    private static final class MutableConcurrentSkipListSetView<T>
            extends MutableConcurrentSkipListSet<T> {
        ...
        public MutableConcurrentSkipListSetView(final NavigableSet<T> reference) {
            super();
        ...
        @Override public MutableConcurrentSkipListSetView<T> subSet(final T from, final T to) { return new MutableConcurrentSkipListSetView<>(__reference.subSet(from, true, to, false)); }

        @Contract(ALWAYS_NEW_4)
        @Override public MutableConcurrentSkipListSetView<T> subSet(final T from, final boolean fromIsInclusive, final T to, final boolean toIsInclusive) { return new MutableConcurrentSkipListSetView<>(__reference.subSet(from, fromIsInclusive, to, toIsInclusive)); }


        @Contract(ALWAYS_NEW_1)
        @Override public MutableConcurrentSkipListSetView<T> headSet(final T to) { return new MutableConcurrentSkipListSetView<>(__reference.headSet(to, false)); }

        @Contract(ALWAYS_NEW_2)
        @Override public MutableConcurrentSkipListSetView<T> headSet(final T to, final boolean isInclusive) { return new MutableConcurrentSkipListSetView<>(__reference.headSet(to, isInclusive)); }


        @Contract(ALWAYS_NEW_1)
        @Override public MutableConcurrentSkipListSetView<T> tailSet(final T from) { return new MutableConcurrentSkipListSetView<>(__reference.tailSet(from, true)); }

        @Contract(ALWAYS_NEW_2)
        @Override public MutableConcurrentSkipListSetView<T> tailSet(final T from, final boolean isInclusive) { return new MutableConcurrentSkipListSetView<>(__reference.tailSet(from, isInclusive)); }

        //#endregion -------------------- As subdivided methods --------------------
        //#region -------------------- As reverse methods --------------------

        @Contract(ALWAYS_NEW_0)
        @Override public MutableConcurrentSkipListSetView<T> reversed() { return new MutableConcurrentSkipListSetView<>(__reference.descendingSet()); }

        @Contract(ALWAYS_NEW_0)
        @Override public MutableConcurrentSkipListSetView<T> descendingSet() { return new MutableConcurrentSkipListSetView<>(__reference.descendingSet()); }
        ...
        @Contract(ALWAYS_NEW_0)
        @Override public MutableConcurrentSkipListSetView<T> clone() { return (MutableConcurrentSkipListSetView<T>) super.clone(); }
    ...
    @Contract(ALWAYS_NEW_2)
    @Override public MutableConcurrentSkipListSet<T> subSet(final T from, final T to) { return new MutableConcurrentSkipListSetView<>(super.subSet(from, true, to, false)); }

    @Contract(ALWAYS_NEW_4)
    @Override public MutableConcurrentSkipListSet<T> subSet(final T from, final boolean fromIsInclusive, final T to, final boolean toIsInclusive) { return new MutableConcurrentSkipListSetView<>(super.subSet(from, fromIsInclusive, to, toIsInclusive)); }


    @Contract(ALWAYS_NEW_1)
    @Override public MutableConcurrentSkipListSet<T> headSet(final T to) { return new MutableConcurrentSkipListSetView<>(super.headSet(to, false)); }

    @Contract(ALWAYS_NEW_2)
    @Override public MutableConcurrentSkipListSet<T> headSet(final T to, final boolean isInclusive) { return new MutableConcurrentSkipListSetView<>(super.headSet(to, isInclusive)); }


    @Contract(ALWAYS_NEW_1)
    @Override public MutableConcurrentSkipListSet<T> tailSet(final T from) { return new MutableConcurrentSkipListSetView<>(super.tailSet(from, true)); }

    @Contract(ALWAYS_NEW_2)
    @Override public MutableConcurrentSkipListSet<T> tailSet(final T from, final boolean isInclusive) { return new MutableConcurrentSkipListSetView<>(super.tailSet(from, isInclusive)); }

    //#endregion -------------------- As subdivided methods --------------------
    //#region -------------------- As reverse methods --------------------

    @Contract(ALWAYS_NEW_0)
    @Override public MutableConcurrentSkipListSet<T> reversed() { return new MutableConcurrentSkipListSetView<>(super.reversed()); }

    @Contract(ALWAYS_NEW_0)
    @Override public MutableConcurrentSkipListSet<T> descendingSet() { return new MutableConcurrentSkipListSetView<>(super.descendingSet()); }
