...
/// An implementation of a reversed-order [Deque] similar to the [ArrayAsDeque] in its behaviour.
...
///                          (generally a [ArrayAsDeque] or [ReversedArrayAsDeque])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsDeque
@NotNullByDefault
public class ReversedArrayAsDeque<T extends @Nullable Object,
    ...
    public ReversedArrayAsDeque(final SOURCE source,
    ...
    @Override public ReversedArrayAsDeque<T, SOURCE, REVERSED_ARRAY> clone() { return new ReversedArrayAsDeque<>(_source(), _reversedArray()); }
