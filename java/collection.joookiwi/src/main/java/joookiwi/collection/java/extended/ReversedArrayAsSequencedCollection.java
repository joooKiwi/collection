...
/// An implementation of a reversed-order [SequencedCollection] similar to the [ArrayAsSequencedCollection] in its behaviour.
...
///                          (generally a [ArrayAsSequencedCollection] or [ReversedArrayAsSequencedCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsSequencedCollection
@NotNullByDefault
public class ReversedArrayAsSequencedCollection<T extends @Nullable Object,
    ...
    public ReversedArrayAsSequencedCollection(final SOURCE source,
