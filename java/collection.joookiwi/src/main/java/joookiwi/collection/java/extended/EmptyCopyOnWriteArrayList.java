...
public class EmptyCopyOnWriteArrayList<T>
    ...
    @Contract(pure = true) public @Override @NotNull ListIterator<T> listIterator(               ) { return emptyListIterator(); }
    @Contract(pure = true) public @Override @NotNull ListIterator<T> listIterator(final int index) { return emptyListIterator(); }
