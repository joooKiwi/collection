...
/// An implementation of a reversed-order [MutableSortedCollection] similar to the [ArrayAsMutableSortedCollection] in its behaviour.
///
...
///                          (generally a [ArrayAsMutableSortedCollection] or [ReversedArrayAsMutableSortedCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsMutableSortedCollection
@NotNullByDefault
public class ReversedArrayAsMutableSortedCollection<T extends @Nullable Object,
        SOURCE extends MutableSortedCollection<T>,
    ...
    public ReversedArrayAsMutableSortedCollection(final SOURCE source,
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ReversedArrayAsMutableSortedCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsMutableSortedCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
