...
/// An implementation of a reversed-order [ImmutableConcurrentNavigableCollection] similar to the [ArrayAsImmutableConcurrentNavigableCollection] in its behaviour.
...
///                          (generally a [ArrayAsImmutableConcurrentNavigableCollection] or [ReversedArrayAsImmutableConcurrentNavigableCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsImmutableConcurrentNavigableCollection
@NotNullByDefault
public class ReversedArrayAsImmutableConcurrentNavigableCollection<T extends @Nullable Object,
        SOURCE extends ImmutableConcurrentNavigableCollection<T>,
    ...
    public ReversedArrayAsImmutableConcurrentNavigableCollection(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableConcurrentNavigableCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableConcurrentNavigableCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
