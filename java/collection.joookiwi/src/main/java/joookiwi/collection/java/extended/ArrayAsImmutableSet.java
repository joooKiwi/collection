...
/// @param <T> The type
@NotNullByDefault
public class ArrayAsImmutableSet<T extends @Nullable Object>
    ...
    public ArrayAsImmutableSet(final T[] reference) {
        super();
    ...
    @Override public ArrayAsImmutableSet<T> clone() { return new ArrayAsImmutableSet<>(_reference().clone()); }
