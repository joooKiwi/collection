...
@NotNullByDefault
public final class ToMutableTransferQueue
        extends UtilityWithTable {

    @Contract(ALWAYS_FAIL_0)
    private ToMutableTransferQueue() { throw new ImpossibleConstructionException("The utility class “ToMutableTransferQueue” cannot be constructed.", ToMutableTransferQueue.class); }

    //#region -------------------- Facade methods --------------------

    //#region -------------------- ∅ --------------------

    /// Convert the `collection` to a [MutableTransferQueue]
    ///
    ...
    public static <T> MutableTransferQueue<T> toMutableTransferQueue(final @Nullable MinimalistCollectionHolder<? extends T> collection) {
        ...
        if (size == 0)
            return new ArrayAsMutableTransferQueue<>();
        return new ArrayAsMutableTransferQueue<>(_values(collection, size));
    }
    ...
    public static <T> MutableTransferQueue<T> toMutableTransferQueue(final @Nullable CollectionHolder<? extends T> collection) {
        ...
        if (collection.isEmpty())
            return new ArrayAsMutableTransferQueue<>();
        return new ArrayAsMutableTransferQueue<>(_values(collection, collection.size()));
    }
    ...
    public static <T extends @Nullable Object, U> MutableTransferQueue<U> toMutableTransferQueue(final @Nullable MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new ArrayAsMutableTransferQueue<>();
        return new ArrayAsMutableTransferQueue<>(_values(collection, size, transform));
    }
    ...
    public static <T extends @Nullable Object, U> MutableTransferQueue<U> toMutableTransferQueue(final @Nullable CollectionHolder<? extends T> collection,
        ...
        if (collection.isEmpty())
            return new ArrayAsMutableTransferQueue<>();
        return new ArrayAsMutableTransferQueue<>(_values(collection, collection.size(), transform));
    }
    ...
    public static <T extends @Nullable Object, U> MutableTransferQueue<U> toMutableTransferQueue(final @Nullable MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new ArrayAsMutableTransferQueue<>();
        return new ArrayAsMutableTransferQueue<>(_values(size, transform));
    }
