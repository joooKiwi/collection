...
@NotNullByDefault
public final class FindLastIndexIndexed
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindLastIndexIndexed() { throw new ImpossibleConstructionException("The utility class “FindLastIndexIndexed” cannot be constructed.", FindLastIndexIndexed.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final IntObjPredicate<? super T> predicate) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                             final IntObjPredicate<? super T> predicate) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final T @Nullable @Unmodifiable [] collection,
                                                                                                             final IntObjPredicate<? super T> predicate) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final IntPredicate predicate) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final BooleanSupplier predicate) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             ...
                                                                                                             final int from) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final IntObjPredicate<? super T> predicate,
                                                                                                             final @Nullable Integer from) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final IntObjPredicate<? super T> predicate,
                                                                                                             final int from,
                                                                                                             final int to) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate, from, to); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                             final IntObjPredicate<? super T> predicate,
                                                                                                             final int from,
                                                                                                             final @Nullable Integer to) { return IndexOfLastIndexed.indexOfLastIndexed(collection, predicate, from, to); }
