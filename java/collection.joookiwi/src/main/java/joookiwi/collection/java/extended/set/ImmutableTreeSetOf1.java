...
@NotNullByDefault
public class ImmutableTreeSetOf1<T extends @Nullable Object>
    ...
    public ImmutableTreeSetOf1(final T value) {
        super();
        __value = value;
    }

    public ImmutableTreeSetOf1(final T value, final @Nullable Comparator<? super T> comparator) {
        super(comparator);
        __value = value;
    }
    ...
    @Contract(ALWAYS_THIS_0) @Override public ImmutableTreeSetOf1<T> reversed() { return this; }

    @Contract(ALWAYS_THIS_0) @Override public ImmutableTreeSetOf1<T> descendingSet() { return this; }

    //#endregion -------------------- As reverse methods --------------------
    //#region -------------------- As subdivided methods --------------------

    @Override public ImmutableTreeSetOf1<T> subSet(final T from, final T to) { return UtilityFor1.asSubdivided(this, from, to, "TreeSet"); }

    @Override public ImmutableTreeSetOf1<T> subSet(final T from, final boolean fromIsInclusive, final T to, final boolean toIsInclusive) { return UtilityFor1.asSubdivided(this, from, fromIsInclusive, to, toIsInclusive, "TreeSet"); }


    @Override public ImmutableTreeSetOf1<T> headSet(final T to) { return UtilityFor1.asHeadSubdivided(this, to, "TreeSet"); }

    @Override public ImmutableTreeSetOf1<T> headSet(final T to, final boolean isInclusive) { return UtilityFor1.asHeadSubdivided(this, to, isInclusive, "TreeSet"); }


    @Override public ImmutableTreeSetOf1<T> tailSet(final T from) { return UtilityFor1.asTailSubdivided(this, from, "TreeSet"); }

    @Override public ImmutableTreeSetOf1<T> tailSet(final T from, final boolean isInclusive) { return UtilityFor1.asTailSubdivided(this, from, isInclusive, "TreeSet"); }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableTreeSetOf1<T> clone() {
        return (ImmutableTreeSetOf1<T>) super.clone();
    }
