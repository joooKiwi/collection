...
public final class Drop
    ...
    public static <T extends @Nullable Object> @NotNull CollectionHolder<T> drop(final @Nullable MinimalistCollectionHolder<T> collection,
                                                                                 final int n) {
        if (collection == null)
    ...
    @ExtensionFunction
    @CanReceiveNegativeValue
    public static <T extends @Nullable Object> @NotNull CollectionHolder<T> drop(final @Nullable CollectionHolder<T> collection,
                                                                                 final int n) {
        if (collection == null)
            return emptyCollectionHolder();
        return __core(collection, n);
    ...
    @ExtensionFunction
    @CanReceiveNegativeValue
    public static <T extends @Nullable Object> @NotNull CollectionHolder<T> drop(final T @Nullable @Unmodifiable [] collection,
                                                                                 final int n) {
        if (collection == null)
            return emptyCollectionHolder();
        return __core(collection, n);
