...
/// An implementation of a reversed-order [MutableNavigableCollection] similar to the [ArrayAsMutableNavigableCollection] in its behaviour.
///
...
///                          (generally a [ArrayAsMutableNavigableCollection] or [ReversedArrayAsMutableNavigableCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsMutableNavigableCollection
@NotNullByDefault
public class ReversedArrayAsMutableNavigableCollection<T extends @Nullable Object,
        SOURCE extends MutableNavigableCollection<T>,
    ...
    public ReversedArrayAsMutableNavigableCollection(final SOURCE source,
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ReversedArrayAsMutableNavigableCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsMutableNavigableCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
