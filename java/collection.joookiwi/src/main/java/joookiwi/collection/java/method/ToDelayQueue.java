...
import joookiwi.collection.java.extended.queue.EmptyDelayQueue;
...
@NotNullByDefault
public final class ToDelayQueue
        extends UtilityWithTable {

    @Contract(ALWAYS_FAIL_0)
    private ToDelayQueue() { throw new ImpossibleConstructionException("The utility class “ToDelayQueue” cannot be constructed.", ToDelayQueue.class); }
    ...
    public static <T extends Delayed> ImmutableDelayQueue<T> toDelayQueue(final @Nullable MinimalistCollectionHolder<? extends T> collection) {
        if (collection == null)
            return EmptyDelayQueue.getInstance();
