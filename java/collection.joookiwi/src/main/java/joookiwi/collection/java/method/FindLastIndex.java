...
@NotNullByDefault
public final class FindLastIndex
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindLastIndex() { throw new ImpossibleConstructionException("The utility class “FindLastIndex2” cannot be constructed.", FindLastIndex.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final ObjIntPredicate<? super T> predicate) { return IndexOfLast.indexOfLast(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                      final ObjIntPredicate<? super T> predicate) { return IndexOfLast.indexOfLast(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final T @Nullable @Unmodifiable [] collection,
                                                                                                      final ObjIntPredicate<? super T> predicate) { return IndexOfLast.indexOfLast(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final Predicate<? super T> predicate) { return IndexOfLast.indexOfLast(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final BooleanSupplier predicate) { return IndexOfLast.indexOfLast(collection, predicate); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      ...
                                                                                                      final int from) { return IndexOfLast.indexOfLast(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final ObjIntPredicate<? super T> predicate,
                                                                                                      final @Nullable Integer from) { return IndexOfLast.indexOfLast(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final ObjIntPredicate<? super T> predicate,
                                                                                                      final int from,
                                                                                                      final int to) { return IndexOfLast.indexOfLast(collection, predicate, from, to); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findLastIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                      final ObjIntPredicate<? super T> predicate,
                                                                                                      final int from,
                                                                                                      final @Nullable Integer to) { return IndexOfLast.indexOfLast(collection, predicate, from, to); }
