...
public class SubdividedArrayAsImmutableNavigableSet<T extends @Nullable Object,
    ...
    @Override public SubdividedArrayAsImmutableNavigableSet<T, SOURCE, SUB_ARRAY> clone() { return (SubdividedArrayAsImmutableNavigableSet<T, SOURCE, SUB_ARRAY>) super.clone(); }
