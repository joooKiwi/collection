...
public class MutableLinkedTransferQueue<T>
        ...
        implements MutableTransferQueue<T> {

    @Serial private static final long serialVersionUID = 6638210710747128761L;
    ...
    @Override public boolean hasWaitingConsumer() { return super.hasWaitingConsumer(); }

    @Override public @Range(from = 0, to = MAX_INT_VALUE) int getWaitingConsumerCount() { return super.getWaitingConsumerCount(); }
    ...
    @Override public boolean tryTransfer(final T value) { return super.tryTransfer(value); }

    @Override public boolean tryTransfer(final T value, final long timeout, final TimeUnit unit) throws InterruptedException { return super.tryTransfer(value, timeout, unit); }


    @Override public void transfer(final T value) throws InterruptedException { super.transfer(value); }

    //#endregion -------------------- Transfer methods --------------------
