...
public final class ToMutableCopyOnWriteArrayList
    ...
    private static <T extends @Nullable Object> CopyOnWriteArrayList<T> __withNoTransform(final MinimalistCollectionHolder<? extends T> collection,
                                                                                          final int size) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size));
    }

    private static <T extends @Nullable Object> CopyOnWriteArrayList<T> __withNoTransform(final T @Unmodifiable [] collection,
                                                                                          final int size) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size));
    }


    private static <U extends @Nullable Object> CopyOnWriteArrayList<U> __with0Argument(final int size,
                                                                                        final Supplier<? extends U> transform) {
        return new MutableCopyOnWriteArrayList<>(_values(size, transform));
    }


    private static <T extends @Nullable Object, U extends @Nullable Object> CopyOnWriteArrayList<U> __with1Argument(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                                    final int size,
                                                                                                                    final Function<? super T, ? extends U> transform) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size, transform));
    }

    private static <T extends @Nullable Object, U extends @Nullable Object> CopyOnWriteArrayList<U> __with1Argument(final T @Unmodifiable [] collection,
                                                                                                                    final int size,
                                                                                                                    final Function<? super T, ? extends U> transform) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size, transform));
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> CopyOnWriteArrayList<U> __with2Argument(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                                    final int size,
                                                                                                                    final ObjIntFunction<? super T, ? extends U> transform) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size, transform));
    }

    private static <T extends @Nullable Object, U extends @Nullable Object> CopyOnWriteArrayList<U> __with2Argument(final T @Unmodifiable [] collection,
                                                                                                                    final int size,
                                                                                                                    final ObjIntFunction<? super T, ? extends U> transform) {
        return new MutableCopyOnWriteArrayList<>(_values(collection, size, transform));
    }
