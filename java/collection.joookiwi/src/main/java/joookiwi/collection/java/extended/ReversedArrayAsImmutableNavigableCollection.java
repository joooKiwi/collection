...
/// An implementation of a reversed-order [ImmutableNavigableCollection] similar to the [ArrayAsImmutableNavigableCollection] in its behaviour.
...
///                          (generally a [ArrayAsImmutableNavigableCollection] or [ReversedArrayAsImmutableNavigableCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsImmutableNavigableCollection
@NotNullByDefault
public class ReversedArrayAsImmutableNavigableCollection<T extends @Nullable Object,
        SOURCE extends ImmutableNavigableCollection<T>,
    ...
    public ReversedArrayAsImmutableNavigableCollection(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableNavigableCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableNavigableCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
