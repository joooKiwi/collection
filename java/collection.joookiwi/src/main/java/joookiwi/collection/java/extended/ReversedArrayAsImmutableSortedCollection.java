...
/// An implementation of a reversed-order [ImmutableSortedCollection] similar to the [ArrayAsImmutableSortedCollection] in its behaviour.
...
///                          (generally a [ArrayAsImmutableSortedCollection] or [ReversedArrayAsImmutableSortedCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsImmutableSortedCollection
@NotNullByDefault
public class ReversedArrayAsImmutableSortedCollection<T extends @Nullable Object,
        SOURCE extends ImmutableSortedCollection<T>,
    ...
    public ReversedArrayAsImmutableSortedCollection(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableSortedCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableSortedCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
