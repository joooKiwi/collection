...
/// A bare-bone implementation of an [ImmutableNavigableCollection].
///
...
///
/// @param <T> The type
/// @see ReversedArrayAsImmutableNavigableCollection
@NotNullByDefault
public class ArrayAsImmutableNavigableCollection<T extends @Nullable Object>
    ...
    /// Create an instance of an [ImmutableNavigableCollection] from the `reference`
    ...
    public ArrayAsImmutableNavigableCollection(final T[] reference) {
        super();
        __comparator = null;
    ...
    public ArrayAsImmutableNavigableCollection(final T[] reference, final @Nullable Comparator<? super T> comparator) {
        super();
    ...
    @Override public ArrayAsImmutableNavigableCollection<T> clone() { return (ArrayAsImmutableNavigableCollection<T>) super.clone(); }
