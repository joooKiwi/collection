...
@NotNullByDefault
public class ImmutableVectorOf1<T extends @Nullable Object>
        extends ImmutableVector<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = 2473108223670583486L;
    ...
    public ImmutableVectorOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(pure = true)
    @Override public T get(final int index) { return UtilityFor1.get(this, index, "Vector"); }

    @Contract(pure = true)
    @Override public T elementAt(final int index) { return UtilityFor1.get(this, index, "Vector"); }
    ...
    @Contract(ALWAYS_THIS_2) @Override public ImmutableVectorOf1<T> subList(final int from, final int to) { return UtilityFor1.asSubdivided(this, from, to); }

    //#endregion -------------------- As subdivided methods --------------------
    //#region -------------------- As reverse methods --------------------

    @Contract(ALWAYS_THIS_0) @Override public ImmutableVectorOf1<T> reversed() { return this; }
    ...
    @Override public CollectionIteratorOf1<T> listIterator(final int index) { return UtilityFor1.toIterator(this, index, "Vector"); }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableVectorOf1<T> clone() {
        return (ImmutableVectorOf1<T>) super.clone();
    }
