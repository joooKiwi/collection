...
@NotNullByDefault
public class ImmutableHashSetOf1<T extends @Nullable Object>
        extends ImmutableHashSet<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = -756253108762891146L;
    ...
    public ImmutableHashSetOf1(final T value) {
        super();
        __value = value;
    }

    public ImmutableHashSetOf1(final T value, final float loadFactor) {
        super(loadFactor);
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableHashSetOf1<T> clone() {
        return (ImmutableHashSetOf1<T>) super.clone();
    }
