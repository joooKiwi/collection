...
@NotNullByDefault
public final class FindIndexIndexed
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindIndexIndexed() { throw new ImpossibleConstructionException("The utility class “FindIndexIndexed” cannot be constructed.", FindIndexIndexed.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndexIndexed(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                         final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndexIndexed(final T @Nullable @Unmodifiable [] collection,
                                                                                                         final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
