...
/// An implementation of a subdivided-[ImmutableSortedMap] similar to the [ArrayAsImmutableSortedMap] in its behaviour.
///
...
///                           (generally a [ArrayAsImmutableSortedMap], [SubdividedArrayAsImmutableSortedMap] or [ReversedArrayAsImmutableSortedMap])
/// @param <SUBDIVIDED_ARRAY> The array that should contain the new reference
/// @see ArrayAsImmutableSortedMap
/// @see ReversedArrayAsImmutableSortedMap
@NotNullByDefault
public class SubdividedArrayAsImmutableSortedMap<K extends @Nullable Object,
        V extends @Nullable Object,
        SOURCE extends ImmutableSortedMap<? super K, ? super V>,
    ...
    public SubdividedArrayAsImmutableSortedMap(final SOURCE source,
    ...
    @Override public SubdividedArrayAsImmutableSortedMap<K, V, SOURCE, SUBDIVIDED_ARRAY> clone() { return (SubdividedArrayAsImmutableSortedMap<K, V, SOURCE, SUBDIVIDED_ARRAY>) super.clone(); }
