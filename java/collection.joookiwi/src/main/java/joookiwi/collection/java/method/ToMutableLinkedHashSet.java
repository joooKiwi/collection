...
public final class ToMutableLinkedHashSet
    ...
    ///
    /// @param collection      The [nullable][Nullable] [collection][MinimalistCollectionHolder] to convert
    /// @param initialCapacity The [set][java.util.LinkedHashSet] initial capacity (if it over the <code>collection.[size][MinimalistCollectionHolder#size()]</code>)
    /// @param <T>             The `collection` type
    @ExtensionFunction
    @Contract(ALWAYS_NEW_2)
    public static <T extends @Nullable Object> MutableLinkedHashSet<T> toMutableLinkedHashSet(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    ///
    /// @param collection      The [nullable][Nullable] [collection][CollectionHolder] to convert
    /// @param initialCapacity The [Set][java.util.LinkedHashSet] initial capacity (if it over the <code>collection.[size][CollectionHolder#size()]</code>)
    /// @param <T>             The `collection` type
    @ExtensionFunction
    @Contract(ALWAYS_NEW_2)
    public static <T extends @Nullable Object> MutableLinkedHashSet<T> toMutableLinkedHashSet(final @Nullable CollectionHolder<? extends T> collection,
    ...
    ///
    /// @param collection      The [nullable][Nullable] collection to convert
    /// @param initialCapacity The [Set][java.util.LinkedHashSet] initial capacity (if it over the `collection.length`)
    /// @param <T>             The `collection` type
    @ExtensionFunction
    @Contract(ALWAYS_NEW_2)
    public static <T extends @Nullable Object> MutableLinkedHashSet<T> toMutableLinkedHashSet(final T @Nullable @Unmodifiable [] collection,
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __empty() { return new MutableLinkedHashSet<>(); }


    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __empty(final int initialCapacity) { return new MutableLinkedHashSet<>(initialCapacity); }

    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __empty(final @Nullable Integer initialCapacity) { return new MutableLinkedHashSet<>(initialCapacity); }


    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __empty(final int initialCapacity,
                                                                                final float loadFactor) { return new MutableLinkedHashSet<>(initialCapacity, loadFactor); }

    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __empty(final @Nullable Integer initialCapacity,
                                                                                final float loadFactor) { return new MutableLinkedHashSet<>(initialCapacity, loadFactor); }
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final MinimalistCollectionHolder<? extends T> collection) {
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final CollectionHolder<? extends T> collection) {
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final T @Unmodifiable [] collection) {
        final var size = collection.length;
        if (size == 0)
            return new MutableLinkedHashSet<>();
        return new MutableLinkedHashSet<>(_uniqueValues(collection, size));
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final MinimalistCollectionHolder<? extends T> collection,
                                                                                                           final ObjIntFunction<? super T, ? extends U> transform) {
        final var size = collection.size();
        if (size == 0)
            return new MutableLinkedHashSet<>();
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final CollectionHolder<? extends T> collection,
                                                                                                           final ObjIntFunction<? super T, ? extends U> transform) {
        if (collection.isEmpty())
            return new MutableLinkedHashSet<>();
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final T @Unmodifiable [] collection,
                                                                                                           final ObjIntFunction<? super T, ? extends U> transform) {
        final var size = collection.length;
        if (size == 0)
            return new MutableLinkedHashSet<>();
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        return new MutableLinkedHashSet<>(_uniqueValues(collection, size), initialCapacity);
    }
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final CollectionHolder<? extends T> collection,
        ...
        if (collection.isEmpty())
            return new MutableLinkedHashSet<>(initialCapacity);
        if (collection.hasDuplicate())
            return new MutableLinkedHashSet<>(_values(collection, collection.size()), initialCapacity);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, collection.size()), initialCapacity);
    }
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        return new MutableLinkedHashSet<>(_uniqueValues(collection, size), initialCapacity, loadFactor);
    }
    ...
    private static <T extends @Nullable Object> MutableLinkedHashSet<T> __core(final CollectionHolder<? extends T> collection,
        ...
        if (collection.isEmpty())
            return new MutableLinkedHashSet<>(initialCapacity, loadFactor);
        if (collection.hasDuplicate())
            return new MutableLinkedHashSet<>(_values(collection, collection.size()), initialCapacity, loadFactor);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, collection.size()), initialCapacity, loadFactor);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new MutableLinkedHashSet<>(initialCapacity);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, size, transform), initialCapacity);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final CollectionHolder<? extends T> collection,
        ...
        if (collection.isEmpty())
            return new MutableLinkedHashSet<>(initialCapacity);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, collection.size(), transform), initialCapacity);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new MutableLinkedHashSet<>(initialCapacity);
        return new MutableLinkedHashSet<>(_uniqueValues(size, transform), initialCapacity);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new MutableLinkedHashSet<>(initialCapacity, loadFactor);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, size, transform), initialCapacity, loadFactor);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final CollectionHolder<? extends T> collection,
        ...
        if (collection.isEmpty())
            return new MutableLinkedHashSet<>(initialCapacity, loadFactor);
        return new MutableLinkedHashSet<>(_uniqueValues(collection, collection.size(), transform), initialCapacity, loadFactor);
    }
    ...
    private static <T extends @Nullable Object, U extends @Nullable Object> MutableLinkedHashSet<U> __core(final MinimalistCollectionHolder<? extends T> collection,
        ...
        if (size == 0)
            return new MutableLinkedHashSet<>(initialCapacity, loadFactor);
        return new MutableLinkedHashSet<>(_uniqueValues(size, transform), initialCapacity, loadFactor);
    }
