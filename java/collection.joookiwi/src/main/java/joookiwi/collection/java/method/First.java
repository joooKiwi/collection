...
public final class First
    ...
    public static <T extends @Nullable Object> T first(final @Nullable MinimalistCollectionHolder<? extends T> collection) { return GetFirst.getFirst(collection); }
    ...
    @ExtensionFunction
    @Contract(IF_1ST_NULL_THEN_FAIL_1)
    public static <T extends @Nullable Object> T first(final @Nullable CollectionHolder<? extends T> collection) { return GetFirst.getFirst(collection); }
    ...
    @ExtensionFunction
    @Contract(IF_1ST_NULL_THEN_FAIL_1)
    public static <T extends @Nullable Object> T first(final T @Nullable @Unmodifiable [] collection) { return GetFirst.getFirst(collection); }
    ...
    public static <T extends @Nullable Object> T first(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @ExtensionFunction
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> T first(final @Nullable CollectionHolder<? extends T> collection,
                                                       final @Nullable ObjIntPredicate<? super T> predicate) {
        if (predicate == null)
            return GetFirst.getFirst(collection);
        return FindFirst.findFirst(collection, predicate);
    ...
    @ExtensionFunction
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> T first(final T @Nullable @Unmodifiable [] collection,
                                                       final @Nullable ObjIntPredicate<? super T> predicate) {
        if (predicate == null)
            return GetFirst.getFirst(collection);
        return FindFirst.findFirst(collection, predicate);
