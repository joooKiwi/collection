...
/// An implementation of a subdivided-[MutableNavigableSet] similar to the [ArrayAsMutableNavigableSet] in its behaviour.
...
///                    (generally a [ArrayAsMutableNavigableSet], [SubdividedArrayAsMutableNavigableSet] or [ReversedArrayAsMutableNavigableSet])
/// @see ArrayAsMutableNavigableSet
/// @see ReversedArrayAsMutableNavigableSet
@NotNullByDefault
public class SubdividedArrayAsMutableNavigableSet<T extends @Nullable Object,
        SOURCE extends MutableNavigableSet<? super T>,
    ...
    public SubdividedArrayAsMutableNavigableSet(final SOURCE source,
    ...
    @Override public SubdividedArrayAsMutableNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY> clone() { return (SubdividedArrayAsMutableNavigableSet<T, SOURCE, SUBDIVIDED_ARRAY>) super.clone(); }
