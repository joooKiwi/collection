...
/// @param <T> The type
@NotNullByDefault
public class ArrayAsMutableBlockingQueue<T>
        extends AbstractArrayAsMutableBlockingQueue<T> {
    ...
    /// Create an instance of a [MutableBlockingQueue] from an [empty array][joookiwi.collection.java.CollectionConstants#emptyArray]
    public ArrayAsMutableBlockingQueue() {
        super();
        __reference = emptyArray();
    }

    /// Create an instance of a [MutableBlockingQueue] from the `reference`
    ///
    /// @param reference The array to be the internal structure
    public ArrayAsMutableBlockingQueue(final T[] reference) {
        super();
    ...
    @Override public ArrayAsMutableBlockingQueue<T> clone() { return (ArrayAsMutableBlockingQueue<T>) super.clone(); }
