...
/// An implementation of a reversed-order [ImmutableSortedSet] similar to the [ArrayAsImmutableSortedSet] in its behaviour.
...
public class ReversedArrayAsImmutableSortedSet<T extends @Nullable Object,
    ...
    public ReversedArrayAsImmutableSortedSet(final SOURCE source,
