...
@NotNullByDefault
public final class FindFirstIndexIndexed
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindFirstIndexIndexed() { throw new ImpossibleConstructionException("The utility class “FindFirstIndexIndexed” cannot be constructed.", FindFirstIndexIndexed.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                              final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final T @Nullable @Unmodifiable [] collection,
                                                                                                              final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final IntPredicate predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final BooleanSupplier predicate) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              ...
                                                                                                              final int from) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final IntObjPredicate<? super T> predicate,
                                                                                                              final @Nullable Integer from) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate, from); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final IntObjPredicate<? super T> predicate,
                                                                                                              final int from,
                                                                                                              final int to) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate, from, to); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findFirstIndexIndexed(final @Nullable MinimalistCollectionHolder<? extends T> collection,
                                                                                                              final IntObjPredicate<? super T> predicate,
                                                                                                              final int from,
                                                                                                              final @Nullable Integer to) { return IndexOfFirstIndexed.indexOfFirstIndexed(collection, predicate, from, to); }
