...
/// An implementation of a reversed-order [MutableConcurrentNavigableCollection] similar to the [ArrayAsMutableConcurrentNavigableCollection] in its behaviour.
///
...
///                          (generally a [ArrayAsMutableConcurrentNavigableCollection] or [ReversedArrayAsMutableConcurrentNavigableCollection])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsMutableConcurrentNavigableCollection
@NotNullByDefault
public class ReversedArrayAsMutableConcurrentNavigableCollection<T extends @Nullable Object,
        SOURCE extends MutableConcurrentNavigableCollection<T>,
    ...
    public ReversedArrayAsMutableConcurrentNavigableCollection(final SOURCE source,
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ReversedArrayAsMutableConcurrentNavigableCollection<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsMutableConcurrentNavigableCollection<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
