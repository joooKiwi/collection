...
@NotNullByDefault
public class ArrayAsImmutableSortedMap<K extends @Nullable Object,
    ...
    public ArrayAsImmutableSortedMap(joookiwi.collection.java.entry.Entry<? extends K, ? extends V>[] reference) {
        __comparator = null;
    ...
    public ArrayAsImmutableSortedMap(joookiwi.collection.java.entry.Entry<? extends K, ? extends V>[] reference, final @Nullable Comparator<? super K> comparator) {
