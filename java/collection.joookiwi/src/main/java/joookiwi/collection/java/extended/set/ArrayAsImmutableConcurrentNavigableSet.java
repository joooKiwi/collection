...
/// A bare-bone implementation of an [ImmutableConcurrentNavigableSet].
///
...
@NotNullByDefault
public class ArrayAsImmutableConcurrentNavigableSet<T extends @Nullable Object>
    ...
    /// Create an instance of an [ImmutableConcurrentNavigableSet] from the `reference`
    ...
    public ArrayAsImmutableConcurrentNavigableSet(final T[] reference) {
        super();
    ...
    public ArrayAsImmutableConcurrentNavigableSet(final T[] reference, final @Nullable Comparator<? super T> comparator) {
        super();
    ...
    @Override public ArrayAsImmutableConcurrentNavigableSet<T> clone() { return (ArrayAsImmutableConcurrentNavigableSet<T>) super.clone(); }
