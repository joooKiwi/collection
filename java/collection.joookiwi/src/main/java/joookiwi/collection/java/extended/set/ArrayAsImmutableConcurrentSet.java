...
/// A bare-bone implementation of an [ImmutableConcurrentSet].
///
...
/// @param <T> The type
@NotNullByDefault
public class ArrayAsImmutableConcurrentSet<T extends @Nullable Object>
        extends AbstractArrayAsImmutableConcurrentSet<T> {
    ...
    /// Create an instance of an [ImmutableConcurrentSet] from the `reference`
    ///
    /// @param reference The array to be the internal structure
    /// @throws RuntimeException A duplicate value exists in the `reference`
    public ArrayAsImmutableConcurrentSet(final T[] reference) {
        super();
    ...
    @Override public ArrayAsImmutableConcurrentSet<T> clone() { return (ArrayAsImmutableConcurrentSet<T>) super.clone(); }
