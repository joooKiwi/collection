...
/// An implementation of a reversed-order [ImmutableConcurrentNavigableSet] similar to the [ArrayAsImmutableConcurrentNavigableSet] in its behaviour.
...
@NotNullByDefault
public class ReversedArrayAsImmutableConcurrentNavigableSet<T extends @Nullable Object,
        SOURCE extends ImmutableConcurrentNavigableSet<T>,
    ...
    public ReversedArrayAsImmutableConcurrentNavigableSet(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableConcurrentNavigableSet<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableConcurrentNavigableSet<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
