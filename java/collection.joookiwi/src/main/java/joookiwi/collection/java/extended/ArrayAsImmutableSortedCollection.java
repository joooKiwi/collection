...
/// A bare-bone implementation of an [ImmutableSortedCollection].
///
...
///
/// @param <T> The type
/// @see ReversedArrayAsImmutableSortedCollection
@NotNullByDefault
public class ArrayAsImmutableSortedCollection<T extends @Nullable Object>
    ...
    /// Create an instance of an [ImmutableSortedCollection] from the `reference`
    ...
    public ArrayAsImmutableSortedCollection(final T[] reference) {
        super();
        __comparator = null;
    ...
    public ArrayAsImmutableSortedCollection(final T[] reference, final @Nullable Comparator<? super T> comparator) {
        super();
    ...
    @Override public ArrayAsImmutableSortedCollection<T> clone() { return (ArrayAsImmutableSortedCollection<T>) super.clone(); }
