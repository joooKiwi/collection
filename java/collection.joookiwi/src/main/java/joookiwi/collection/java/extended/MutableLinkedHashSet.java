...
public class MutableLinkedHashSet<T>
    ...
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) byte initialCapacity) { super(initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    ///
    /// @throws IllegalArgumentException The `initialCapacity` was negative
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) @Nullable Byte initialCapacity) { super(initialCapacity == null ? DEFAULT_INITIAL_CAPACITY : initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    ///
    /// @throws IllegalArgumentException The `initialCapacity` was negative
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) short initialCapacity) { super(initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    ///
    /// @throws IllegalArgumentException The `initialCapacity` was negative
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) @Nullable Short initialCapacity) { super(initialCapacity == null ? DEFAULT_INITIAL_CAPACITY : initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    ///
    /// @throws IllegalArgumentException The `initialCapacity` was negative
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) int initialCapacity) { super(initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    ///
    /// @throws IllegalArgumentException The `initialCapacity` was negative
    public MutableLinkedHashSet(final @Range(from = 0, to = MAX_VALUE) @Nullable Integer initialCapacity) { super(initialCapacity == null ? DEFAULT_INITIAL_CAPACITY : initialCapacity, DEFAULT_LOAD_FACTOR); }
    ...
    /// and a load factor of [0.75][joookiwi.collection.java.CollectionConstants#DEFAULT_EMPTY_LOAD_FACTOR]
    public MutableLinkedHashSet(final T @Flow(sourceIsContainer = true, targetIsContainer = true) @NotNull @Unmodifiable [] values) {
    ...
    /// and a load factor of [0.75][joookiwi.collection.java.CollectionConstants#DEFAULT_EMPTY_LOAD_FACTOR]
    public MutableLinkedHashSet(final @Flow(sourceIsContainer = true, targetIsContainer = true) @NotNull @Unmodifiable Collection<? extends T> values) {
