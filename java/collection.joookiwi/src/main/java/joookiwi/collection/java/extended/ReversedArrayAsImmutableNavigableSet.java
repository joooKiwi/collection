...
@NotNullByDefault
public class ReversedArrayAsImmutableNavigableSet<T extends @Nullable Object,
        SOURCE extends @NotNull ImmutableNavigableSet<T>,
    ...
    public ReversedArrayAsImmutableNavigableSet(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableNavigableSet<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsImmutableNavigableSet<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
