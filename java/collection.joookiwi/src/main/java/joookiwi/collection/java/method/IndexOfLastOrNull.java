...
@NotNullByDefault
public final class IndexOfLastOrNull
        extends UtilityWithIndex {

    @Contract(ALWAYS_FAIL_0)
    private IndexOfLastOrNull() { throw new ImpossibleConstructionException("The utility class “IndexOfLastOrNull” cannot be constructed.", IndexOfLastOrNull.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer indexOfLastOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer indexOfLastOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                                        final ObjIntPredicate<? super T> predicate) {
        if (collection == null)
            return null;
        return __core(collection, predicate);
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer indexOfLastOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                                                        final ObjIntPredicate<? super T> predicate) {
        if (collection == null)
            return null;
        return __core(collection, predicate);
    ...
    private static <T extends @Nullable Object> @Nullable Integer __with1Argument(final MinimalistCollectionHolder<? extends T> collection,
                                                                                  final Predicate<? super T> predicate,
                                                                                  final int startingIndex,
                                                                                  final int endingIndex) {
        var index = endingIndex + 1;
    ...
    private static <T extends @Nullable Object> @Nullable Integer __with1Argument(final T @Unmodifiable [] collection,
                                                                                  final Predicate<? super T> predicate,
                                                                                  final int startingIndex,
                                                                                  final int endingIndex) {
        var index = endingIndex + 1;
