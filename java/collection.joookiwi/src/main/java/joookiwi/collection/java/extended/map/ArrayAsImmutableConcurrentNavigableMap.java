...
@NotNullByDefault
public class ArrayAsImmutableConcurrentNavigableMap<K extends @Nullable Object,
    ...
    public ArrayAsImmutableConcurrentNavigableMap(joookiwi.collection.java.entry.Entry<? extends K, ? extends V>[] reference) {
        __comparator = null;
    ...
    public ArrayAsImmutableConcurrentNavigableMap(joookiwi.collection.java.entry.Entry<? extends K, ? extends V>[] reference, final @Nullable Comparator<? super K> comparator) {
