...
public final class None
    ...
    public static <T> boolean none(@Nullable MinimalistCollectionHolder<? extends T> collection, @Nullable BiFunction<? super T, @NotNull Integer, @NotNull Boolean> predicate) {
        if (collection == null)
            return true;
        if (predicate == null)
            return collection.size() == 0;
    ...
    @ExtensionFunction
    @Contract("null, _ -> true")
    public static <T> boolean none(@Nullable CollectionHolder<? extends T> collection, @Nullable BiFunction<? super T, @NotNull Integer, @NotNull Boolean> predicate) {
        if (collection == null)
            return true;
        if (predicate == null)
            return collection.isEmpty();
    ...
    @ExtensionFunction
    @Contract("null, _ -> true")
    public static <T> boolean none(@Nullable MinimalistCollectionHolder<? extends T> collection, @Nullable Function<? super T, @NotNull Boolean> predicate) {
        if (collection == null)
            return true;
        if (predicate == null)
            return collection.size() == 0;
    ...
    @ExtensionFunction
    @Contract("null, _ -> true")
    public static <T> boolean none(@Nullable CollectionHolder<? extends T> collection, @Nullable Function<? super T, @NotNull Boolean> predicate) {
        if (collection == null)
            return true;
        if (predicate == null)
            return collection.isEmpty();
