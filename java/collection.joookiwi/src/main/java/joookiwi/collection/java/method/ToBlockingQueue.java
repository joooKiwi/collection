...
import joookiwi.collection.java.extended.queue.ArrayAsImmutableBlockingQueue;
import joookiwi.collection.java.extended.queue.EmptyBlockingQueue;
...
public final class ToBlockingQueue
    ...
    /// Convert the `collection` to an [ImmutableBlockingQueue]
    ///
