...
public interface ImmutableList<T extends @Nullable Object>
    ...
    /// @throws joookiwi.collection.java.exception.IndexOutOfBoundsException The `index` is under zero or over the [size][#size]
    /// @see List#get(int)
    ...
    /// Get the first element in the current [instance][List]
    ///
    /// @throws NoSuchElementException The current [instance][List] [is empty][#isEmpty]
    /// @see List#getFirst()
    ...
    /// Get the last element in the current [instance][List]
    ///
    /// @throws NoSuchElementException The current [instance][List] [is empty][#isEmpty]
    /// @see List#getLast()
    ...
    /// Give a subdivided-array of the current [instance][List] between both indexes (`from` and `to`)
    ///
    /// @param from The starting index (inclusive)
    /// @param to   The ending index (exclusive)
    /// @throws joookiwi.collection.java.exception.IndexOutOfBoundsException  `from` or `to` are not within a valid range
