...
/// An implementation of an [InsideIteratorValue] with only the 1<sup>st</sup> value out of 2
/// if a [CollectionIterator][joookiwi.collection.java.iterator.CollectionIterator]
///
/// @param <T> The element type
@NotNullByDefault
public class IteratorValueOf1On2<T extends @Nullable Object>
        extends AbstractIteratorValue<T>
        implements InsideIteratorValue<T> {

    private final T __value;

    public IteratorValueOf1On2(final T value) {
        super();
        __value = value;
    }
