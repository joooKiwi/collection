...
public class MutableLinkedList<T extends @Nullable Object>
    ...
    @Serial private static final long serialVersionUID = -8812760137283314704L;

    //#region -------------------- Sub class --------------------

    /// A view of a subdivided [MutableLinkedList]
    ///
    /// @param <T> The type
    private static final class MutableSubdividedLinkedListView<T extends @Nullable Object>
            extends MutableLinkedList<T> {

        //#region -------------------- Fields --------------------

        @Serial private static final long serialVersionUID = 1760343162620871001L;
        ...
        public MutableSubdividedLinkedListView(final List<T> reference) {
            super();
        ...
        @Override public MutableSubdividedLinkedListView<T> subList(final int from, final int to) { return new MutableSubdividedLinkedListView<>(__reference.subList(from, to)); }

        //#endregion -------------------- As subdivided methods --------------------
        //#region -------------------- As reverse methods --------------------

        @Contract(ALWAYS_NEW_0)
        @Override public MutableSubdividedLinkedListView<T> reversed() { return new MutableSubdividedLinkedListView<>(__reference.reversed()); }
        ...
        @Contract(ALWAYS_NEW_0)
        @Override public MutableSubdividedLinkedListView<T> clone() { return (MutableSubdividedLinkedListView<T>) super.clone(); }
    ...
    /// A view of a reversed [MutableLinkedList]
    ///
    /// @param <T> The type
    private static final class MutableReversedLinkedListView<T extends @Nullable Object>
            extends MutableLinkedList<T> {

        //#region -------------------- Fields --------------------

        @Serial private static final long serialVersionUID = -1886472305486656078L;

        private final LinkedList<T> __reference;

        //#endregion -------------------- Fields --------------------
        //#region -------------------- Constructor --------------------

        public MutableReversedLinkedListView(final LinkedList<T> reference) {
            super();
            __reference = reference;
        }
        ...
        @Contract(ALWAYS_NEW_0)
        @Override public MutableReversedLinkedListView<T> reversed() { return new MutableReversedLinkedListView<>(__reference.reversed()); }
        ...
        @MustBeInvokedByOverriders
        @Contract(ALWAYS_NEW_0)
        @Override public MutableReversedLinkedListView<T> clone() { return (MutableReversedLinkedListView<T>) super.clone(); }
    ...
    @Contract(ALWAYS_NEW_2)
    @Override public MutableLinkedList<T> subList(final int from, final int to) { return new MutableSubdividedLinkedListView<>(super.subList(from, to)); }

    //#endregion -------------------- As subdivided methods --------------------
    //#region -------------------- As reverse methods --------------------

    @Contract(ALWAYS_NEW_0)
    @Override public MutableLinkedList<T> reversed() { return new MutableReversedLinkedListView<>(super.reversed()); }
