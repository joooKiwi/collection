...
public class ImmutableArrayBlockingQueue<T>
    ...
    @Override public ImmutableArrayBlockingQueue<T> clone() {
        try {
            return (ImmutableArrayBlockingQueue<T>) super.clone();
    ...
    /// Fail to add a `value` to the current [instance][ImmutableArrayBlockingQueue]
    ///
    ...
    /// Fail to add the `values` in the current [instance][ImmutableArrayBlockingQueue]
    ///
    ...
    /// Fail to remove and retrieve the head of the current [instance][ImmutableArrayBlockingQueue]
    ///
    /// @throws UnsupportedOperationException The method is not supported
    ...
    /// Fail to clear the current [instance][ImmutableArrayBlockingQueue]
    ///
    /// @throws UnsupportedOperationException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove the head of the current [instance][ImmutableArrayBlockingQueue]
    ///
    /// @throws UnsupportedOperationException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove a `value` in the current [instance][ImmutableArrayBlockingQueue]
    ///
    ...
    /// Fail to remove the `values` in the current [instance][ImmutableArrayBlockingQueue]
    ///
    ...
    /// Fail to remove anything to the current [instance][ImmutableArrayBlockingQueue]
    ///
    /// @param filter The (_never used_) predicate
    /// @throws UnsupportedOperationException The method is not supported
    @Contract(ALWAYS_FAIL_1)
    @Override public boolean removeIf(final @Nullable Predicate<? super @Nullable T> filter) { throw new UnsupportedOperationException("The method “removeIf” is not supported in an immutable ArrayAsBlockingQueue."); }


    /// Fail to keep the `values` in the current [instance][ImmutableArrayBlockingQueue]
    ///
    ...
    /// Fail to transfer the `values` from the current [instance][ImmutableArrayBlockingQueue]
    ///
    /// @param values The (_never used_) values to keep
    /// @throws UnsupportedOperationException The method is not supported
    @Contract(ALWAYS_FAIL_1)
    @Override public int drainTo(final @Nullable @Unmodifiable Collection<? super @Nullable T> values) { throw new UnsupportedOperationException("The method “drainTo” is not supported in an immutable ArrayAsBlockingQueue."); }
    ...
    /// @throws UnsupportedOperationException The method is not supported
    @Contract(ALWAYS_FAIL_2)
    @Override public int drainTo(final @Nullable @Unmodifiable Collection<? super @Nullable T> values, int maximum) { throw new UnsupportedOperationException("The method “drainTo” is not supported in an immutable ArrayAsBlockingQueue."); }
