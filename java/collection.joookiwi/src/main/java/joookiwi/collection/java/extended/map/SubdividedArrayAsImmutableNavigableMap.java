...
/// An implementation of a subdivided-[ImmutableNavigableMap] similar to the [ArrayAsImmutableNavigableMap] in its behaviour.
///
...
///                           (generally a [ArrayAsImmutableNavigableMap], [SubdividedArrayAsImmutableNavigableMap] or [ReversedArrayAsImmutableNavigableMap])
/// @param <SUBDIVIDED_ARRAY> The array that should contain the new reference
/// @see ArrayAsImmutableNavigableMap
/// @see ReversedArrayAsImmutableNavigableMap
@NotNullByDefault
public class SubdividedArrayAsImmutableNavigableMap<K extends @Nullable Object,
        V extends @Nullable Object,
        SOURCE extends ImmutableNavigableMap<? super K, ? super V>,
    ...
    public SubdividedArrayAsImmutableNavigableMap(final SOURCE source,
    ...
    @Override public SubdividedArrayAsImmutableNavigableMap<K, V, SOURCE, SUBDIVIDED_ARRAY> clone() { return (SubdividedArrayAsImmutableNavigableMap<K, V, SOURCE, SUBDIVIDED_ARRAY>) super.clone(); }
