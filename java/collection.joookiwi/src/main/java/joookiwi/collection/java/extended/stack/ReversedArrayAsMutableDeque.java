...
/// An implementation of a reversed-order [MutableDeque] similar to the [ArrayAsMutableDeque] in its behaviour.
///
...
///                          (generally a [ArrayAsMutableDeque] or [ReversedArrayAsMutableDeque])
/// @param <REVERSED_ARRAY>> The array that should contain the new reference
/// @see ArrayAsMutableDeque
@NotNullByDefault
public class ReversedArrayAsMutableDeque<T extends @Nullable Object,
        SOURCE extends MutableDeque<T>,
    ...
    public ReversedArrayAsMutableDeque(final SOURCE source,
    ...
    @Override public ReversedArrayAsMutableDeque<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsMutableDeque<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
