...
/// The first as [CollectionHolderOf1] and the second as [CollectionHolderOf2].
/// Plus, the inner-collection is lazily retrieved.
///
/// @param <T> The type
@NotNullByDefault
public class LazyCollectionHolderOf1Or2<T extends @Nullable Object>
    ...
    public LazyCollectionHolderOf1Or2(final Supplier<? extends java.util.@Nullable Optional<Couple<@Nullable Object, ? extends T, ? extends java.util.Optional<? extends T>>>> latePossibleValue) {
        ...
        __latePossibleValue = () -> {
            ...
            if (value2.isEmpty())
                return new Couple<>(value1, EmptyOptional.getInstance());
            return new Couple<>(value1, new Optional<>(value2.get()));
        };
    ...
    ///
    /// @return Either [CollectionHolderOf1] or [CollectionHolderOf2]
    ...
    protected CollectionHolder<T> _innerCollection() {
        ...
        return __innerCollection = new CollectionHolderOf2<>(couple.value1(), value2.get());
    }
    ...
    @Override public T value1() {
        ...
        return __value1 = _innerCollection().getFirst();
    }
    ...
    @Override public @Range(from = 1, to = 2) int size() { return _innerCollection().size(); }
    ...
    @Override public T getFirstOrNull() { return _innerCollection().getFirstOrNull(); }

    @Override public T getLastOrNull() { return _innerCollection().getLastOrNull(); }
    ...
    /// @return Either [CollectionHolderOf2], [CollectionHolderOf1] or [EmptyCollectionHolder]
    ...
    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEach(final ObjIntConsumer<? super T> action) {
        _innerCollection().forEach(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEach(final Consumer<? super T> action) {
        _innerCollection().forEach(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEach(final Runnable action) {
        _innerCollection().forEach(action);
        return this;
    }


    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEachIndexed(final IntObjConsumer<? super T> action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEachIndexed(final IntConsumer action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }

    @Contract(ALWAYS_THIS_1) @Override public LazyCollectionHolderOf1Or2<T> onEachIndexed(final Runnable action) {
        _innerCollection().forEachIndexed(action);
        return this;
    }
    ...
    /// @return Either [CollectionHolderOf2] or [CollectionHolderOf1]
    ...
    /// @return Either [CollectionIteratorOf2][joookiwi.collection.java.iterator.CollectionIteratorOf2] or [CollectionIteratorOf1][joookiwi.collection.java.iterator.CollectionIteratorOf1]
    ...
    @Override public LazyCollectionHolderOf1Or2<T> clone() { return (LazyCollectionHolderOf1Or2<T>) super.clone(); }

//    @MustBeInvokedByOverriders
//    @Contract(ALWAYS_NEW_0)
//    @Override public LazyCollectionHolderOf1Or2<T> shallowClone() { return clone(); }
//
//    @MustBeInvokedByOverriders
//    @Contract(ALWAYS_NEW_0)
//    @Override public LazyCollectionHolderOf1Or2<T> deepClone() {
//        final var innerCollection = __innerCollection;
//        if (innerCollection == null)
//            return new LazyCollectionHolderOf1Or2<>(() -> __latePossibleValue.get().clone());
//
//        final var newInstance = new LazyCollectionHolderOf1Or2<T>(() -> { throw new RuntimeException("The Supplier should never be called in normal circumstance."); });
