...
/// A sequential [DoubleStream] with nothing (as a [singleton][Singleton] instance)
///
...
@Singleton
@NotNullByDefault
public class EmptySequentialDoubleStream
        implements DoubleStream {

    //#region -------------------- Singleton usage --------------------

    private static volatile @Nullable EmptySequentialDoubleStream instance;

    protected EmptySequentialDoubleStream() { super(); }

    public static EmptySequentialDoubleStream getInstance() {
        final var instance = EmptySequentialDoubleStream.instance;
        if (instance != null)
            return instance;
        synchronized (EmptySequentialDoubleStream.class) {
            final var instance2 = EmptySequentialDoubleStream.instance;
            if (instance2 != null)
                return instance2;
            return (EmptySequentialDoubleStream.instance = new EmptySequentialDoubleStream());
        }
    }
    ...
    @Contract(ALWAYS_THIS_0) @Override public EmptySequentialDoubleStream sequential(                                            ) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream sequential(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Sequential --------------------
    //#region -------------------- Parallel --------------------

    @Override public EmptyParallelDoubleStream parallel(                                            ) { return EmptyParallelDoubleStream.getInstance(); }
              public EmptyParallelDoubleStream parallel(final @Nullable Object @Nullable ... ignored) { return EmptyParallelDoubleStream.getInstance(); }

    //#endregion -------------------- Parallel --------------------
    //#region -------------------- Unordered --------------------

    @Contract(ALWAYS_THIS_0) @Override public EmptySequentialDoubleStream unordered(                                            ) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream unordered(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Unordered --------------------
    //#region -------------------- Filter --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream filter(final @Nullable DoublePredicate      predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream filter(final @Nullable BooleanSupplier      predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream filter(final @Nullable Object @Nullable ...   ignored) { return this; }

    //#endregion -------------------- Filter --------------------
    //#region -------------------- Map --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream map(final @Nullable DoubleUnaryOperator   mapper) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream map(final @Nullable DoubleSupplier        mapper) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream map(final @Nullable Object @Nullable ... ignored) { return this; }

    @Override public <U extends @Nullable Object> EmptySequentialStream<U> mapToObj(final @Nullable DoubleFunction<? extends U> mapper) { return EmptySequentialStream.getInstance(); }
    ...
    @Override public EmptySequentialBooleanStream mapToBoolean(final @Nullable DoubleToBooleanFunction mapper) { return EmptySequentialBooleanStream.getInstance(); }
              public EmptySequentialBooleanStream mapToBoolean(final @Nullable DoubleSupplier          mapper) { return EmptySequentialBooleanStream.getInstance(); }
    ...
    @Override public EmptySequentialCharStream mapToChar(final @Nullable DoubleToCharFunction  mapper) { return EmptySequentialCharStream.getInstance(); }
              public EmptySequentialCharStream mapToChar(final @Nullable DoubleSupplier        mapper) { return EmptySequentialCharStream.getInstance(); }
    ...
    @Override public EmptySequentialByteStream mapToByte(final @Nullable DoubleToByteFunction  mapper) { return EmptySequentialByteStream.getInstance(); }
              public EmptySequentialByteStream mapToByte(final @Nullable DoubleSupplier        mapper) { return EmptySequentialByteStream.getInstance(); }
    ...
    @Override public EmptySequentialShortStream mapToShort(final @Nullable DoubleToShortFunction mapper) { return EmptySequentialShortStream.getInstance(); }
              public EmptySequentialShortStream mapToShort(final @Nullable DoubleSupplier        mapper) { return EmptySequentialShortStream.getInstance(); }
    ...
    @Override public EmptySequentialIntStream mapToInt(final @Nullable DoubleToIntFunction   mapper) { return EmptySequentialIntStream.getInstance(); }
              public EmptySequentialIntStream mapToInt(final @Nullable DoubleSupplier        mapper) { return EmptySequentialIntStream.getInstance(); }
    ...
    @Override public EmptySequentialLongStream mapToLong(final @Nullable DoubleToLongFunction  mapper) { return EmptySequentialLongStream.getInstance(); }
              public EmptySequentialLongStream mapToLong(final @Nullable DoubleSupplier        mapper) { return EmptySequentialLongStream.getInstance(); }
    ...
    @Override public EmptySequentialFloatStream mapToFloat(final @Nullable DoubleToFloatFunction mapper) { return EmptySequentialFloatStream.getInstance(); }
              public EmptySequentialFloatStream mapToFloat(final @Nullable DoubleSupplier        mapper) { return EmptySequentialFloatStream.getInstance(); }
    ...
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapToDouble(final @Nullable DoubleUnaryOperator   mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapToDouble(final @Nullable DoubleSupplier        mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapToDouble(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Map --------------------
    //#region -------------------- Flat map --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream flatMap(final @Nullable DoubleFunction<? extends java.util.stream.@Nullable DoubleStream> mapper) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream flatMap(final @Nullable Supplier<? extends @Nullable DoubleStream>                        mapper) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream flatMap(final @Nullable Object @Nullable ...                                             ignored) { return this; }

    @Override public <U extends @Nullable Object> EmptySequentialStream<U> flatMapToObj(final @Nullable DoubleFunction<? extends @Nullable Stream<? extends U>> mapper) { return EmptySequentialStream.getInstance(); }
    ...
    @Override public EmptySequentialBooleanStream flatMapToBoolean(final @Nullable DoubleFunction<? extends @Nullable BooleanStream> mapper) { return EmptySequentialBooleanStream.getInstance(); }
    ...
    @Override public EmptySequentialCharStream flatMapToChar(final @Nullable DoubleFunction<? extends @Nullable CharStream> mapper) { return EmptySequentialCharStream.getInstance(); }
    ...
    @Override public EmptySequentialByteStream flatMapToByte(final @Nullable DoubleFunction<? extends @Nullable ByteStream> mapper) { return EmptySequentialByteStream.getInstance(); }
    ...
    @Override public EmptySequentialShortStream flatMapToShort(final @Nullable DoubleFunction<? extends @Nullable ShortStream> mapper) { return EmptySequentialShortStream.getInstance(); }
    ...
    @Override public EmptySequentialIntStream flatMapToInt(final @Nullable DoubleFunction<? extends @Nullable IntStream> mapper) { return EmptySequentialIntStream.getInstance(); }
    ...
    @Override public EmptySequentialLongStream flatMapToLong(final @Nullable DoubleFunction<? extends @Nullable LongStream> mapper) { return EmptySequentialLongStream.getInstance(); }
    ...
    @Override public EmptySequentialFloatStream flatMapToFloat(final @Nullable DoubleFunction<? extends @Nullable FloatStream> mapper) { return EmptySequentialFloatStream.getInstance(); }
    ...
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream flatMapToDouble(final @Nullable DoubleFunction<? extends @Nullable DoubleStream> mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream flatMapToDouble(final @Nullable Supplier<? extends @Nullable DoubleStream>       mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream flatMapToDouble(final @Nullable Object @Nullable ...                            ignored) { return this; }

    //#endregion -------------------- Flat map --------------------
    //#region -------------------- Map multi --------------------

    @Override public  EmptySequentialDoubleStream mapMulti(final @Nullable DoubleMapMultiConsumer  mapper) { return this; }
              public  EmptySequentialDoubleStream mapMulti(final @Nullable DoubleConsumer          mapper) { return this; }
              public  EmptySequentialDoubleStream mapMulti(final @Nullable Runnable                mapper) { return this; }
              public  EmptySequentialDoubleStream mapMulti(final @Nullable Object @Nullable ...   ignored) { return this; }

    @Override public <U extends @Nullable Object> EmptySequentialStream<U> mapMultiToObj(final @Nullable DoubleObjConsumer<? super @Nullable Consumer<U>> mapper) { return EmptySequentialStream.getInstance(); }
              public <U extends @Nullable Object> EmptySequentialStream<U> mapMultiToObj(final @Nullable DoubleConsumer                                   mapper) { return EmptySequentialStream.getInstance(); }
    ...
    @Override public EmptySequentialBooleanStream mapMultiToBoolean(final @Nullable DoubleObjConsumer<? super @Nullable BooleanConsumer> mapper) { return EmptySequentialBooleanStream.getInstance(); }
              public EmptySequentialBooleanStream mapMultiToBoolean(final @Nullable DoubleConsumer                                       mapper) { return EmptySequentialBooleanStream.getInstance(); }
    ...
    @Override public EmptySequentialCharStream mapMultiToChar(final @Nullable DoubleObjConsumer<? super @Nullable CharConsumer> mapper) { return EmptySequentialCharStream.getInstance(); }
              public EmptySequentialCharStream mapMultiToChar(final @Nullable DoubleConsumer                                    mapper) { return EmptySequentialCharStream.getInstance(); }
    ...
    @Override public EmptySequentialByteStream mapMultiToByte(final @Nullable DoubleObjConsumer<? super @Nullable ByteConsumer> mapper) { return EmptySequentialByteStream.getInstance(); }
              public EmptySequentialByteStream mapMultiToByte(final @Nullable DoubleConsumer                                    mapper) { return EmptySequentialByteStream.getInstance(); }
    ...
    @Override public EmptySequentialShortStream mapMultiToShort(final @Nullable DoubleObjConsumer<? super @Nullable ShortConsumer> mapper) { return EmptySequentialShortStream.getInstance(); }
              public EmptySequentialShortStream mapMultiToShort(final @Nullable DoubleConsumer                                     mapper) { return EmptySequentialShortStream.getInstance(); }
    ...
    @Override public EmptySequentialIntStream mapMultiToInt(final @Nullable DoubleObjConsumer<? super @Nullable IntConsumer> mapper) { return EmptySequentialIntStream.getInstance(); }
              public EmptySequentialIntStream mapMultiToInt(final @Nullable DoubleConsumer                                   mapper) { return EmptySequentialIntStream.getInstance(); }
    ...
    @Override public EmptySequentialLongStream mapMultiToLong(final @Nullable DoubleObjConsumer<? super @Nullable LongConsumer> mapper) { return EmptySequentialLongStream.getInstance(); }
              public EmptySequentialLongStream mapMultiToLong(final @Nullable DoubleConsumer                                    mapper) { return EmptySequentialLongStream.getInstance(); }
    ...
    @Override public EmptySequentialFloatStream mapMultiToFloat(final @Nullable DoubleObjConsumer<? super @Nullable FloatConsumer> mapper) { return EmptySequentialFloatStream.getInstance(); }
              public EmptySequentialFloatStream mapMultiToFloat(final @Nullable DoubleConsumer                                     mapper) { return EmptySequentialFloatStream.getInstance(); }
    ...
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapMultiToDouble(final @Nullable DoubleObjConsumer<? super @Nullable DoubleConsumer> mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapMultiToDouble(final @Nullable DoubleConsumer                                      mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapMultiToDouble(final @Nullable Runnable                                            mapper) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream mapMultiToDouble(final @Nullable Object @Nullable ...                               ignored) { return this; }

    //#endregion -------------------- Map multi --------------------
    //#region -------------------- Distinct --------------------

    @Contract(ALWAYS_THIS_0) @Override public EmptySequentialDoubleStream distinct(                                            ) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream distinct(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Distinct --------------------
    //#region -------------------- Sorted --------------------

    @Contract(ALWAYS_THIS_0) @Override public EmptySequentialDoubleStream sorted(                                            ) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream sorted(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Sorted --------------------
    //#region -------------------- Peek --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream peek(final @Nullable DoubleConsumer        action) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream peek(final @Nullable Runnable              action) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream peek(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Peek --------------------
    //#region -------------------- Limit --------------------

    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final byte                                                  maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final short                                                 maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final int                                                   maximum) { return this; }
    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream limit(final long                                                  maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final float                                                 maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final double                                                maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final @Nullable Number                                      maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final @Nullable AtomicReference<? extends @Nullable Number> maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream limit(final @Nullable Object @Nullable ...                        ignored) { return this; }

    //#endregion -------------------- Limit --------------------
    //#region -------------------- Skip --------------------

    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final byte                                                  maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final short                                                 maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final int                                                   maximum) { return this; }
    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream skip(final long                                                  maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final float                                                 maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final double                                                maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final @Nullable Number                                      maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final @Nullable AtomicReference<? extends @Nullable Number> maximum) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream skip(final @Nullable Object @Nullable ...                        ignored) { return this; }

    //#endregion -------------------- Skip --------------------
    //#region -------------------- Take while --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream takeWhile(final @Nullable DoublePredicate    predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream takeWhile(final @Nullable BooleanSupplier    predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream takeWhile(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- Take while --------------------
    //#region -------------------- Drop while --------------------

    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream dropWhile(final @Nullable DoublePredicate    predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream dropWhile(final @Nullable BooleanSupplier    predicate) { return this; }
    @Contract(ALWAYS_THIS_1)           public EmptySequentialDoubleStream dropWhile(final @Nullable Object @Nullable ... ignored) { return this; }
    ...
    @Contract(pure = true)           public <U extends @Nullable Object> U[]      toArray(final DoubleFunction<U[]> generator) { return generator.apply(0); }
    ...
    @Contract(ALWAYS_THIS_0) public EmptySequentialDoubleStream asDoubleStream(                                            ) { return this; }
    @Contract(ALWAYS_THIS_1) public EmptySequentialDoubleStream asDoubleStream(final @Nullable Object @Nullable ... ignored) { return this; }

    //#endregion -------------------- As stream --------------------
    //#region -------------------- Boxed --------------------

    @Override public EmptySequentialStream<Double> boxed(                                            ) { return EmptySequentialStream.getInstance(); }
              public EmptySequentialStream<Double> boxed(final @Nullable Object @Nullable ... ignored) { return EmptySequentialStream.getInstance(); }
    ...
    @Contract(ALWAYS_THIS_1) @Override public EmptySequentialDoubleStream onClose(final @Nullable Runnable handler) { return this; }
