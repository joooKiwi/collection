...
public final class FindIndex
    ...
    private FindIndex() { throw new ImpossibleConstructionException("The utility class “FirstIndex” cannot be constructed.", FindIndex.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndex(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndex(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                  final ObjIntPredicate<? super T> predicate) { return IndexOfFirst.indexOfFirst(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_FAIL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) int findIndex(final T @Nullable @Unmodifiable [] collection,
                                                                                                  final ObjIntPredicate<? super T> predicate) { return IndexOfFirst.indexOfFirst(collection, predicate); }
