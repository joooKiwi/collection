...
@NotNullByDefault
public class ArrayAsImmutableConcurrentMap<K extends @Nullable Object,
        V extends @Nullable Object>
        extends AbstractArrayAsImmutableConcurrentMap<K, V> {
    ...
    public ArrayAsImmutableConcurrentMap(joookiwi.collection.java.entry.Entry<? extends K, ? extends V>[] reference) {
