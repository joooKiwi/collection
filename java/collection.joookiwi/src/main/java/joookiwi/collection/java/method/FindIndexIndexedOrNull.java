...
@NotNullByDefault
public final class FindIndexIndexedOrNull
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindIndexIndexedOrNull() { throw new ImpossibleConstructionException("The utility class “FindIndexIndexedOrNull” cannot be constructed.", FindIndexIndexedOrNull.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexIndexedOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexIndexedOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                                             final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexIndexedOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                                                             final IntObjPredicate<? super T> predicate) { return IndexOfFirstIndexedOrNull.indexOfFirstIndexedOrNull(collection, predicate); }
