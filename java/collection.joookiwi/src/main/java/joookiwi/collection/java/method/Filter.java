...
public final class Filter
    ...
    private Filter() { throw new ImpossibleConstructionException("The utility class “Filter” cannot be constructed.", Filter.class); }
    ...
    /// @see <a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/filter.html">Kotlin filter(predicate)</a>
    /// @see <a href="https://learn.microsoft.com/dotnet/api/system.linq.enumerable.where">C# Where(predicate)</a>
    @ExtensionFunction
    public static <T> CollectionHolder<T> filter(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    /// @see <a href="https://learn.microsoft.com/dotnet/api/system.linq.enumerable.where">C# Where(predicate)</a>
    @ExtensionFunction
    public static <T> CollectionHolder<T> filter(final @Nullable CollectionHolder<? extends T> collection,
                                                 final ObjIntPredicate<? super T> predicate) {
        if (collection == null)
            return emptyCollectionHolder();
    ...
    /// @see <a href="https://learn.microsoft.com/dotnet/api/system.linq.enumerable.where">C# Where(predicate)</a>
    @ExtensionFunction
    public static <T> CollectionHolder<T> filter(final T @Nullable @Unmodifiable [] collection,
                                                 final ObjIntPredicate<? super T> predicate) {
        if (collection == null)
            return emptyCollectionHolder();
