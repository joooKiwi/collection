...
/// An implementation of a reversed-order [MutableNavigableSet] similar to the [ArrayAsMutableNavigableSet] in its behaviour.
...
@NotNullByDefault
public class ReversedArrayAsMutableNavigableSet<T extends @Nullable Object,
    ...
    public ReversedArrayAsMutableNavigableSet(final SOURCE source,
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ReversedArrayAsMutableNavigableSet<T, SOURCE, REVERSED_ARRAY> clone() { return (ReversedArrayAsMutableNavigableSet<T, SOURCE, REVERSED_ARRAY>) super.clone(); }
