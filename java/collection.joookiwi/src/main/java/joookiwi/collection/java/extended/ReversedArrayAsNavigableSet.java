...
/// An implementation of a reversed-order [NavigableSet] similar to the [ArrayAsNavigableSet] in its behaviour.
...
@NotNullByDefault
public class ReversedArrayAsNavigableSet<T extends @Nullable Object,
        SOURCE extends NavigableSet<? super T>,
        REVERSED_ARRAY extends ReversedArray<? extends T>>
        extends ReversedArrayAsSortedSet<T, SOURCE, REVERSED_ARRAY>
        implements NavigableSet<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = 3788881792972178843L;

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public ReversedArrayAsNavigableSet(SOURCE source, REVERSED_ARRAY reversedArray) { super(source, reversedArray); }
