...
@NotNullByDefault
public class ImmutableLinkedTransferQueueOf1<T>
        extends ImmutableLinkedTransferQueue<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = 4174179292201906498L;
    ...
    public ImmutableLinkedTransferQueueOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableLinkedTransferQueueOf1<T> clone() {
        return (ImmutableLinkedTransferQueueOf1<T>) super.clone();
    }
