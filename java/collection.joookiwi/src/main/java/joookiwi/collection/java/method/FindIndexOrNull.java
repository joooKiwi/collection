...
@NotNullByDefault
public final class FindIndexOrNull
        extends AliasUtility {

    @Contract(ALWAYS_FAIL_0)
    private FindIndexOrNull() { throw new ImpossibleConstructionException("The utility class “FindFirstIndexOrNull” cannot be constructed.", FindIndexOrNull.class); }
    ...
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexOrNull(final @Nullable MinimalistCollectionHolder<? extends T> collection,
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexOrNull(final @Nullable CollectionHolder<? extends T> collection,
                                                                                                                      final ObjIntPredicate<? super T> predicate) { return IndexOfFirstOrNull.indexOfFirstOrNull(collection, predicate); }
    ...
    @OnlyGivePositiveValue
    @Contract(IF_1ST_NULL_THEN_NULL_2)
    public static <T extends @Nullable Object> @Range(from = 0, to = MAX_INT_VALUE) @Nullable Integer findIndexOrNull(final T @Nullable @Unmodifiable [] collection,
                                                                                                                      final ObjIntPredicate<? super T> predicate) { return IndexOfFirstOrNull.indexOfFirstOrNull(collection, predicate); }
