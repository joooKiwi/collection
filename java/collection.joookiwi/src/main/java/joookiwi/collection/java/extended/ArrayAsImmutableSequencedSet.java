...
@NotNullByDefault
public class ArrayAsImmutableSequencedSet<T extends @Nullable Object>
    ...
    public ArrayAsImmutableSequencedSet(final T[] reference) {
        super();
    ...
    @Override public ArrayAsImmutableSequencedSet<T> clone() { return new ArrayAsImmutableSequencedSet<>(_reference().clone()); }
