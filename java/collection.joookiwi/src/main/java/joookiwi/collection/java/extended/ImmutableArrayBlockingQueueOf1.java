...
@NotNullByDefault
public class ImmutableArrayBlockingQueueOf1<T>
        extends ImmutableArrayBlockingQueue<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = -5134544131398205511L;
    ...
    public ImmutableArrayBlockingQueueOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableArrayBlockingQueueOf1<T> clone() {
        return (ImmutableArrayBlockingQueueOf1<T>) super.clone();
    }
