...
@NotNullByDefault
public class ImmutableCopyOnWriteArraySetOf1<T>
        extends ImmutableCopyOnWriteArraySet<T>
        implements ClassWith1Value<T> {

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = -76605094595452285L;
    ...
    public ImmutableCopyOnWriteArraySetOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Contract(ALWAYS_NEW_0)
    @Override public ImmutableCopyOnWriteArraySetOf1<T> clone() {
        return (ImmutableCopyOnWriteArraySetOf1<T>) super.clone();
    }
