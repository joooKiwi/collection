...
public class ArrayAsImmutableSortedSet<T extends @Nullable Object>
    ...
    public ArrayAsImmutableSortedSet(final T[] reference) {
        super();
    ...
    public ArrayAsImmutableSortedSet(final T[] reference, final @Nullable Comparator<? super T> comparator) {
        super();
    ...
    @Override public ArrayAsImmutableSortedSet<T> clone() { return new ArrayAsImmutableSortedSet<>(_reference().clone(), comparator()); }
