...
///                          (generally a [ArrayAsImmutableSequencedSet] or [ReversedArrayAsImmutableSequencedSet])
...
public class ReversedArrayAsImmutableSequencedSet<T extends @Nullable Object,
    ...
    public ReversedArrayAsImmutableSequencedSet(final SOURCE source,
    ...
    @Override public ReversedArrayAsImmutableSequencedSet<T, SOURCE, REVERSED_ARRAY> clone() { return new ReversedArrayAsImmutableSequencedSet<>(_source(), _reversedArray()); }
