...
public interface ImmutableSequencedCollection<T extends @Nullable Object>
    ...
    /// Fail to add a `value` to the current [instance][ImmutableSequencedCollection]
    ///
    ...
    /// Fail to add the `values` in the current [instance][ImmutableSequencedCollection]
    ///
    ...
    /// Fail to clear the current [instance][ImmutableSequencedCollection]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    ...
    /// Fail to remove a `value` in the current [instance][ImmutableSequencedCollection]
    ///
    ...
    /// Fail to remove the first value in the current [instance][ImmutableSequencedCollection]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove the last value in the current [instance][ImmutableSequencedCollection]
    ///
    /// @throws UnsupportedMethodException The method is not supported
    @Contract(ALWAYS_FAIL_0)
    ...
    /// Fail to remove the `values` in the current [instance][ImmutableSequencedCollection]
    ///
    ...
    /// Fail to remove anything to the current [instance][ImmutableSequencedCollection]
    ///
    ...
    /// Fail to keep the `values` in the current [instance][ImmutableSequencedCollection]
    ///
