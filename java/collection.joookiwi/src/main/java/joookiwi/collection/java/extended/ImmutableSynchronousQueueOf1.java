...
@NotNullByDefault
public class ImmutableSynchronousQueueOf1<T>
        extends ImmutableSynchronousQueue<T>
        implements ClassWith1Value<T> {
    //TODO: verify how synchronousQueue operate to have its values processed

    //#region -------------------- Fields --------------------

    @Serial private static final long serialVersionUID = 2820496538957105877L;
    ...
    public ImmutableSynchronousQueueOf1(final T value) {
        super();
        __value = value;
    }
    ...
    @Override public ImmutableSynchronousQueueOf1<T> clone() {
        return (ImmutableSynchronousQueueOf1<T>) super.clone();
    }
