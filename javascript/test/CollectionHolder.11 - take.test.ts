...
describe("CollectionHolderTest (take)", () => {
    ...
    describe("aliases", () => {
        ...
        describe("ArrayOf1AsCollectionHolder", () => {
            test("takeLast",              () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.takeLast(0,),)                            .take_amountOfCall,)            .toBe(1,),)
            test("takeLastWhile",         () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.takeLastWhile(callbackAsFalse0,),)        .takeWhile_amountOfCall,)       .toBe(1,),)
            test("takeLastWhileIndexed",  () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.takeLastWhileIndexed(callbackAsFalse0,),) .takeWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("limitLast",             () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.limitLast(0,),)                           .take_amountOfCall,)            .toBe(1,),)
            test("limitLastWhile",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.limitLastWhile(callbackAsFalse0,),)       .takeWhile_amountOfCall,)       .toBe(1,),)
            test("limitLastWhileIndexed", () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.limitLastWhileIndexed(callbackAsFalse0,),).takeWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("CollectionHolderOf1", () => {
            test("takeLast",              () => expect(new CollectionHolder_1Follower().execute(it => it.takeLast(0,),)                            .take_amountOfCall,)            .toBe(1,),)
            test("takeLastWhile",         () => expect(new CollectionHolder_1Follower().execute(it => it.takeLastWhile(callbackAsFalse0,),)        .takeWhile_amountOfCall,)       .toBe(1,),)
            test("takeLastWhileIndexed",  () => expect(new CollectionHolder_1Follower().execute(it => it.takeLastWhileIndexed(callbackAsFalse0,),) .takeWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("limitLast",             () => expect(new CollectionHolder_1Follower().execute(it => it.limitLast(0,),)                           .take_amountOfCall,)            .toBe(1,),)
            test("limitLastWhile",        () => expect(new CollectionHolder_1Follower().execute(it => it.limitLastWhile(callbackAsFalse0,),)       .takeWhile_amountOfCall,)       .toBe(1,),)
            test("limitLastWhileIndexed", () => expect(new CollectionHolder_1Follower().execute(it => it.limitLastWhileIndexed(callbackAsFalse0,),).takeWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("LazyCollectionHolderOf1", () => {
            test("takeLast",              () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.takeLast(0,),)                            .take_amountOfCall,)            .toBe(1,),)
            test("takeLastWhile",         () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.takeLastWhile(callbackAsFalse0,),)        .takeWhile_amountOfCall,)       .toBe(1,),)
            test("takeLastWhileIndexed",  () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.takeLastWhileIndexed(callbackAsFalse0,),) .takeWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("limitLast",             () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.limitLast(0,),)                           .take_amountOfCall,)            .toBe(1,),)
            test("limitLastWhile",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.limitLastWhile(callbackAsFalse0,),)       .takeWhile_amountOfCall,)       .toBe(1,),)
            test("limitLastWhileIndexed", () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.limitLastWhileIndexed(callbackAsFalse0,),).takeWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("SetOf1AsCollectionHolder", () => {
            test("takeLast",              () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.takeLast(0,),)                            .take_amountOfCall,)            .toBe(1,),)
            test("takeLastWhile",         () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.takeLastWhile(callbackAsFalse0,),)        .takeWhile_amountOfCall,)       .toBe(1,),)
            test("takeLastWhileIndexed",  () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.takeLastWhileIndexed(callbackAsFalse0,),) .takeWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("limitLast",             () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.limitLast(0,),)                           .take_amountOfCall,)            .toBe(1,),)
            test("limitLastWhile",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.limitLastWhile(callbackAsFalse0,),)       .takeWhile_amountOfCall,)       .toBe(1,),)
            test("limitLastWhileIndexed", () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.limitLastWhileIndexed(callbackAsFalse0,),).takeWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("limit", () => {
            test("all", () => {
                const method = vi.spyOn(takeModule, "take",)
                limit(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeModule, "takeByMinimalistCollectionHolder",)
                limitByMinimalistCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeModule, "takeByCollectionHolder",)
                limitByCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeModule, "takeByArray",)
                limitByArray(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
        },)
        describe("limitWhile", () => {
            test("all", () => {
                const method = vi.spyOn(takeWhileModule, "takeWhile",)
                limitWhile(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeWhileModule, "takeWhileByMinimalistCollectionHolder",)
                limitWhileByMinimalistCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeWhileModule, "takeWhileByCollectionHolder",)
                limitWhileByCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeWhileModule, "takeWhileByArray",)
        ...
        describe("limitWhileIndexed", () => {
            test("all", () => {
                const method = vi.spyOn(takeWhileIndexedModule, "takeWhileIndexed",)
                limitWhileIndexed(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeWhileIndexedModule, "takeWhileIndexedByMinimalistCollectionHolder",)
                limitWhileIndexedByMinimalistCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeWhileIndexedModule, "takeWhileIndexedByCollectionHolder",)
                limitWhileIndexedByCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeWhileIndexedModule, "takeWhileIndexedByArray",)
        ...
        describe("limitLast", () => {
            test("all", () => {
                const method = vi.spyOn(takeLastModule, "takeLast",)
                limitLast(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeLastModule, "takeLastByMinimalistCollectionHolder",)
                limitLastByMinimalistCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeLastModule, "takeLastByCollectionHolder",)
                limitLastByCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeLastModule, "takeLastByArray",)
        ...
        describe("limitLastWhile", () => {
            test("all", () => {
                const method = vi.spyOn(takeLastWhileModule, "takeLastWhile",)
                limitLastWhile(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeLastWhileModule, "takeLastWhileByMinimalistCollectionHolder",)
                limitLastWhileByMinimalistCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeLastWhileModule, "takeLastWhileByCollectionHolder",)
                limitLastWhileByCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeLastWhileModule, "takeLastWhileByArray",)
        ...
        describe("limitLastWhileIndexed", () => {
            test("all", () => {
                const method = vi.spyOn(takeLastWhileIndexedModule, "takeLastWhileIndexed",)
                limitLastWhileIndexed(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(takeLastWhileIndexedModule, "takeLastWhileIndexedByMinimalistCollectionHolder",)
                limitLastWhileIndexedByMinimalistCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(takeLastWhileIndexedModule, "takeLastWhileIndexedByCollectionHolder",)
                limitLastWhileIndexedByCollectionHolder(null, callbackAsTrue0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(takeLastWhileIndexedModule, "takeLastWhileIndexedByArray",)
    ...
    describe("get() being called", () => {
        ...
        describe("empty ~ collection (by minimalist)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
        },)
        describe("empty ~ collection (by normal)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
        },)

        describe("1 field ~ collection (by minimalist)", () => {
            describe("take", () => {
                test('0',  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1',  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2',  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(1,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(1,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)
        describe("1 field ~ collection (by normal)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(1,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(1,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(1,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)

        describe("2 fields ~ collection (by minimalist)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.take(3,),).amountOfCall,).toBe(2,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(3,),).amountOfCall,).toBe(2,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)
        describe("2 fields ~ collection (by normal)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.take(3,),).amountOfCall,).toBe(2,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLast(3,),).amountOfCall,).toBe(2,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(2,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)

        describe("N fields ~ collection (by minimalist)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(3,),).amountOfCall,).toBe(3,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.take(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(3,),).amountOfCall,).toBe(3,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)
        describe("N fields ~ collection (by normal)", () => {
            describe("take", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(3,),).amountOfCall,).toBe(3,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.take(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)

            describe("takeLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(3,),).amountOfCall,).toBe(3,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
            describe("takeLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
            },)
        },)
    ...
    describe("viewer", () => {
        test("take",                 () => expect(new CollectionHolder_ByViewer().execute(it => it.take(0,),)                              .take_amountOfCall,)                .toBe(1,),)
        test("takeWhile",            () => expect(new CollectionHolder_ByViewer().execute(it => it.takeWhile(callbackAsTrue0,),)           .takeWhile_amountOfCall,)           .toBe(1,),)
        test("takeWhileIndexed",     () => expect(new CollectionHolder_ByViewer().execute(it => it.takeWhileIndexed(callbackAsTrue0,),)    .takeWhileIndexed_amountOfCall,)    .toBe(1,),)
        test("takeLast",             () => expect(new CollectionHolder_ByViewer().execute(it => it.takeLast(0,),)                          .takeLast_amountOfCall,)            .toBe(1,),)
        test("takeLastWhile",        () => expect(new CollectionHolder_ByViewer().execute(it => it.takeLastWhile(callbackAsTrue0,),)       .takeLastWhile_amountOfCall,)       .toBe(1,),)
        test("takeLastWhileIndexed", () => expect(new CollectionHolder_ByViewer().execute(it => it.takeLastWhileIndexed(callbackAsTrue0,),).takeLastWhileIndexed_amountOfCall,).toBe(1,),)
    },)
