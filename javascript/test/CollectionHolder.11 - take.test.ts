    ...
    describe("get() being called", () => {
        ...
        describe("N fields ~ collection (by normal)", () => {
            describe("take", () => {
                ...
                test('4', () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.take(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.take(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeWhile", () => {
            ...
            describe("takeLast", () => {
                ...
                test('4', () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(4,),).amountOfCall,).toBe(4,),)
                test('5', () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLast(5,),).amountOfCall,).toBe(4,),)
            },)
            describe("takeLastWhile", () => {
                ...
                test("() → true",           () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
            ...
            describe("takeLastWhileIndexed", () => {
                ...
                test("(number) → true",     () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_ByGenericCollection(ABCD,).executeWhileHavingIndexesOnField(it => it.takeLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(4,),)
