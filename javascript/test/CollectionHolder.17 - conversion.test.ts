...
describe("CollectionHolderTest (conversion)", () => {
    ...
    describe("EmptyCollectionHolder", () => {
        ...
        test("toWeakSet",                () => expect(instance.toWeakSet(),)              .toBe(EmptyConstants.EMPTY_WEAK_SET,),)
        ...
        test("toMap",                    () => expect(instance.toMap(),)                  .toBe(EmptyConstants.EMPTY_MAP,),)
        ...
        test("toWeakMap",                () => expect(instance.toWeakMap(),)              .toBe(EmptyConstants.EMPTY_WEAK_MAP,),)
        ...
        test("toString",                 () => expect(instance.toString(),)               .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        test("toLocaleString",           () => expect(instance.toLocaleString(),)         .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        test("toLowerCaseString",        () => expect(instance.toLowerCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        test("toLocaleLowerCaseString",  () => expect(instance.toLocaleLowerCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        test("toUpperCaseString",        () => expect(instance.toUpperCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        test("toLocaleUpperCaseString",  () => expect(instance.toLocaleUpperCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
    },)
    ...
    describe.each(everyExtensionMethodInstances,)("%s", ({value: {instance: instance,},},) => {
        ...
        describe("toArray",                 () => expect(instance.toArray(),)                .toBe(EmptyConstants.EMPTY_ARRAY,),)
        describe("toMutableArray",          () => expect(instance.toMutableArray(),)         .toEqual(EmptyConstants.EMPTY_ARRAY,),)
        describe("toSet",                   () => expect(instance.toSet(),)                  .toBe(EmptyConstants.EMPTY_SET,),)
        describe("toMutableSet",            () => expect(instance.toMutableSet(),)           .toEqual(EmptyConstants.EMPTY_SET,),)
        // describe("toWeakSet",               () => expect(instance.toWeakSet(),)              .toBe(EmptyConstants.EMPTY_WEAK_SET,),)
        // describe("toMutableWeakSet",        () => expect(instance.toMutableWeakSet(),)       .toEqual(EmptyConstants.EMPTY_WEAK_SET,),)
        describe("toMap",                   () => expect(instance.toMap(),)                  .toBe(EmptyConstants.EMPTY_MAP,),)
        describe("toMutableMap",            () => expect(instance.toMutableMap(),)           .toEqual(EmptyConstants.EMPTY_MAP,),)
        describe("toString",                () => expect(instance.toString(),)               .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleString",          () => expect(instance.toLocaleString(),)         .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLowerCaseString",       () => expect(instance.toLowerCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleLowerCaseString", () => expect(instance.toLocaleLowerCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toUpperCaseString",       () => expect(instance.toUpperCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleUpperCaseString", () => expect(instance.toLocaleUpperCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
    },)},)
    ...
    describe("instances", () => {
        ...
        describe.each(every0Instances,)("%s", ({value: {newInstance,},},) => {
            ...
            test("toArray",                 () => expect(newInstance().toArray(),)                .toBe(EmptyConstants.EMPTY_ARRAY,),)
            test("toMutableArray",          () => expect(newInstance().toMutableArray(),)         .toStrictEqual(EmptyConstants.EMPTY_ARRAY,),)
            test("toMutableArray: frozen",  () => expect(newInstance().toMutableArray(),)         .not.toBeFrozen(),)
            test("toSet",                   () => expect(newInstance().toSet(),)                  .toBe(EmptyConstants.EMPTY_SET,),)
            ...
            test("toMap",                   () => expect(newInstance().toMap(),)                  .toBe(EmptyConstants.EMPTY_MAP,),)
            ...
            test("toString",                () => expect(newInstance().toString(),)               .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
            test("toLocaleString",          () => expect(newInstance().toLocaleString(),)         .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
            test("toLowerCaseString",       () => expect(newInstance().toLowerCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
            test("toLocaleLowerCaseString", () => expect(newInstance().toLocaleLowerCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
            test("toUpperCaseString",       () => expect(newInstance().toUpperCaseString(),)      .toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
            test("toLocaleUpperCaseString", () => expect(newInstance().toLocaleUpperCaseString(),).toBe(DefaultConstants.DEFAULT_EMPTY_COLLECTION,),)
        },)},)
        describe("1 field", () => {
