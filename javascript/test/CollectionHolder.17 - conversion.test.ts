...
describe("CollectionHolderTest (conversion)", () => {
    ...
    describe.each(everyExtensionMethodInstances,)("%s", ({value: {instance: instance,},},) => {
        describe("toIterator",              () => expect(instance.toIterator(),).toEqual(CollectionConstants.EMPTY_COLLECTION_ITERATOR,),)
        describe("toArray",                 () => expect(instance.toArray() === CollectionConstants.EMPTY_ARRAY,).toBeTrue(),)
        describe("toMutableArray",          () => expect(instance.toMutableArray(),).toEqual(CollectionConstants.EMPTY_ARRAY,),)
        describe("toSet",                   () => expect(instance.toSet() === CollectionConstants.EMPTY_SET,).toBeTrue(),)
        describe("toMutableSet",            () => expect(instance.toMutableSet(),).toEqual(CollectionConstants.EMPTY_SET,),)
        // describe("toWeakSet",               () => expect(instance.toWeakSet() === CollectionConstants.EMPTY_WEAK_SET,).toBeTrue(),)
        // describe("toMutableWeakSet",        () => expect(instance.toMutableWeakSet(),).toEqual(CollectionConstants.EMPTY_WEAK_SET,),)
        describe("toMap",                   () => expect(instance.toMap() === CollectionConstants.EMPTY_MAP,).toBeTrue(),)
        describe("toMutableMap",            () => expect(instance.toMutableMap(),).toEqual(CollectionConstants.EMPTY_MAP,),)

        describe("toString",                () => expect(instance.toString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleString",          () => expect(instance.toLocaleString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLowerCaseString",       () => expect(instance.toLowerCaseString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleLowerCaseString", () => expect(instance.toLocaleLowerCaseString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toUpperCaseString",       () => expect(instance.toUpperCaseString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
        describe("toLocaleUpperCaseString", () => expect(instance.toLocaleUpperCaseString(),).toEqual(CollectionConstants.DEFAULT_EMPTY_COLLECTION,),)
    },)},)
