...
describe("CollectionHolderTest (find)", () => {
    ...
    describe("EmptyCollectionHolder", () => {
        test("find",                   () => expect(() => new EmptyCollectionHolderForTest().find(),).toThrow(EmptyCollectionHolderException,),)
        test("findOrNull",             () => expect(new EmptyCollectionHolderForTest().findOrNull(),).toBeNull(),)
        test("findIndexed",            () => expect(() => new EmptyCollectionHolderForTest().findIndexed(),).toThrow(EmptyCollectionHolderException,),)
        test("findIndexedOrNull",      () => expect(new EmptyCollectionHolderForTest().findIndexedOrNull(),).toBeNull(),)
        test("findFirst",              () => expect(() => new EmptyCollectionHolderForTest().findFirst(),).toThrow(EmptyCollectionHolderException,),)
        test("findFirstOrNull",        () => expect(new EmptyCollectionHolderForTest().findFirstOrNull(),).toBeNull(),)
        test("findFirstIndexed",       () => expect(() => new EmptyCollectionHolderForTest().findFirstIndexed(),).toThrow(EmptyCollectionHolderException,),)
        test("findFirstIndexedOrNull", () => expect(new EmptyCollectionHolderForTest().findFirstIndexedOrNull(),).toBeNull(),)
        test("findLast",               () => expect(() => new EmptyCollectionHolderForTest().findLast(),).toThrow(EmptyCollectionHolderException,),)
        test("findLastOrNull",         () => expect(new EmptyCollectionHolderForTest().findLastOrNull(),).toBeNull(),)
        test("findLastIndexed",        () => expect(() => new EmptyCollectionHolderForTest().findLastIndexed(),).toThrow(EmptyCollectionHolderException,),)
    ...
    describe.each(everyCollectionInstancesAndExtensionFunctionAsCollectionHolder,)("%s", ({value: {instance, isExtension,},},) => {
        if (!isExtension)
            describe("get() being called", () => {
                describe("findFirst", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirst(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirst(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirst(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                        test("2 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                        test("2 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                        test("2 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirst(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("findFirstIndexed", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirstIndexed(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirstIndexed(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findFirstIndexed(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("findLast", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLast(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLast(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLast(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                        test("2 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                        test("2 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                        test("2 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLast(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("findLastIndexed", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLastIndexed(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLastIndexed(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.findLastIndexed(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("0 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("1 argument: false",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments: false", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.findLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
        ...
        describe("findFirst", () => {
            describe("empty", () => {
                test("0 arguments", () => expect(() => new instance(EMPTY,).findFirst(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("1 argument",  () => expect(() => new instance(EMPTY,).findFirst(callbackAsFail1,),).toThrow(EmptyCollectionHolderException,),)
                test("2 arguments", () => expect(() => new instance(EMPTY,).findFirst(callbackAsFail2,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                ...
                describe.each(falseCallbacks,)("true: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).findFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).findFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).findFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).findFirst(callbackIsA,),).toBe('a',),)
                test('e',    () => expect(() => new instance(A,).findFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).findFirst(callbackIsEvenAlt,),).toBe('a',),)
                test("odd",  () => expect(() => new instance(A,).findFirst(callbackIsOddAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).findFirst(callbackIs0Alt,),).toBe('a',),)
                test('4',    () => expect(() => new instance(A,).findFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('a',    () => expect(new instance(AB,).findFirst(callbackIsA,),).toBe('a',),)
                test('b',    () => expect(new instance(AB,).findFirst(callbackIsB,),).toBe('b',),)
                test('e',    () => expect(() => new instance(AB,).findFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(() => new instance(AB,).findFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).findFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).findFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("findFirstOrNull", () => {
            describe("empty", () => {
        ...
        describe("findFirstIndexed", () => {
            describe("empty", () => {
                test("0 arguments", () => expect(() => new instance(EMPTY,).findFirstIndexed(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("1 argument",  () => expect(() => new instance(EMPTY,).findFirstIndexed(callbackAsFail1,),).toThrow(EmptyCollectionHolderException,),)
                test("2 arguments", () => expect(() => new instance(EMPTY,).findFirstIndexed(callbackAsFail2,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                describe.each(trueCallbacks,)("true: %s", ({value: it,},) => {
                ...
                describe.each(falseCallbacks,)("true: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).findFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).findFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).findFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).findFirstIndexed(callbackIsAAlt,),).toBe('a',),)
                test('e',    () => expect(() => new instance(A,).findFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).findFirstIndexed(callbackIsEven,),).toBe('a',),)
                test("odd",  () => expect(() => new instance(A,).findFirstIndexed(callbackIsOdd,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).findFirstIndexed(callbackIs0,),).toBe('a',),)
                test('4',    () => expect(() => new instance(A,).findFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                ...
                test('e',    () => expect(() => new instance(AB,).findFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(AB,).findFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).findFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).findFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("findFirstIndexedOrNull", () => {
            describe("empty", () => {
        ...
        describe("findLast", () => {
            describe("empty", () => {
                test("0 arguments", () => expect(() => new instance(EMPTY,).findLast(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("1 argument",  () => expect(() => new instance(EMPTY,).findLast(callbackAsFail1,),).toThrow(EmptyCollectionHolderException,),)
                test("2 arguments", () => expect(() => new instance(EMPTY,).findLast(callbackAsFail2,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                describe.each(trueCallbacks,)("true: %s", ({value: it,},) => {
                ...
                describe.each(falseCallbacks,)("true: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).findLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).findLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).findLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).findLast(callbackIsA,),).toBe('a',),)
                test('e',    () => expect(() => new instance(A,).findLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).findLast(callbackIsEvenAlt,),).toBe('a',),)
                test("odd",  () => expect(() => new instance(A,).findLast(callbackIsOddAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).findLast(callbackIs0Alt,),).toBe('a',),)
                test('4',    () => expect(() => new instance(A,).findLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('a',    () => expect(new instance(AB,).findLast(callbackIsA,),).toBe('a',),)
                test('b',    () => expect(new instance(AB,).findLast(callbackIsB,),).toBe('b',),)
                test('e',    () => expect(() => new instance(AB,).findLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(() => new instance(AB,).findLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).findLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).findLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("findLastOrNull", () => {
            describe("empty", () => {
        ...
        describe("findLastIndexed", () => {
            describe("empty", () => {
                test("0 arguments", () => expect(() => new instance(EMPTY,).findLastIndexed(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("1 argument",  () => expect(() => new instance(EMPTY,).findLastIndexed(callbackAsFail1,),).toThrow(EmptyCollectionHolderException,),)
                test("2 arguments", () => expect(() => new instance(EMPTY,).findLastIndexed(callbackAsFail2,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                describe.each(trueCallbacks,)("true: %s", ({value: it,},) => {
                ...
                describe.each(falseCallbacks,)("true: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).findLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).findLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).findLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).findLastIndexed(callbackIsAAlt,),).toBe('a',),)
                test('e',    () => expect(() => new instance(A,).findLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).findLastIndexed(callbackIsEven,),).toBe('a',),)
                test("odd",  () => expect(() => new instance(A,).findLastIndexed(callbackIsOdd,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).findLastIndexed(callbackIs0,),).toBe('a',),)
                test('4',    () => expect(() => new instance(A,).findLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                ...
                test('e',    () => expect(() => new instance(AB,).findLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(AB,).findLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).findLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).findLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("findLastIndexedOrNull", () => {
            describe("empty", () => {
