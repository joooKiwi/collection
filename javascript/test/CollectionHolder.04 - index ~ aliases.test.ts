...
describe("CollectionHolderTest (index) ~ aliases", () => {
    ...
    describe("ArrayOf1AsCollectionHolder", () => {
        ...
        test("indexOfLast",                 () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.indexOfLast(callbackAsTrue0,),)                .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("indexOfLastOrNull",           () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.indexOfLastOrNull(callbackAsTrue0,),)          .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("indexOfLastIndexed",          () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.indexOfLastIndexed(callbackAsTrue0,),)         .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("indexOfLastIndexedOrNull",    () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.indexOfLastIndexedOrNull(callbackAsTrue0,),)   .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
        ...
        test("findLastIndex",               () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.findLastIndex(callbackAsTrue0,),)              .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("findLastIndexOrNull",         () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.findLastIndexOrNull(callbackAsTrue0,),)        .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("findLastIndexIndexed",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.findLastIndexIndexed(callbackAsTrue0,),)       .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("findLastIndexIndexedOrNull",  () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.findLastIndexIndexedOrNull(callbackAsTrue0,),) .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
    },)
    ...
    describe("CollectionHolderOf1", () => {
        ...
        test("indexOfLast",                 () => expect(new CollectionHolder_1Follower().execute(it => it.indexOfLast(callbackAsTrue0,),)                .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("indexOfLastOrNull",           () => expect(new CollectionHolder_1Follower().execute(it => it.indexOfLastOrNull(callbackAsTrue0,),)          .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("indexOfLastIndexed",          () => expect(new CollectionHolder_1Follower().execute(it => it.indexOfLastIndexed(callbackAsTrue0,),)         .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("indexOfLastIndexedOrNull",    () => expect(new CollectionHolder_1Follower().execute(it => it.indexOfLastIndexedOrNull(callbackAsTrue0,),)   .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
        ...
        test("findLastIndex",               () => expect(new CollectionHolder_1Follower().execute(it => it.findLastIndex(callbackAsTrue0,),)              .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("findLastIndexOrNull",         () => expect(new CollectionHolder_1Follower().execute(it => it.findLastIndexOrNull(callbackAsTrue0,),)        .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("findLastIndexIndexed",        () => expect(new CollectionHolder_1Follower().execute(it => it.findLastIndexIndexed(callbackAsTrue0,),)       .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("findLastIndexIndexedOrNull",  () => expect(new CollectionHolder_1Follower().execute(it => it.findLastIndexIndexedOrNull(callbackAsTrue0,),) .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
    },)
    ...
    describe("LazyCollectionHolderOf0Or1", () => {
        ...
        test("findLastIndex",               () => expect(new CollectionHolder_LazyOf0Or1Follower().execute(it => it.findLastIndex(callbackAsTrue0,),)              .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("findLastIndexOrNull",         () => expect(new CollectionHolder_LazyOf0Or1Follower().execute(it => it.findLastIndexOrNull(callbackAsTrue0,),)        .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("findLastIndexIndexed",        () => expect(new CollectionHolder_LazyOf0Or1Follower().execute(it => it.findLastIndexIndexed(callbackAsTrue0,),)       .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("findLastIndexIndexedOrNull",  () => expect(new CollectionHolder_LazyOf0Or1Follower().execute(it => it.findLastIndexIndexedOrNull(callbackAsTrue0,),) .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
    },)
    ...
    describe("LazyCollectionHolderOf1", () => {
        ...
        test("indexOfLast",                 () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.indexOfLast(callbackAsTrue0,),)                .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("indexOfLastOrNull",           () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.indexOfLastOrNull(callbackAsTrue0,),)          .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("indexOfLastIndexed",          () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.indexOfLastIndexed(callbackAsTrue0,),)         .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("indexOfLastIndexedOrNull",    () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.indexOfLastIndexedOrNull(callbackAsTrue0,),)   .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
        ...
        test("findLastIndex",               () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.findLastIndex(callbackAsTrue0,),)              .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("findLastIndexOrNull",         () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.findLastIndexOrNull(callbackAsTrue0,),)        .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("findLastIndexIndexed",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.findLastIndexIndexed(callbackAsTrue0,),)       .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("findLastIndexIndexedOrNull",  () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.findLastIndexIndexedOrNull(callbackAsTrue0,),) .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
    },)
    ...
    describe("SetOf1AsCollectionHolder", () => {
        ...
        test("indexOfLast",                 () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.indexOfLast(callbackAsTrue0,),)                .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("indexOfLastOrNull",           () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.indexOfLastOrNull(callbackAsTrue0,),)          .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("indexOfLastIndexed",          () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.indexOfLastIndexed(callbackAsTrue0,),)         .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("indexOfLastIndexedOrNull",    () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.indexOfLastIndexedOrNull(callbackAsTrue0,),)   .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
        ...
        test("findLastIndex",               () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.findLastIndex(callbackAsTrue0,),)              .indexOfFirst_amountOfCall,)             .toBe(1,),)
        test("findLastIndexOrNull",         () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.findLastIndexOrNull(callbackAsTrue0,),)        .indexOfFirstOrNull_amountOfCall,)       .toBe(1,),)
        test("findLastIndexIndexed",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.findLastIndexIndexed(callbackAsTrue0,),)       .indexOfFirstIndexed_amountOfCall,)      .toBe(1,),)
        test("findLastIndexIndexedOrNull",  () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.findLastIndexIndexedOrNull(callbackAsTrue0,),) .indexOfFirstIndexedOrNull_amountOfCall,).toBe(1,),)
    },)
    ...
    describe("indexOf", () => {
        test("all", () => {
            const method = vi.spyOn(firstIndexOfModule, "firstIndexOf",)
            indexOf(A, "a",)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(firstIndexOfModule, "firstIndexOfByMinimalistCollectionHolder",)
            indexOfByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), "a",)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(firstIndexOfModule, "firstIndexOfByCollectionHolder",)
            indexOfByCollectionHolder(new CollectionHolderFromArray(A,), "a",)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(firstIndexOfModule, "firstIndexOfByArray",)
            indexOfByArray(A, "a",)
            expect(method,).toHaveBeenCalledOnce()
        },)
    },)
    describe("indexOfOrNull", () => {
        test("all", () => {
            const method = vi.spyOn(firstIndexOfOrNullModule, "firstIndexOfOrNull",)
            indexOfOrNull(null, null,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(firstIndexOfOrNullModule, "firstIndexOfOrNullByMinimalistCollectionHolder",)
            indexOfOrNullByMinimalistCollectionHolder(null, null,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(firstIndexOfOrNullModule, "firstIndexOfOrNullByCollectionHolder",)
            indexOfOrNullByCollectionHolder(null, null,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(firstIndexOfOrNullModule, "firstIndexOfOrNullByArray",)
    ...
    describe("findFirstIndex", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfFirstModule, "indexOfFirst",)
            findFirstIndex(A, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfFirstModule, "indexOfFirstByMinimalistCollectionHolder",)
            findFirstIndexByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfFirstModule, "indexOfFirstByCollectionHolder",)
            findFirstIndexByCollectionHolder(new CollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfFirstModule, "indexOfFirstByArray",)
    ...
    describe("findFirstIndexOrNull", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfFirstOrNullModule, "indexOfFirstOrNull",)
            findFirstIndexOrNull(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfFirstOrNullModule, "indexOfFirstOrNullByMinimalistCollectionHolder",)
            findFirstIndexOrNullByMinimalistCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfFirstOrNullModule, "indexOfFirstOrNullByCollectionHolder",)
            findFirstIndexOrNullByCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfFirstOrNullModule, "indexOfFirstOrNullByArray",)
    ...
    describe("findFirstIndexIndexed", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfFirstIndexedModule, "indexOfFirstIndexed",)
            findFirstIndexIndexed(A, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfFirstIndexedModule, "indexOfFirstIndexedByMinimalistCollectionHolder",)
            findFirstIndexIndexedByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfFirstIndexedModule, "indexOfFirstIndexedByCollectionHolder",)
            findFirstIndexIndexedByCollectionHolder(new CollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfFirstIndexedModule, "indexOfFirstIndexedByArray",)
    ...
    describe("findFirstIndexIndexedOrNull", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfFirstIndexedOrNullModule, "indexOfFirstIndexedOrNull",)
            findFirstIndexIndexedOrNull(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfFirstIndexedOrNullModule, "indexOfFirstIndexedOrNullByMinimalistCollectionHolder",)
            findFirstIndexIndexedOrNullByMinimalistCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfFirstIndexedOrNullModule, "indexOfFirstIndexedOrNullByCollectionHolder",)
            findFirstIndexIndexedOrNullByCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfFirstIndexedOrNullModule, "indexOfFirstIndexedOrNullByArray",)
    ...
    describe("findLastIndex", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfLastModule, "indexOfLast",)
            findLastIndex(A, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfLastModule, "indexOfLastByMinimalistCollectionHolder",)
            findLastIndexByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfLastModule, "indexOfLastByCollectionHolder",)
            findLastIndexByCollectionHolder(new CollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfLastModule, "indexOfLastByArray",)
    ...
    describe("findLastIndexOrNull", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfLastOrNullModule, "indexOfLastOrNull",)
            findLastIndexOrNull(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfLastOrNullModule, "indexOfLastOrNullByMinimalistCollectionHolder",)
            findLastIndexOrNullByMinimalistCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfLastOrNullModule, "indexOfLastOrNullByCollectionHolder",)
            findLastIndexOrNullByCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfLastOrNullModule, "indexOfLastOrNullByArray",)
    ...
    describe("findLastIndexIndexed", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfLastIndexedModule, "indexOfLastIndexed",)
            findLastIndexIndexed(A, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfLastIndexedModule, "indexOfLastIndexedByMinimalistCollectionHolder",)
            findLastIndexIndexedByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfLastIndexedModule, "indexOfLastIndexedByCollectionHolder",)
            findLastIndexIndexedByCollectionHolder(new CollectionHolderFromArray(A,), callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfLastIndexedModule, "indexOfLastIndexedByArray",)
    ...
    describe("findLastIndexIndexedOrNull", () => {
        test("all", () => {
            const method = vi.spyOn(indexOfLastIndexedOrNullModule, "indexOfLastIndexedOrNull",)
            findLastIndexIndexedOrNull(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("minimalist collection holder", () => {
            const method = vi.spyOn(indexOfLastIndexedOrNullModule, "indexOfLastIndexedOrNullByMinimalistCollectionHolder",)
            findLastIndexIndexedOrNullByMinimalistCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("collection holder", () => {
            const method = vi.spyOn(indexOfLastIndexedOrNullModule, "indexOfLastIndexedOrNullByCollectionHolder",)
            findLastIndexIndexedOrNullByCollectionHolder(null, callbackAsTrue0,)
            expect(method,).toHaveBeenCalledOnce()
        },)
        test("array", () => {
            const method = vi.spyOn(indexOfLastIndexedOrNullModule, "indexOfLastIndexedOrNullByArray",)
