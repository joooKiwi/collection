...
describe("CollectionHolderTest (constructor)", () => {
    ...
    describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
        const newCollection = <const T, >(values: readonly T[],) => new GenericMinimalistCollectionHolder_ConstructorTest(new iterable(values,),).array
    ...
    describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
        const newCollection = <const T, >(values: readonly T[],) => new GenericCollectionHolder_ConstructorTest(new iterable(values,),)
