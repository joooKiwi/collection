...
describe("CollectionIteratorTest", () => {
    ...
    describe("GenericCollectionIterator", () => {
        ...
        describe.each(iterableCreation,)("%s", ({value: iterableCreation,},) => {
            ...
            type PossibleValue = typeof ABCDEFGHIJ[number]
            ...
            beforeEach(() => instance = new GenericCollectionIterator(newCollectionInstance(iterableCreation, ABCDEFGHIJ,),) as unknown as GenericCollectionIterator<typeof ABCDEFGHIJ[number]>,)
