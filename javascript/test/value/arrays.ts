...
export const UNDEFINED_NULL = [undefined, null,     ] as const
export const _00 =            [0,         0,        ] as const
export const _01 =            [0,         1,        ] as const
export const _11 =            [1,         1,        ] as const
export const _22 =            [2,         2,        ] as const
export const _33 =            [3,         3,        ] as const
...
export const A_NULL_C_UNDEFINED =           ['a',       null,      'c',       undefined,     ] as const
export const A_UNDEFINED_C_NULL =           ['a',       undefined, 'c',       null,          ] as const
...
export const BBBB =           ['b',       'b',       'b',       'b',      ] as const
export const CCCC =           ['c',       'c',       'c',       'c',      ] as const
export const DCBA =           ['d',       'c',       'b',       'a',      ] as const
export const DDDD =           ['d',       'd',       'd',       'd',      ] as const
...
export const _0000 =          [0,         0,         0,         0,        ] as const
export const _0123 =          [0,         1,         2,         3,        ] as const
export const _1111 =          [1,         1,         1,         1,        ] as const
export const _2222 =          [2,         2,         2,         2,        ] as const
export const _3333 =          [3,         3,         3,         3,        ] as const
