    ...
    describe.each(everyInstances,)("%s", ({value: {instance, isMinimalist, type,},},) => {
        ...
        describe("filter", () => {
            ...
            describe("boolean callbacks", () => {
                ...
                test("1 field, (T) → true",           () => expect(new instance(A,)   .filter(callbackAsTrue1,).toArray(),).toStrictEqual(A,),)
                test("1 field, () → true",            () => expect(new instance(A,)   .filter(callbackAsTrue0,).toArray(),).toStrictEqual(A,),)
                test("1 field, (T, number) → false",  () => expect(new instance(A,)   .filter(callbackAsFalse2,),)         .toBeEmpty(),)
                test("1 field, (T) → false",          () => expect(new instance(A,)   .filter(callbackAsFalse1,),)         .toBeEmpty(),)
                test("1 field, () → false",           () => expect(new instance(A,)   .filter(callbackAsFalse0,),)         .toBeEmpty(),)
                test("2 fields, (T, number) → true",  () => expect(new instance(AB,)  .filter(callbackAsTrue2,).toArray(),).toStrictEqual(AB,),)
                test("2 fields, (T) → true",          () => expect(new instance(AB,)  .filter(callbackAsTrue1,).toArray(),).toStrictEqual(AB,),)
                test("2 fields, () → true",           () => expect(new instance(AB,)  .filter(callbackAsTrue0,).toArray(),).toStrictEqual(AB,),)
                test("2 fields, (T, number) → false", () => expect(new instance(AB,)  .filter(callbackAsFalse2,),)         .toBeEmpty(),)
                test("2 fields, (T) → false",         () => expect(new instance(AB,)  .filter(callbackAsFalse1,),)         .toBeEmpty(),)
                test("2 fields, () → false",          () => expect(new instance(AB,)  .filter(callbackAsFalse0,),)         .toBeEmpty(),)
                test("4 fields, (T, number) → true",  () => expect(new instance(ABCD,).filter(callbackAsTrue2,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields, (T) → true",          () => expect(new instance(ABCD,).filter(callbackAsTrue1,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields, () → true",           () => expect(new instance(ABCD,).filter(callbackAsTrue0,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields, (T, number) → false", () => expect(new instance(ABCD,).filter(callbackAsFalse2,),)         .toBeEmpty(),)
                test("4 fields, (T) → false",         () => expect(new instance(ABCD,).filter(callbackAsFalse1,),)         .toBeEmpty(),)
                test("4 fields, () → false",          () => expect(new instance(ABCD,).filter(callbackAsFalse0,),)         .toBeEmpty(),)
            },)
            describe("1 field", () => {
        ...
        describe("filterIndexed", () => {
            ...
            describe("boolean callbacks", () => {
                ...
                test("1 field: (number) → true",      () => expect(new instance(A,)   .filterIndexed(callbackAsTrue1,).toArray(),).toStrictEqual(A,),)
                test("1 field: () → true",            () => expect(new instance(A,)   .filterIndexed(callbackAsTrue0,).toArray(),).toStrictEqual(A,),)
                test("1 field: (number, T) → false",  () => expect(new instance(A,)   .filterIndexed(callbackAsFalse2,),)         .toBeEmpty(),)
                test("1 field: (number) → false",     () => expect(new instance(A,)   .filterIndexed(callbackAsFalse1,),)         .toBeEmpty(),)
                test("1 field: () → false",           () => expect(new instance(A,)   .filterIndexed(callbackAsFalse0,),)         .toBeEmpty(),)
                test("2 fields: (number, T) → true",  () => expect(new instance(AB,)  .filterIndexed(callbackAsTrue2,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: (number) → true",     () => expect(new instance(AB,)  .filterIndexed(callbackAsTrue1,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: () → true",           () => expect(new instance(AB,)  .filterIndexed(callbackAsTrue0,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: (number, T) → false", () => expect(new instance(AB,)  .filterIndexed(callbackAsFalse2,),)         .toBeEmpty(),)
                test("2 fields: (number) → false",    () => expect(new instance(AB,)  .filterIndexed(callbackAsFalse1,),)         .toBeEmpty(),)
                test("2 fields: () → false",          () => expect(new instance(AB,)  .filterIndexed(callbackAsFalse0,),)         .toBeEmpty(),)
                test("4 fields: (number, T) → true",  () => expect(new instance(ABCD,).filterIndexed(callbackAsTrue2,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: (number) → true",     () => expect(new instance(ABCD,).filterIndexed(callbackAsTrue1,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: () → true",           () => expect(new instance(ABCD,).filterIndexed(callbackAsTrue0,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: (number, T) → false", () => expect(new instance(ABCD,).filterIndexed(callbackAsFalse2,),)         .toBeEmpty(),)
                test("4 fields: (number) → false",    () => expect(new instance(ABCD,).filterIndexed(callbackAsFalse1,),)         .toBeEmpty(),)
                test("4 fields: () → false",          () => expect(new instance(ABCD,).filterIndexed(callbackAsFalse0,),)         .toBeEmpty(),)
            },)
            describe("1 field", () => {
        ...
        describe("filterNot", () => {
            ...
            describe("boolean callbacks", () => {
                ...
                test("1 field: (T) → true",           () => expect(new instance(A,)   .filterNot(callbackAsTrue1,),)           .toBeEmpty(),)
                test("1 field: () → true",            () => expect(new instance(A,)   .filterNot(callbackAsTrue0,),)           .toBeEmpty(),)
                test("1 field: (T, number) → false",  () => expect(new instance(A,)   .filterNot(callbackAsFalse2,).toArray(),).toStrictEqual(A,),)
                test("1 field: (T) → false",          () => expect(new instance(A,)   .filterNot(callbackAsFalse1,).toArray(),).toStrictEqual(A,),)
                test("1 field: () → false",           () => expect(new instance(A,)   .filterNot(callbackAsFalse0,).toArray(),).toStrictEqual(A,),)
                test("2 fields: (T, number) → true",  () => expect(new instance(AB,)  .filterNot(callbackAsTrue2,),)           .toBeEmpty(),)
                test("2 fields: (T) → true",          () => expect(new instance(AB,)  .filterNot(callbackAsTrue1,),)           .toBeEmpty(),)
                test("2 fields: () → true",           () => expect(new instance(AB,)  .filterNot(callbackAsTrue0,),)           .toBeEmpty(),)
                test("2 fields: (T, number) → false", () => expect(new instance(AB,)  .filterNot(callbackAsFalse2,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: (T) → false",         () => expect(new instance(AB,)  .filterNot(callbackAsFalse1,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: () → false",          () => expect(new instance(AB,)  .filterNot(callbackAsFalse0,).toArray(),).toStrictEqual(AB,),)
                test("4 fields: (T, number) → true",  () => expect(new instance(ABCD,).filterNot(callbackAsTrue2,),)           .toBeEmpty(),)
                test("4 fields: (T) → true",          () => expect(new instance(ABCD,).filterNot(callbackAsTrue1,),)           .toBeEmpty(),)
                test("4 fields: () → true",           () => expect(new instance(ABCD,).filterNot(callbackAsTrue0,),)           .toBeEmpty(),)
                test("4 fields: (T, number) → false", () => expect(new instance(ABCD,).filterNot(callbackAsFalse2,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: (T) → false",         () => expect(new instance(ABCD,).filterNot(callbackAsFalse1,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: () → false",          () => expect(new instance(ABCD,).filterNot(callbackAsFalse0,).toArray(),).toStrictEqual(ABCD,),)
            },)
            describe("1 field", () => {
        ...
        describe("filterNotIndexed", () => {
            ...
            describe("boolean callbacks", () => {
                ...
                test("1 field: (number) → true",      () => expect(new instance(A,)   .filterNotIndexed(callbackAsTrue1,),)           .toBeEmpty(),)
                test("1 field: () → true",            () => expect(new instance(A,)   .filterNotIndexed(callbackAsTrue0,),)           .toBeEmpty(),)
                test("1 field: (number, T) → false",  () => expect(new instance(A,)   .filterNotIndexed(callbackAsFalse2,).toArray(),).toStrictEqual(A,),)
                test("1 field: (number) → false",     () => expect(new instance(A,)   .filterNotIndexed(callbackAsFalse1,).toArray(),).toStrictEqual(A,),)
                test("1 field: () → false",           () => expect(new instance(A,)   .filterNotIndexed(callbackAsFalse0,).toArray(),).toStrictEqual(A,),)
                test("2 fields: (number, T) → true",  () => expect(new instance(AB,)  .filterNotIndexed(callbackAsTrue2,),)           .toBeEmpty(),)
                test("2 fields: (number) → true",     () => expect(new instance(AB,)  .filterNotIndexed(callbackAsTrue1,),)           .toBeEmpty(),)
                test("2 fields: () → true",           () => expect(new instance(AB,)  .filterNotIndexed(callbackAsTrue0,),)           .toBeEmpty(),)
                test("2 fields: (number, T) → false", () => expect(new instance(AB,)  .filterNotIndexed(callbackAsFalse2,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: (number) → false",    () => expect(new instance(AB,)  .filterNotIndexed(callbackAsFalse1,).toArray(),).toStrictEqual(AB,),)
                test("2 fields: () → false",          () => expect(new instance(AB,)  .filterNotIndexed(callbackAsFalse0,).toArray(),).toStrictEqual(AB,),)
                test("4 fields: (number, T) → true",  () => expect(new instance(ABCD,).filterNotIndexed(callbackAsTrue2,),)           .toBeEmpty(),)
                test("4 fields: (number) → true",     () => expect(new instance(ABCD,).filterNotIndexed(callbackAsTrue1,),)           .toBeEmpty(),)
                test("4 fields: () → true",           () => expect(new instance(ABCD,).filterNotIndexed(callbackAsTrue0,),)           .toBeEmpty(),)
                test("4 fields: (number, T) → false", () => expect(new instance(ABCD,).filterNotIndexed(callbackAsFalse2,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: (number) → false",    () => expect(new instance(ABCD,).filterNotIndexed(callbackAsFalse1,).toArray(),).toStrictEqual(ABCD,),)
                test("4 fields: () → false",          () => expect(new instance(ABCD,).filterNotIndexed(callbackAsFalse0,).toArray(),).toStrictEqual(ABCD,),)
            },)
            describe("1 field", () => {
        ...
        describe("filterNotNull", () => {
            ...
            test("2 fields (non-null)",            () => expect(new instance(AB,)                .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("2 fields (null at start)",       () => expect(new instance(NULL_A,)            .filterNotNull().toArray(),).toStrictEqual(A,),)
            test("2 fields (null at end)",         () => expect(new instance(A_NULL,)            .filterNotNull().toArray(),).toStrictEqual(A,),)
            test("2 fields (undefined at start)",  () => expect(new instance(UNDEFINED_A,)       .filterNotNull().toArray(),).toStrictEqual(A,),)
            test("2 fields (undefined at end)",    () => expect(new instance(A_UNDEFINED,)       .filterNotNull().toArray(),).toStrictEqual(A,),)
            test("2 fields (null + undefined)",    () => expect(new instance(NULL_UNDEFINED,)    .filterNotNull(),)          .toBeEmpty(),)
            test("4 fields (non-null)",            () => expect(new instance(ABCD,)              .filterNotNull().toArray(),).toStrictEqual(ABCD,),)
            test("3 fields (null at start)",       () => expect(new instance(NULL_AB,)           .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("3 fields (null at center)",      () => expect(new instance(A_NULL_B,)          .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("3 fields (null at end)",         () => expect(new instance(AB_NULL,)           .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("3 fields (undefined at start)",  () => expect(new instance(UNDEFINED_AB,)      .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("3 fields (undefined at center)", () => expect(new instance(A_UNDEFINED_B,)     .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("3 fields (undefined at end)",    () => expect(new instance(AB_UNDEFINED,)      .filterNotNull().toArray(),).toStrictEqual(AB,),)
            test("4 fields (null + undefined)",    () => expect(new instance(A_NULL_UNDEFINED_B,).filterNotNull().toArray(),).toStrictEqual(AB,),)
