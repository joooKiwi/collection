...
describe("CollectionHolderTest (has)", () => {
    ...
    describe.each(everyInstances,)("%s", ({value: {instance, isMinimalist, isLazy,},},) => {
        describe("get() being called", () => {
            ...
            describe("hasOne", () => {
                ...
                describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                    test("0 fields (empty)",     () => expect(new instance(EMPTY,).execute(it =>         it.hasOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("0 fields (non-empty)", () => expect(new instance<string>(EMPTY,).execute(it => it.hasOne(new iterable(AB,),),).amountOfCall,).toBe(0,),)
                    test("1 field (empty)",      () => expect(new instance(A,).execute(it =>             it.hasOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("1 field (non-empty)",  () => expect(new instance<string>(A,).execute(it =>     it.hasOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                    test("2 fields (empty)",     () => expect(new instance(AB,).execute(it =>            it.hasOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("2 fields (non-empty)", () => expect(new instance(AB,).execute(it =>            it.hasOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                    test("4 fields (empty)",     () => expect(new instance(ABCD,).execute(it =>          it.hasOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("4 fields (non-empty)", () => expect(new instance(ABCD,).execute(it =>          it.hasOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                },)
            },)
            describe("hasNotOne", () => {
                describe.each(NULL_UNDEFINED,)("%s", nullValue => {
                ...
                describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                    test("0 fields (empty)",     () => expect(new instance(EMPTY,).execute(it =>         it.hasNotOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("0 fields (non-empty)", () => expect(new instance<string>(EMPTY,).execute(it => it.hasNotOne(new iterable(AB,),),).amountOfCall,).toBe(0,),)
                    test("1 field (empty)",      () => expect(new instance(A,).execute(it =>             it.hasNotOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("1 field (non-empty)",  () => expect(new instance<string>(A,).execute(it =>     it.hasNotOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                    test("2 fields (empty)",     () => expect(new instance(AB,).execute(it =>            it.hasNotOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("2 fields (non-empty)", () => expect(new instance(AB,).execute(it =>            it.hasNotOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                    test("4 fields (empty)",     () => expect(new instance(ABCD,).execute(it =>          it.hasNotOne(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("4 fields (non-empty)", () => expect(new instance(ABCD,).execute(it =>          it.hasNotOne(new iterable(AB,),),).amountOfCall,).toBe(1,),)
                },)
            },)
            ...
            describe("hasAll", () => {
                ...
                describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                    test("0 fields (empty)",     () => expect(new instance(EMPTY,).execute(it =>         it.hasAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("0 fields (non-empty)", () => expect(new instance<string>(EMPTY,).execute(it => it.hasAll(new iterable(AB,),),).amountOfCall,).toBe(0,),)
                    test("1 field (empty)",      () => expect(new instance(A,).execute(it =>             it.hasAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("1 field (non-empty)",  () => expect(new instance<string>(A,).execute(it =>     it.hasAll(new iterable(AB,),),).amountOfCall,).toBe(2,),)
                    test("2 fields (empty)",     () => expect(new instance(AB,).execute(it =>            it.hasAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("2 fields (non-empty)", () => expect(new instance(AB,).execute(it =>            it.hasAll(new iterable(AB,),),).amountOfCall,).toBe(3,),)
                    test("4 fields (empty)",     () => expect(new instance(ABCD,).execute(it =>          it.hasAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("4 fields (non-empty)", () => expect(new instance(ABCD,).execute(it =>          it.hasAll(new iterable(AB,),),).amountOfCall,).toBe(3,),)
                },)
            },)
            describe("hasNotAll", () => {
                describe.each(NULL_UNDEFINED,)("%s", nullValue => {
                ...
                describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                    test("1 field (empty)",      () => expect(new instance(EMPTY,).execute(it =>         it.hasNotAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("1 field (non-empty)",  () => expect(new instance<string>(EMPTY,).execute(it => it.hasNotAll(new iterable(AB,),),).amountOfCall,).toBe(0,),)
                    test("1 field (empty)",      () => expect(new instance(A,).execute(it =>             it.hasNotAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("1 field (non-empty)",  () => expect(new instance<string>(A,).execute(it =>     it.hasNotAll(new iterable(AB,),),).amountOfCall,).toBe(2,),)
                    test("2 fields (empty)",     () => expect(new instance(AB,).execute(it =>            it.hasNotAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("2 fields (non-empty)", () => expect(new instance(AB,).execute(it =>            it.hasNotAll(new iterable(AB,),),).amountOfCall,).toBe(3,),)
                    test("4 fields (empty)",     () => expect(new instance(ABCD,).execute(it =>          it.hasNotAll(new iterable(EMPTY,),),).amountOfCall,).toBe(0,),)
                    test("4 fields (non-empty)", () => expect(new instance(ABCD,).execute(it =>          it.hasNotAll(new iterable(AB,),),).amountOfCall,).toBe(3,),)
                },)
            },)
        ...
        describe("hasOne", () => {
            ...
            describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                test("empty (none)",      () => expect(new instance(EMPTY,)        .hasOne(new iterable(EMPTY,),),).toBeFalse(),)
                test("empty (a)",         () => expect(new instance<string>(EMPTY,).hasOne(new iterable(A,),),).toBeFalse(),)
                test("empty (ab)",        () => expect(new instance<string>(EMPTY,).hasOne(new iterable(AB,),),).toBeFalse(),)
                test("empty (abcd)",      () => expect(new instance<string>(EMPTY,).hasOne(new iterable(ABCD,),),).toBeFalse(),)
                test("1 field (none)",    () => expect(new instance(A,)            .hasOne(new iterable(EMPTY,),),).toBeTrue(),)
                test("1 field (a)",       () => expect(new instance(A,)            .hasOne(new iterable(A,),),).toBeTrue(),)
                test("1 field (e)",       () => expect(new instance<string>(A,)    .hasOne(new iterable(E,),),).toBeFalse(),)
                test("1 field (ab)",      () => expect(new instance<string>(A,)    .hasOne(new iterable(AB,),),).toBeTrue(),)
                test("1 field (ef)",      () => expect(new instance<string>(A,)    .hasOne(new iterable(EF,),),).toBeFalse(),)
                test("1 field (abcd)",    () => expect(new instance<string>(A,)    .hasOne(new iterable(ABCD,),),).toBeTrue(),)
                test("1 field (efgh)",    () => expect(new instance<string>(A,)    .hasOne(new iterable(EFGH,),),).toBeFalse(),)
                test("2 fields (none)",   () => expect(new instance(AB,)           .hasOne(new iterable(EMPTY,),),).toBeTrue(),)
                test("2 fields (a)",      () => expect(new instance(AB,)           .hasOne(new iterable(A,),),).toBeTrue(),)
                test("2 fields (b)",      () => expect(new instance(AB,)           .hasOne(new iterable(B,),),).toBeTrue(),)
                test("2 fields (e)",      () => expect(new instance<string>(AB,)   .hasOne(new iterable(E,),),).toBeFalse(),)
                test("2 fields (ab)",     () => expect(new instance(AB,)           .hasOne(new iterable(AB,),),).toBeTrue(),)
                test("2 fields (ef)",     () => expect(new instance<string>(AB,)   .hasOne(new iterable(EF,),),).toBeFalse(),)
                test("2 fields (abcd)",   () => expect(new instance<string>(AB,)   .hasOne(new iterable(ABCD,),),).toBeTrue(),)
                test("2 fields (efgh)",   () => expect(new instance<string>(AB,)   .hasOne(new iterable(EFGH,),),).toBeFalse(),)
                test("4 fields (none)",   () => expect(new instance(ABCD,)         .hasOne(new iterable(EMPTY,),),).toBeTrue(),)
                test("4 fields (a)",      () => expect(new instance(ABCD,)         .hasOne(new iterable(A,),),).toBeTrue(),)
                test("4 fields (b)",      () => expect(new instance(ABCD,)         .hasOne(new iterable(B,),),).toBeTrue(),)
                test("4 fields (c)",      () => expect(new instance(ABCD,)         .hasOne(new iterable(C,),),).toBeTrue(),)
                test("4 fields (d)",      () => expect(new instance(ABCD,)         .hasOne(new iterable(D,),),).toBeTrue(),)
                test("4 fields (e)",      () => expect(new instance<string>(ABCD,) .hasOne(new iterable(E,),),).toBeFalse(),)
                test("4 fields (ab)",     () => expect(new instance(ABCD,)         .hasOne(new iterable(AB,),),).toBeTrue(),)
                test("4 fields (ef)",     () => expect(new instance<string>(ABCD,) .hasOne(new iterable(EF,),),).toBeFalse(),)
                test("4 fields (abcd)",   () => expect(new instance(ABCD,)         .hasOne(new iterable(ABCD,),),).toBeTrue(),)
                test("4 fields (efgh)",   () => expect(new instance<string>(ABCD,) .hasOne(new iterable(EFGH,),),).toBeFalse(),)
            },)
        },)
        describe("hasNotOne", () => {
            describe("null|undefined", () => {
            ...
            describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                test("empty (none)",     () => expect(new instance(EMPTY,)        .hasNotOne(new iterable(EMPTY,),),).toBeTrue(),)
                test("empty (a)",        () => expect(new instance<string>(EMPTY,).hasNotOne(new iterable(A,),),).toBeTrue(),)
                test("empty (ab)",       () => expect(new instance<string>(EMPTY,).hasNotOne(new iterable(AB,),),).toBeTrue(),)
                test("empty (abcd)",     () => expect(new instance<string>(EMPTY,).hasNotOne(new iterable(ABCD,),),).toBeTrue(),)
                test("1 field (none)",   () => expect(new instance(A,)            .hasNotOne(new iterable(EMPTY,),),).toBeFalse(),)
                test("1 field (a)",      () => expect(new instance(A,)            .hasNotOne(new iterable(A,),),).toBeFalse(),)
                test("1 field (e)",      () => expect(new instance<string>(A,)    .hasNotOne(new iterable(E,),),).toBeTrue(),)
                test("1 field (ab)",     () => expect(new instance<string>(A,)    .hasNotOne(new iterable(AB,),),).toBeFalse(),)
                test("1 field (ef)",     () => expect(new instance<string>(A,)    .hasNotOne(new iterable(EF,),),).toBeTrue(),)
                test("1 field (abcd)",   () => expect(new instance<string>(A,)    .hasNotOne(new iterable(ABCD,),),).toBeFalse(),)
                test("1 field (efgh)",   () => expect(new instance<string>(A,)    .hasNotOne(new iterable(EFGH,),),).toBeTrue(),)
                test("2 fields (none)",  () => expect(new instance(AB,)           .hasNotOne(new iterable(EMPTY,),),).toBeFalse(),)
                test("2 fields (a)",     () => expect(new instance(AB,)           .hasNotOne(new iterable(A,),),).toBeFalse(),)
                test("2 fields (b)",     () => expect(new instance(AB,)           .hasNotOne(new iterable(B,),),).toBeFalse(),)
                test("2 fields (e)",     () => expect(new instance<string>(AB,)   .hasNotOne(new iterable(E,),),).toBeTrue(),)
                test("2 fields (ab)",    () => expect(new instance(AB,)           .hasNotOne(new iterable(AB,),),).toBeFalse(),)
                test("2 fields (ef)",    () => expect(new instance<string>(AB,)   .hasNotOne(new iterable(EF,),),).toBeTrue(),)
                test("2 fields (abcd)",  () => expect(new instance<string>(AB,)   .hasNotOne(new iterable(ABCD,),),).toBeFalse(),)
                test("2 fields (efgh)",  () => expect(new instance<string>(AB,)   .hasNotOne(new iterable(EFGH,),),).toBeTrue(),)
                test("4 fields (none)",  () => expect(new instance(ABCD,)         .hasNotOne(new iterable(EMPTY,),),).toBeFalse(),)
                test("4 fields (a)",     () => expect(new instance(ABCD,)         .hasNotOne(new iterable(A,),),).toBeFalse(),)
                test("4 fields (b)",     () => expect(new instance(ABCD,)         .hasNotOne(new iterable(B,),),).toBeFalse(),)
                test("4 fields (c)",     () => expect(new instance(ABCD,)         .hasNotOne(new iterable(C,),),).toBeFalse(),)
                test("4 fields (d)",     () => expect(new instance(ABCD,)         .hasNotOne(new iterable(D,),),).toBeFalse(),)
                test("4 fields (e)",     () => expect(new instance<string>(ABCD,) .hasNotOne(new iterable(E,),),).toBeTrue(),)
                test("4 fields (ab)",    () => expect(new instance(ABCD,)         .hasNotOne(new iterable(AB,),),).toBeFalse(),)
                test("4 fields (ef)",    () => expect(new instance<string>(ABCD,) .hasNotOne(new iterable(EF,),),).toBeTrue(),)
                test("4 fields (abcd)",  () => expect(new instance(ABCD,)         .hasNotOne(new iterable(ABCD,),),).toBeFalse(),)
                test("4 fields (efgh)",  () => expect(new instance<string>(ABCD,) .hasNotOne(new iterable(EFGH,),),).toBeTrue(),)
            },)
        },)
        ...
        describe("hasAll", () => {
            ...
            describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                test("empty (none)",    () => expect(new instance(EMPTY,)        .hasAll(new iterable(EMPTY,),),).toBeTrue(),)
                test("empty (a)",       () => expect(new instance<string>(EMPTY,).hasAll(new iterable(A,),),).toBeFalse(),)
                test("empty (ab)",      () => expect(new instance<string>(EMPTY,).hasAll(new iterable(AB,),),).toBeFalse(),)
                test("empty (abcd)",    () => expect(new instance<string>(EMPTY,).hasAll(new iterable(ABCD,),),).toBeFalse(),)
                test("1 field (none)",  () => expect(new instance(A,)            .hasAll(new iterable(EMPTY,),),).toBeTrue(),)
                test("1 field (a)",     () => expect(new instance(A,)            .hasAll(new iterable(A,),),).toBeTrue(),)
                test("1 field (e)",     () => expect(new instance<string>(A,)    .hasAll(new iterable(E,),),).toBeFalse(),)
                test("1 field (ab)",    () => expect(new instance<string>(A,)    .hasAll(new iterable(AB,),),).toBeFalse(),)
                test("1 field (ef)",    () => expect(new instance<string>(A,)    .hasAll(new iterable(EF,),),).toBeFalse(),)
                test("1 field (abcd)",  () => expect(new instance<string>(A,)    .hasAll(new iterable(ABCD,),),).toBeFalse(),)
                test("1 field (efgh)",  () => expect(new instance<string>(A,)    .hasAll(new iterable(EFGH,),),).toBeFalse(),)
                test("2 fields (none)", () => expect(new instance(AB,)           .hasAll(new iterable(EMPTY,),),).toBeTrue(),)
                test("2 fields (a)",    () => expect(new instance(AB,)           .hasAll(new iterable(A,),),).toBeTrue(),)
                test("2 fields (b)",    () => expect(new instance(AB,)           .hasAll(new iterable(B,),),).toBeTrue(),)
                test("2 fields (e)",    () => expect(new instance<string>(AB,)   .hasAll(new iterable(E,),),).toBeFalse(),)
                test("2 fields (ab)",   () => expect(new instance(AB,)           .hasAll(new iterable(AB,),),).toBeTrue(),)
                test("2 fields (ef)",   () => expect(new instance<string>(AB,)   .hasAll(new iterable(EF,),),).toBeFalse(),)
                test("2 fields (abcd)", () => expect(new instance<string>(AB,)   .hasAll(new iterable(ABCD,),),).toBeFalse(),)
                test("2 fields (efgh)", () => expect(new instance<string>(AB,)   .hasAll(new iterable(EFGH,),),).toBeFalse(),)
                test("4 fields (none)", () => expect(new instance(ABCD,)         .hasAll(new iterable(EMPTY,),),).toBeTrue(),)
                test("4 fields (a)",    () => expect(new instance(ABCD,)         .hasAll(new iterable(A,),),).toBeTrue(),)
                test("4 fields (b)",    () => expect(new instance(ABCD,)         .hasAll(new iterable(B,),),).toBeTrue(),)
                test("4 fields (c)",    () => expect(new instance(ABCD,)         .hasAll(new iterable(C,),),).toBeTrue(),)
                test("4 fields (d)",    () => expect(new instance(ABCD,)         .hasAll(new iterable(D,),),).toBeTrue(),)
                test("4 fields (e)",    () => expect(new instance<string>(ABCD,) .hasAll(new iterable(E,),),).toBeFalse(),)
                test("4 fields (ab)",   () => expect(new instance(ABCD,)         .hasAll(new iterable(AB,),),).toBeTrue(),)
                test("4 fields (ef)",   () => expect(new instance<string>(ABCD,) .hasAll(new iterable(EF,),),).toBeFalse(),)
                test("4 fields (abcd)", () => expect(new instance(ABCD,)         .hasAll(new iterable(ABCD,),),).toBeTrue(),)
                test("4 fields (efgh)", () => expect(new instance<string>(ABCD,) .hasAll(new iterable(EFGH,),),).toBeFalse(),)
            },)
        },)
        describe("hasNotAll", () => {
            describe("null|undefined", () => {
            ...
            describe.each(everyIterableInstances,)("%s", ({value: iterable,},) => {
                test("empty (none)",    () => expect(new instance(EMPTY,)        .hasNotAll(new iterable(EMPTY,),),).toBeFalse(),)
                test("empty (a)",       () => expect(new instance<string>(EMPTY,).hasNotAll(new iterable(A,),),).toBeTrue(),)
                test("empty (ab)",      () => expect(new instance<string>(EMPTY,).hasNotAll(new iterable(AB,),),).toBeTrue(),)
                test("empty (abcd)",    () => expect(new instance<string>(EMPTY,).hasNotAll(new iterable(ABCD,),),).toBeTrue(),)
                test("1 field (none)",  () => expect(new instance(A,)            .hasNotAll(new iterable(EMPTY,),),).toBeFalse(),)
                test("1 field (a)",     () => expect(new instance(A,)            .hasNotAll(new iterable(A,),),).toBeFalse(),)
                test("1 field (e)",     () => expect(new instance<string>(A,)    .hasNotAll(new iterable(E,),),).toBeTrue(),)
                test("1 field (ab)",    () => expect(new instance<string>(A,)    .hasNotAll(new iterable(AB,),),).toBeTrue(),)
                test("1 field (ef)",    () => expect(new instance<string>(A,)    .hasNotAll(new iterable(EF,),),).toBeTrue(),)
                test("1 field (abcd)",  () => expect(new instance<string>(A,)    .hasNotAll(new iterable(ABCD,),),).toBeTrue(),)
                test("1 field (efgh)",  () => expect(new instance<string>(A,)    .hasNotAll(new iterable(EFGH,),),).toBeTrue(),)
                test("2 fields (none)", () => expect(new instance(AB,)           .hasNotAll(new iterable(EMPTY,),),).toBeFalse(),)
                test("2 fields (a)",    () => expect(new instance(AB,)           .hasNotAll(new iterable(A,),),).toBeFalse(),)
                test("2 fields (b)",    () => expect(new instance(AB,)           .hasNotAll(new iterable(B,),),).toBeFalse(),)
                test("2 fields (e)",    () => expect(new instance<string>(AB,)   .hasNotAll(new iterable(E,),),).toBeTrue(),)
                test("2 fields (ab)",   () => expect(new instance(AB,)           .hasNotAll(new iterable(AB,),),).toBeFalse(),)
                test("2 fields (ef)",   () => expect(new instance<string>(AB,)   .hasNotAll(new iterable(EF,),),).toBeTrue(),)
                test("2 fields (abcd)", () => expect(new instance<string>(AB,)   .hasNotAll(new iterable(ABCD,),),).toBeTrue(),)
                test("2 fields (efgh)", () => expect(new instance<string>(AB,)   .hasNotAll(new iterable(EFGH,),),).toBeTrue(),)
                test("4 fields (none)", () => expect(new instance(ABCD,)         .hasNotAll(new iterable(EMPTY,),),).toBeFalse(),)
                test("4 fields (a)",    () => expect(new instance(ABCD,)         .hasNotAll(new iterable(A,),),).toBeFalse(),)
                test("4 fields (b)",    () => expect(new instance(ABCD,)         .hasNotAll(new iterable(B,),),).toBeFalse(),)
                test("4 fields (c)",    () => expect(new instance(ABCD,)         .hasNotAll(new iterable(C,),),).toBeFalse(),)
                test("4 fields (d)",    () => expect(new instance(ABCD,)         .hasNotAll(new iterable(D,),),).toBeFalse(),)
                test("4 fields (e)",    () => expect(new instance<string>(ABCD,) .hasNotAll(new iterable(E,),),).toBeTrue(),)
                test("4 fields (ab)",   () => expect(new instance(ABCD,)         .hasNotAll(new iterable(AB,),),).toBeFalse(),)
                test("4 fields (ef)",   () => expect(new instance<string>(ABCD,) .hasNotAll(new iterable(EF,),),).toBeTrue(),)
                test("4 fields (abcd)", () => expect(new instance(ABCD,)         .hasNotAll(new iterable(ABCD,),),).toBeFalse(),)
                test("4 fields (efgh)", () => expect(new instance<string>(ABCD,) .hasNotAll(new iterable(EFGH,),),).toBeTrue(),)
            },)
        },)
