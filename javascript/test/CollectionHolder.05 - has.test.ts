...
import {LazyCollectionHolder_HasAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 from "./instance/LazyCollectionHolder_HasAlias"
import {LazyCollectionHolder_HasAllAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              from "./instance/LazyCollectionHolder_HasAllAlias"
import {LazyCollectionHolder_HasDuplicateAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        from "./instance/LazyCollectionHolder_HasDuplicateAlias"
import {LazyCollectionHolder_HasNoDuplicatesAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     from "./instance/LazyCollectionHolder_HasNoDuplicatesAlias"
import {LazyCollectionHolder_HasNoNullsAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          from "./instance/LazyCollectionHolder_HasNoNullsAlias"
import {LazyCollectionHolder_HasNotAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              from "./instance/LazyCollectionHolder_HasNotAlias"
import {LazyCollectionHolder_HasNotAllAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           from "./instance/LazyCollectionHolder_HasNotAllAlias"
import {LazyCollectionHolder_HasNotOneAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           from "./instance/LazyCollectionHolder_HasNotOneAlias"
import {LazyCollectionHolder_HasNullAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             from "./instance/LazyCollectionHolder_HasNullAlias"
import {LazyCollectionHolder_HasOneAlias}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              from "./instance/LazyCollectionHolder_HasOneAlias"
...
describe("CollectionHolderTest (has)", () => {
    ...
    describe("aliases", () => {
        ...
        describe("LazyCollectionHolder", () => {
            test("includes",             () => expect(new LazyCollectionHolder_HasAlias()            .execute(it => it.includes(singleValue,),)             .amountOfCall,).toBe(1,),)
            test("includesNot",          () => expect(new LazyCollectionHolder_HasNotAlias()         .execute(it => it.includesNot(singleValue,),)          .amountOfCall,).toBe(1,),)
            test("includesOne",          () => expect(new LazyCollectionHolder_HasOneAlias()         .execute(it => it.includesOne(singleValueInArray,),)   .amountOfCall,).toBe(1,),)
            test("includesNotOne",       () => expect(new LazyCollectionHolder_HasNotOneAlias()      .execute(it => it.includesNotOne(singleValueInArray,),).amountOfCall,).toBe(1,),)
            test("includesAll",          () => expect(new LazyCollectionHolder_HasAllAlias()         .execute(it => it.includesAll(singleValueInArray,),)   .amountOfCall,).toBe(1,),)
            test("includesNotAll",       () => expect(new LazyCollectionHolder_HasNotAllAlias()      .execute(it => it.includesNotAll(singleValueInArray,),).amountOfCall,).toBe(1,),)
            test("includesNull",         () => expect(new LazyCollectionHolder_HasNullAlias()        .execute(it => it.includesNull,)                       .amountOfCall,).toBe(1,),)
            test("includesNoNulls",      () => expect(new LazyCollectionHolder_HasNoNullsAlias()     .execute(it => it.includesNoNulls,)                    .amountOfCall,).toBe(1,),)
            test("includesDuplicate",    () => expect(new LazyCollectionHolder_HasDuplicateAlias()   .execute(it => it.includesDuplicate,)                  .amountOfCall,).toBe(1,),)
            test("includesNoDuplicates", () => expect(new LazyCollectionHolder_HasNoDuplicatesAlias().execute(it => it.includesNoDuplicates,)               .amountOfCall,).toBe(1,),)
            test("contains",             () => expect(new LazyCollectionHolder_HasAlias()            .execute(it => it.contains(singleValue,),)             .amountOfCall,).toBe(1,),)
            test("containsNot",          () => expect(new LazyCollectionHolder_HasNotAlias()         .execute(it => it.containsNot(singleValue,),)          .amountOfCall,).toBe(1,),)
            test("containsOne",          () => expect(new LazyCollectionHolder_HasOneAlias()         .execute(it => it.containsOne(singleValueInArray,),)   .amountOfCall,).toBe(1,),)
            test("containsNotOne",       () => expect(new LazyCollectionHolder_HasNotOneAlias()      .execute(it => it.containsNotOne(singleValueInArray,),).amountOfCall,).toBe(1,),)
            test("containsAll",          () => expect(new LazyCollectionHolder_HasAllAlias()         .execute(it => it.containsAll(singleValueInArray,),)   .amountOfCall,).toBe(1,),)
            test("containsNotAll",       () => expect(new LazyCollectionHolder_HasNotAllAlias()      .execute(it => it.containsNotAll(singleValueInArray,),).amountOfCall,).toBe(1,),)
            test("containsNull",         () => expect(new LazyCollectionHolder_HasNullAlias()        .execute(it => it.containsNull,)                       .amountOfCall,).toBe(1,),)
            test("containsNoNulls",      () => expect(new LazyCollectionHolder_HasNoNullsAlias()     .execute(it => it.containsNoNulls,)                    .amountOfCall,).toBe(1,),)
            test("containsDuplicate",    () => expect(new LazyCollectionHolder_HasDuplicateAlias()   .execute(it => it.containsDuplicate,)                  .amountOfCall,).toBe(1,),)
            test("containsNoDuplicates", () => expect(new LazyCollectionHolder_HasNoDuplicatesAlias().execute(it => it.containsNoDuplicates,)               .amountOfCall,).toBe(1,),)
        },)
