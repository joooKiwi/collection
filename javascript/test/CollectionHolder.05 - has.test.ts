...
import {A, A_NULL_B_UNDEFINED, A_NULL_B_UNDEFINED_UNDEFINED, A_NULL_NULL_B_UNDEFINED, AAB, AB, AB12, ABB, ABCD_NULL, ABCD_UNDEFINED, NULL_ABCD, NULL_NULL_B_UNDEFINED, UNDEFINED_ABCD} from "./constantCollections"
...
describe("CollectionHolderTest (has)", () => {
    ...
    describe.each(everyInstance,)("%s", ({value: {newInstance,},},) => {
        ...
        describe("duplicate", () => {
            test("[] == false",                            () => expect(newInstance([],).hasDuplicate,).toBeFalse(),)
