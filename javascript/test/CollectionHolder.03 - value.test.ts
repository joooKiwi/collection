...
describe("CollectionHolderTest (value)", () => {
    ...
    describe("aliases", () => {
        ...
        describe("ArrayOf1AsCollectionHolder", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLast",            () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.getLast(),)                                      .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.getLastOrNull(),)                                .getFirst_amountOfCall,) .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.last(),)                                         .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.lastOrNull(),)                                   .getFirst_amountOfCall,) .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.lastIndexed(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.lastIndexedOrNull(),)                            .getFirst_amountOfCall,) .toBe(1,),)
        ...
        describe("ArrayOf2AsCollectionHolder", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.getLastOrNull(),)                                .getLast_amountOfCall,)  .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.last(),)                                         .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.lastOrNull(),)                                   .getLast_amountOfCall,)  .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.lastIndexed(),)                                  .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_ArrayOf2Follower().execute(it => it.lastIndexedOrNull(),)                            .getLast_amountOfCall,)  .toBe(1,),)
        ...
        describe("CollectionHolderOf1", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_1Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLast",            () => expect(new CollectionHolder_1Follower().execute(it => it.getLast(),)                                      .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_1Follower().execute(it => it.getLastOrNull(),)                                .getFirst_amountOfCall,) .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_1Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_1Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_1Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_1Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_1Follower().execute(it => it.last(),)                                         .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_1Follower().execute(it => it.lastOrNull(),)                                   .getFirst_amountOfCall,) .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_1Follower().execute(it => it.lastIndexed(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_1Follower().execute(it => it.lastIndexedOrNull(),)                            .getFirst_amountOfCall,) .toBe(1,),)
        ...
        describe("CollectionHolderOf2", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_2Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_2Follower().execute(it => it.getLastOrNull(),)                                .getLast_amountOfCall,)  .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_2Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_2Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_2Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_2Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_2Follower().execute(it => it.last(),)                                         .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_2Follower().execute(it => it.lastOrNull(),)                                   .getLast_amountOfCall,)  .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_2Follower().execute(it => it.lastIndexed(),)                                  .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_2Follower().execute(it => it.lastIndexedOrNull(),)                            .getLast_amountOfCall,)  .toBe(1,),)
        ...
        describe("LazyCollectionHolderOf1", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLast",            () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.getLast(),)                                      .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.getLastOrNull(),)                                .getFirst_amountOfCall,) .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.last(),)                                         .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.lastOrNull(),)                                   .getFirst_amountOfCall,) .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.lastIndexed(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.lastIndexedOrNull(),)                            .getFirst_amountOfCall,) .toBe(1,),)
        ...
        describe("LazyCollectionHolderOf2", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.getLastOrNull(),)                                .getLast_amountOfCall,)  .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.last(),)                                         .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.lastOrNull(),)                                   .getLast_amountOfCall,)  .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.lastIndexed(),)                                  .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_LazyOf2Follower().execute(it => it.lastIndexedOrNull(),)                            .getLast_amountOfCall,)  .toBe(1,),)
        ...
        describe("SetOf1AsCollectionHolder", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLast",            () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.getLast(),)                                      .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.getLastOrNull(),)                                .getFirst_amountOfCall,) .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.last(),)                                         .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.lastOrNull(),)                                   .getFirst_amountOfCall,) .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.lastIndexed(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.lastIndexedOrNull(),)                            .getFirst_amountOfCall,) .toBe(1,),)
        ...
        describe("SetOf2AsCollectionHolder", () => {
            test("getFirstOrNull",     () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.getFirstOrNull(),)                               .getFirst_amountOfCall,) .toBe(1,),)
            test("getLastOrNull",      () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.getLastOrNull(),)                                .getLast_amountOfCall,)  .toBe(1,),)
            test("first",              () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.first(),)                                        .getFirst_amountOfCall,) .toBe(1,),)
            test("firstOrNull",        () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.firstOrNull(),)                                  .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexed",       () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.firstIndexed(),)                                 .getFirst_amountOfCall,) .toBe(1,),)
            test("firstIndexedOrNull", () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.firstIndexedOrNull(),)                           .getFirst_amountOfCall,) .toBe(1,),)
            test("last",               () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.last(),)                                         .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.lastOrNull(),)                                   .getLast_amountOfCall,)  .toBe(1,),)
            test("lastIndexed",        () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.lastIndexed(),)                                  .getLast_amountOfCall,)  .toBe(1,),)
            test("lastOrNull",         () => expect(new CollectionHolder_SetOf2Follower().execute(it => it.lastIndexedOrNull(),)                            .getLast_amountOfCall,)  .toBe(1,),)
        ...
        describe("first", () => {
            test("all", () => {
                const method = vi.spyOn(getFirstModule, "getFirst",)
                first(A,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getFirstModule, "getFirstByMinimalistCollectionHolder",)
                firstByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,),)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getFirstModule, "getFirstByCollectionHolder",)
                firstByCollectionHolder(new CollectionHolderFromArray(A,),)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getFirstModule, "getFirstByArray",)
                firstByArray(A,)
                expect(method,).toHaveBeenCalledOnce()
            },)
        },)
        describe("firstOrNull", () => {
            test("all", () => {
                const method = vi.spyOn(getFirstOrNullModule, "getFirstOrNull",)
                firstOrNull(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getFirstOrNullModule, "getFirstOrNullByMinimalistCollectionHolder",)
                firstOrNullByMinimalistCollectionHolder(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getFirstOrNullModule, "getFirstOrNullByCollectionHolder",)
                firstOrNullByCollectionHolder(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getFirstOrNullModule, "getFirstOrNullByArray",)
        ...
        describe("last", () => {
            test("all", () => {
                const method = vi.spyOn(getLastModule, "getLast",)
                last(A,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getLastModule, "getLastByMinimalistCollectionHolder",)
                lastByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,),)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getLastModule, "getLastByCollectionHolder",)
                lastByCollectionHolder(new CollectionHolderFromArray(A,),)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getLastModule, "getLastByArray",)
                lastByArray(A,)
                expect(method,).toHaveBeenCalledOnce()
            },)
        },)
        describe("lastOrNull", () => {
            test("all", () => {
                const method = vi.spyOn(getLastOrNullModule, "getLastOrNull",)
                lastOrNull(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getLastOrNullModule, "getLastOrNullByMinimalistCollectionHolder",)
                lastOrNullByMinimalistCollectionHolder(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getLastOrNullModule, "getLastOrNullByCollectionHolder",)
                lastOrNullByCollectionHolder(null,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getLastOrNullModule, "getLastOrNullByArray",)
        ...
        describe("atOrElse", () => {
            test("all", () => {
                const method = vi.spyOn(getOrElseModule, "getOrElse",)
                atOrElse(A, 0, callbackAsFail0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getOrElseModule, "getOrElseByMinimalistCollectionHolder",)
                atOrElseByMinimalistCollectionHolder(new MinimalistCollectionHolderFromArray(A,), 0, callbackAsFail0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getOrElseModule, "getOrElseByCollectionHolder",)
                atOrElseByCollectionHolder(new CollectionHolderFromArray(A,), 0, callbackAsFail0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getOrElseModule, "getOrElseByArray",)
        ...
        describe("atOrNull", () => {
            test("all", () => {
                const method = vi.spyOn(getOrNullModule, "getOrNull",)
                atOrNull(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("minimalist collection holder", () => {
                const method = vi.spyOn(getOrNullModule, "getOrNullByMinimalistCollectionHolder",)
                atOrNullByMinimalistCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("collection holder", () => {
                const method = vi.spyOn(getOrNullModule, "getOrNullByCollectionHolder",)
                atOrNullByCollectionHolder(null, 0,)
                expect(method,).toHaveBeenCalledOnce()
            },)
            test("array", () => {
                const method = vi.spyOn(getOrNullModule, "getOrNullByArray",)
    ...
    describe("instances", () => {
        describe("empty", () => {
            describe("minimalist - get", () => {
                test("NaN", () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(NaN,),)      .toThrow(EmptyCollectionException,),)
                test("-∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(-Infinity,),).toThrow(EmptyCollectionException,),)
                test("-2",  () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(-2,),)       .toThrow(EmptyCollectionException,),)
                test("-1",  () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(-1,),)       .toThrow(EmptyCollectionException,),)
                test('0',   () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(0,),)        .toThrow(EmptyCollectionException,),)
                test('1',   () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(1,),)        .toThrow(EmptyCollectionException,),)
                test("+∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(EMPTY,).get(Infinity,),) .toThrow(EmptyCollectionException,),)
            },)
        ...
        describe("1 field", () => {
            describe("minimalist - get", () => {
                test("NaN", () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(NaN,),)      .toThrow(ForbiddenIndexException,),)
                test("-∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(-Infinity,),).toThrow(ForbiddenIndexException,),)
                test("-3",  () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(-3,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-2",  () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(-2,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-1",  () => expect(      new CollectionHolder_ByMinimalistCollection(A,).get(-1,),)       .toBe('a',),)
                test('0',   () => expect(      new CollectionHolder_ByMinimalistCollection(A,).get(0,),)        .toBe('a',),)
                test('1',   () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(1,),)        .toThrow(IndexOutOfBoundsException,),)
                test('2',   () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(2,),)        .toThrow(IndexOutOfBoundsException,),)
                test("+∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(A,).get(Infinity,),) .toThrow(ForbiddenIndexException,),)
            },)
        ...
        describe("2 fields", () => {
            describe("minimalist - get", () => {
                test("NaN", () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(NaN,),)      .toThrow(ForbiddenIndexException,),)
                test("-∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(-Infinity,),).toThrow(ForbiddenIndexException,),)
                test("-4",  () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(-4,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-3",  () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(-3,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-2",  () => expect(      new CollectionHolder_ByMinimalistCollection(AB,).get(-2,),)       .toBe('a',),)
                test("-1",  () => expect(      new CollectionHolder_ByMinimalistCollection(AB,).get(-1,),)       .toBe('b',),)
                test('0',   () => expect(      new CollectionHolder_ByMinimalistCollection(AB,).get(0,),)        .toBe('a',),)
                test('1',   () => expect(      new CollectionHolder_ByMinimalistCollection(AB,).get(1,),)        .toBe('b',),)
                test('2',   () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(2,),)        .toThrow(IndexOutOfBoundsException,),)
                test('3',   () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(3,),)        .toThrow(IndexOutOfBoundsException,),)
                test("+∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(AB,).get(Infinity,),) .toThrow(ForbiddenIndexException,),)
            },)
        ...
        describe("N fields", () => {
            describe("minimalist - get", () => {
                test("NaN", () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(NaN,),)      .toThrow(ForbiddenIndexException,),)
                test("-∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(-Infinity,),).toThrow(ForbiddenIndexException,),)
                test("-6",  () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(-6,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-5",  () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(-5,),)       .toThrow(IndexOutOfBoundsException,),)
                test("-4",  () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(-4,),)       .toBe('a',),)
                test("-3",  () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(-3,),)       .toBe('b',),)
                test("-2",  () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(-2,),)       .toBe('c',),)
                test("-1",  () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(-1,),)       .toBe('d',),)
                test('0',   () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(0,),)        .toBe('a',),)
                test('1',   () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(1,),)        .toBe('b',),)
                test('2',   () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(2,),)        .toBe('c',),)
                test('3',   () => expect(      new CollectionHolder_ByMinimalistCollection(ABCD,).get(3,),)        .toBe('d',),)
                test('4',   () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(4,),)        .toThrow(IndexOutOfBoundsException,),)
                test('5',   () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(5,),)        .toThrow(IndexOutOfBoundsException,),)
                test("+∞",  () => expect(() => new CollectionHolder_ByMinimalistCollection(ABCD,).get(Infinity,),) .toThrow(ForbiddenIndexException,),)
            },)
