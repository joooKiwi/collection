...
describe("CollectionHolderTest (forEach / onEach)", () => {
    ...
    describe.each(everyExtensionMethodInstances,)("%s", ({value: {instance,},},) => {
        ...
        describe("onEach",          () => expectToBeInstance(instance, it => it.onEach(callbackAsFail0,),),)
        describe("onEachIndexed",   () => expectToBeInstance(instance, it => it.onEachIndexed(callbackAsFail0,),),)
    },)},)
