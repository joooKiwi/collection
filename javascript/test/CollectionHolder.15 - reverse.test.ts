...
describe("CollectionHolderTest (reverse)", () => {
    ...
    describe("methods", () => {
        test.each(everyExtensionMethodInstances,)("%s", ({value: {instance,},},) => expect(instance.toReverse(),).toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
    },)
    ...
    describe.each(everyInstances,)("%s", ({value: {instance,},},) => {
        ...
        describe("empty", () => {
            test("direct",     () => expect(new instance(EMPTY,).toReverse(),)                .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (NaN)", () => expect(new instance(EMPTY,).toReverse(NaN,),)            .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (-∞)",  () => expect(new instance(EMPTY,).toReverse(-Infinity,),)      .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (-1)",  () => expect(new instance(EMPTY,).toReverse(-1,),)             .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (0)",   () => expect(new instance(EMPTY,).toReverse(0,),)              .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (1)",   () => expect(new instance(EMPTY,).toReverse(1,),)              .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("from (+∞)",  () => expect(new instance(EMPTY,).toReverse(Infinity,),)       .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (NaN)",   () => expect(new instance(EMPTY,).toReverse(null, NaN,),)      .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (-∞)",    () => expect(new instance(EMPTY,).toReverse(null, -Infinity,),).toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (-1)",    () => expect(new instance(EMPTY,).toReverse(null, -1,),)       .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (0)",     () => expect(new instance(EMPTY,).toReverse(null, 0,),)        .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (1)",     () => expect(new instance(EMPTY,).toReverse(null, 1,),)        .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
            test("to (+∞)",    () => expect(new instance(EMPTY,).toReverse(null, Infinity,),) .toBe(CollectionConstants.EMPTY_COLLECTION_HOLDER,),)
        },)
        describe("1 field", () => {
        ...
        describe("to", () => {
            ...
            test("-4",   () => expect(      new instance(ABCD,).toReverse(null, -4,).toArray(),).toStrictEqual(A,),)
            test("-3",   () => expect(      new instance(ABCD,).toReverse(null, -3,).toArray(),).toStrictEqual(BA,),)
            test("-2",   () => expect(      new instance(ABCD,).toReverse(null, -2,).toArray(),).toStrictEqual(CBA,),)
            test("-1",   () => expect(      new instance(ABCD,).toReverse(null, -1,).toArray(),).toStrictEqual(DCBA,),)
            test("0",    () => expect(      new instance(ABCD,).toReverse(null, 0,).toArray(),) .toStrictEqual(A,),)
            test("1",    () => expect(      new instance(ABCD,).toReverse(null, 1,).toArray(),) .toStrictEqual(BA,),)
            test("2",    () => expect(      new instance(ABCD,).toReverse(null, 2,).toArray(),) .toStrictEqual(CBA,),)
            test("3",    () => expect(      new instance(ABCD,).toReverse(null, 3,).toArray(),) .toStrictEqual(DCBA,),)
