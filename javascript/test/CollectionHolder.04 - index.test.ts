...
describe("CollectionHolderTest (index)", () => {
    ...
    describe("EmptyCollectionHolder", () => {
        test("firstIndexOf",                () => expect(() => new EmptyCollectionHolderForTest().firstIndexOf(),).toThrow(EmptyCollectionHolderException,),)
        test("indexOf",                     () => expect(() => new EmptyCollectionHolderForTest().indexOf(),).toThrow(EmptyCollectionHolderException,),)
        ...
        test("lastIndexOf",                 () => expect(() => new EmptyCollectionHolderForTest().lastIndexOf(),).toThrow(EmptyCollectionHolderException,),)
        test("lastIndexOfOrNull",           () => expect(new EmptyCollectionHolderForTest().lastIndexOfOrNull(),).toBeNull(),)
        test("indexOfFirst",                () => expect(() => new EmptyCollectionHolderForTest().indexOfFirst(),).toThrow(EmptyCollectionHolderException,),)
        test("findFirstIndex",              () => expect(() => new EmptyCollectionHolderForTest().findFirstIndex(),).toThrow(EmptyCollectionHolderException,),)
        test("findIndex",                   () => expect(() => new EmptyCollectionHolderForTest().findIndex(),).toThrow(EmptyCollectionHolderException,),)
        ...
        test("indexOfFirstIndexed",         () => expect(() => new EmptyCollectionHolderForTest().indexOfFirstIndexed(),).toThrow(EmptyCollectionHolderException,),)
        test("findFirstIndexIndexed",       () => expect(() => new EmptyCollectionHolderForTest().findFirstIndexIndexed(),).toThrow(EmptyCollectionHolderException,),)
        test("findIndexIndexed",            () => expect(() => new EmptyCollectionHolderForTest().findIndexIndexed(),).toThrow(EmptyCollectionHolderException,),)
        ...
        test("indexOfLast",                 () => expect(() => new EmptyCollectionHolderForTest().indexOfLast(),).toThrow(EmptyCollectionHolderException,),)
        test("findLastIndex",               () => expect(() => new EmptyCollectionHolderForTest().findLastIndex(),).toThrow(EmptyCollectionHolderException,),)
        ...
        test("indexOfLastIndexed",          () => expect(() => new EmptyCollectionHolderForTest().indexOfLastIndexed(),).toThrow(EmptyCollectionHolderException,),)
        test("findLastIndexIndexed",        () => expect(() => new EmptyCollectionHolderForTest().findLastIndexIndexed(),).toThrow(EmptyCollectionHolderException,),)
    ...
    describe.each(everyCollectionInstancesAndExtensionFunctionAsCollectionHolder,)("%s", ({value: {instance, isExtension,},},) => {
        if (!isExtension)
            describe("get() being called", () => {
                describe("firstIndexOf", () => {
                    test("empty",        () => expect(new instance<string>(EMPTY,).executeWhileIgnoringEmptyException(it => it.firstIndexOf('a',),).amountOfCall,).toBe(0,),)
                    test("1 field (a)",  () => expect(new instance(A,).execute(it => it.firstIndexOf('a',),).amountOfCall,).toBe(1,),)
                    test("1 field (e)",  () => expect(new instance<string>(A,).executeWhileIgnoringIndexOutOfBound(it => it.firstIndexOf('e',),).amountOfCall,).toBe(1,),)
                    test("2 fields (a)", () => expect(new instance(AB,).execute(it => it.firstIndexOf('a',),).amountOfCall,).toBe(1,),)
                    test("2 fields (k)", () => expect(new instance<string>(AB,).executeWhileIgnoringIndexOutOfBound(it => it.firstIndexOf('k',),).amountOfCall,).toBe(2,),)
                    test("4 fields (a)", () => expect(new instance(ABCD,).execute(it => it.firstIndexOf('a',),).amountOfCall,).toBe(1,),)
                    test("4 fields (k)", () => expect(new instance<string>(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.firstIndexOf('k',),).amountOfCall,).toBe(4,),)
                },)
                ...
                describe("lastIndexOf", () => {
                    test("empty",        () => expect(new instance<string>(EMPTY,).executeWhileIgnoringEmptyException(it => it.lastIndexOf('a',),).amountOfCall,).toBe(0,),)
                    test("1 field (a)",  () => expect(new instance(A,).execute(it => it.lastIndexOf('a',),).amountOfCall,).toBe(1,),)
                    test("1 field (k)",  () => expect(new instance<string>(A,).executeWhileIgnoringIndexOutOfBound(it => it.lastIndexOf('k',),).amountOfCall,).toBe(1,),)
                    test("2 fields (b)", () => expect(new instance(AB,).execute(it => it.lastIndexOf('b',),).amountOfCall,).toBe(1,),)
                    test("2 fields (k)", () => expect(new instance<string>(AB,).executeWhileIgnoringIndexOutOfBound(it => it.lastIndexOf('k',),).amountOfCall,).toBe(2,),)
                    test("4 fields (d)", () => expect(new instance(ABCD,).execute(it => it.lastIndexOf('d',),).amountOfCall,).toBe(1,),)
                    test("4 fields (k)", () => expect(new instance<string>(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.lastIndexOf('k',),).amountOfCall,).toBe(4,),)
                },)
                ...
                describe("indexOfFirst", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirst(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirst(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirst(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                        test("false: 2 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                        test("false: 2 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                        test("false: 2 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirst(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("indexOfFirstIndexed", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirstIndexed(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirstIndexed(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfFirstIndexed(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfFirstIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("indexOfLast", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLast(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLast(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLast(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                        test("false: 2 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                        test("false: 2 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                        test("false: 2 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLast(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
                ...
                describe("indexOfLastIndexed", () => {
                    describe("empty", () => {
                        test("0 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLastIndexed(callbackAsFail0,),).amountOfCall,).toBe(0,),)
                        test("1 argument",  () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLastIndexed(callbackAsFail1,),).amountOfCall,).toBe(0,),)
                        test("2 arguments", () => expect(new instance(EMPTY,).executeWhileIgnoringEmptyException(it => it.indexOfLastIndexed(callbackAsFail2,),).amountOfCall,).toBe(0,),)
                    },)
                    describe("1 field", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(A,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                    },)
                    describe("2 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(AB,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                    },)
                    describe("4 fields", () => {
                        ...
                        test("false: 0 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse0,),).amountOfCall,).toBe(0,),)
                        test("false: 1 argument",  () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse1,),).amountOfCall,).toBe(0,),)
                        test("false: 2 arguments", () => expect(new instance(ABCD,).executeWhileIgnoringIndexOutOfBound(it => it.indexOfLastIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                    },)
                },)
        ...
        describe("firstIndexOf", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a',),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance<string>(EMPTY,).firstIndexOf('a', null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("1 field", () => {
                test('a', () => expect(new instance(A,).firstIndexOf('a',),).toBe(0,),)
                test('e', () => expect(() => new instance<string>(A,).firstIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('a', () => expect(new instance(AA,).firstIndexOf('a',),).toBe(0,),)
                test('e', () => expect(() => new instance<string>(AA,).firstIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                test('a', () => expect(new instance(ABAB,).firstIndexOf('a',),).toBe(0,),)
                test('b', () => expect(new instance(ABAB,).firstIndexOf('b',),).toBe(1,),)
                test('e', () => expect(() => new instance<string>(ABAB,).firstIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-500", () => expect(() => new instance(ABAB,).firstIndexOf('a', -500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("-6",   () => expect(() => new instance(ABAB,).firstIndexOf('a', -6,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("-5",   () => expect(() => new instance(ABAB,).firstIndexOf('a', -5,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("-1",   () => expect(() => new instance(ABAB,).firstIndexOf('a', -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(ABAB,).firstIndexOf('a', 0,),).toBe(0,),)
                test('1',    () => expect(new instance(ABAB,).firstIndexOf('a', 1,),).toBe(2,),)
                test('2',    () => expect(new instance(ABAB,).firstIndexOf('a', 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).firstIndexOf('a', 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('4',    () => expect(() => new instance(ABAB,).firstIndexOf('a', 4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('5',    () => expect(() => new instance(ABAB,).firstIndexOf('a', 5,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("500",  () => expect(() => new instance(ABAB,).firstIndexOf('a', 500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("+∞",   () => expect(() => new instance(ABAB,).firstIndexOf('a', Infinity,),).toThrow(ForbiddenIndexException,),)
            },)
            describe("to", () => {
                ...
                test("-500", () => expect(() => new instance(ABAB,).firstIndexOf('a', null, -500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("-6",   () => expect(() => new instance(ABAB,).firstIndexOf('a', null, -6,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("-5",   () => expect(() => new instance(ABAB,).firstIndexOf('a', null, -5,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(new instance(ABAB,).firstIndexOf('a', null, 2,),).toBe(0,),)
                test('3',    () => expect(new instance(ABAB,).firstIndexOf('a', null, 3,),).toBe(0,),)
                test('4',    () => expect(() => new instance(ABAB,).firstIndexOf('a', null, 4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('5',    () => expect(() => new instance(ABAB,).firstIndexOf('a', null, 5,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("500",  () => expect(() => new instance(ABAB,).firstIndexOf('a', null, 500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("+∞",   () => expect(() => new instance(ABAB,).firstIndexOf('a', null, Infinity,),).toThrow(ForbiddenIndexException,),)
            },)
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).firstIndexOf('a', 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).firstIndexOf('a', 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("firstIndexOfOrNull", () => {
            describe("empty", () => {
        ...
        describe("lastIndexOf", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a',),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance<string>(EMPTY,).lastIndexOf('a', null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("1 field", () => {
                test('a', () => expect(new instance(A,).lastIndexOf('a',),).toBe(0,),)
                test('e', () => expect(() => new instance<string>(A,).lastIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('a', () => expect(new instance(AB,).lastIndexOf('a',),).toBe(0,),)
                test('b', () => expect(new instance(AB,).lastIndexOf('b',),).toBe(1,),)
                test('e', () => expect(() => new instance<string>(AB,).lastIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e', () => expect(() => new instance<string>(ABCD,).lastIndexOf('e',),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-500", () => expect(() => new instance(ABAB,).lastIndexOf('a', -500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("-1",   () => expect(() => new instance(ABAB,).lastIndexOf('a', -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(ABAB,).lastIndexOf('a', 0,),).toBe(2,),)
                test('1',    () => expect(new instance(ABAB,).lastIndexOf('a', 1,),).toBe(2,),)
                test('2',    () => expect(new instance(ABAB,).lastIndexOf('a', 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).lastIndexOf('a', 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('4',    () => expect(() => new instance(ABAB,).lastIndexOf('a', 4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('5',    () => expect(() => new instance(ABAB,).lastIndexOf('a', 5,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("500",  () => expect(() => new instance(ABAB,).lastIndexOf('a', 500,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("+∞",   () => expect(() => new instance(ABAB,).lastIndexOf('a', Infinity,),).toThrow(ForbiddenIndexException,),)
            },)
            ...
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).lastIndexOf('a', 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).lastIndexOf('a', 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("lastIndexOfOrNull", () => {
            describe("empty", () => {
        ...
        describe("indexOfFirst", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance(EMPTY,).indexOfFirst(callbackAsFail0, null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                ...
                describe.each(falseCallbacks,)("false: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).indexOfFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).indexOfFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).indexOfFirst(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).indexOfFirst(callbackIsA,),).toBe(0,),)
                test('e',    () => expect(() => new instance(A,).indexOfFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).indexOfFirst(callbackIsEvenAlt,),).toBe(0,),)
                test("odd",  () => expect(() => new instance(A,).indexOfFirst(callbackIsOddAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).indexOfFirst(callbackIs0Alt,),).toBe(0,),)
                test('4',    () => expect(() => new instance(A,).indexOfFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                ...
                test('e',    () => expect(() => new instance(AB,).indexOfFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(AB,).indexOfFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).indexOfFirst(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).indexOfFirst(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-1",   () => expect(() => new instance(ABAB,).indexOfFirst(callbackIsA, -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(new instance(ABAB,).indexOfFirst(callbackIsA, 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).indexOfFirst(callbackIsA, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).indexOfFirst(callbackIsA, 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).indexOfFirst(callbackIsA, 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("indexOfFirstOrNull", () => {
            describe("empty", () => {
        ...
        describe("indexOfFirstIndexed", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance(EMPTY,).indexOfFirstIndexed(callbackAsFail0, null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                ...
                describe.each(falseCallbacks,)("false: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).indexOfFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).indexOfFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).indexOfFirstIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',    () => expect(new instance(A,).indexOfFirstIndexed(callbackIsAAlt,),).toBe(0,),)
                test('e',    () => expect(() => new instance(A,).indexOfFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even", () => expect(new instance(A,).indexOfFirstIndexed(callbackIsEven,),).toBe(0,),)
                test("odd",  () => expect(() => new instance(A,).indexOfFirstIndexed(callbackIsOdd,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',    () => expect(new instance(A,).indexOfFirstIndexed(callbackIs0,),).toBe(0,),)
                test('4',    () => expect(() => new instance(A,).indexOfFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("2 fields", () => {
                ...
                test('e',    () => expect(() => new instance(AB,).indexOfFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(AB,).indexOfFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("4 fields", () => {
                ...
                test('e',    () => expect(() => new instance(ABCD,).indexOfFirstIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',    () => expect(() => new instance(ABCD,).indexOfFirstIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-1",   () => expect(() => new instance(ABAB,).indexOfFirstIndexed(callbackIsEven, -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(new instance(ABAB,).indexOfFirstIndexed(callbackIsEven, 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).indexOfFirstIndexed(callbackIsEven, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).indexOfFirstIndexed(callbackIsAAlt, 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).indexOfFirstIndexed(callbackIsAAlt, 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("indexOfFirstIndexedOrNull", () => {
            describe("empty", () => {
        ...
        describe("indexOfLast", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance(EMPTY,).indexOfLast(callbackAsFail0, null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                ...
                describe.each(falseCallbacks,)("false: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).indexOfLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).indexOfLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).indexOfLast(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',     () => expect(new instance(A,).indexOfLast(callbackIsA,),).toBe(0,),)
                test('e',     () => expect(() => new instance(A,).indexOfLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even",  () => expect(new instance(A,).indexOfLast(callbackIsEvenAlt,),).toBe(0,),)
                test("odd",   () => expect(() => new instance(A,).indexOfLast(callbackIsOddAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',     () => expect(new instance(A,).indexOfLast(callbackIs0Alt,),).toBe(0,),)
                test('4',     () => expect(() => new instance(A,).indexOfLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('a',     () => expect(new instance(AB,).indexOfLast(callbackIsA,),).toBe(0,),)
                test('b',     () => expect(new instance(AB,).indexOfLast(callbackIsB,),).toBe(1,),)
                test('e',     () => expect(() => new instance(AB,).indexOfLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',     () => expect(() => new instance(AB,).indexOfLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('e',     () => expect(() => new instance(ABCD,).indexOfLast(callbackIsE,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',     () => expect(() => new instance(ABCD,).indexOfLast(callbackIs4Alt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-1",   () => expect(() => new instance(ABAB,).indexOfLast(callbackIsA, -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(new instance(ABAB,).indexOfLast(callbackIsA, 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).indexOfLast(callbackIsA, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).indexOfLast(callbackIsA, 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).indexOfLast(callbackIsA, 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("indexOfLastOrNull", () => {
            describe("empty", () => {
        ...
        describe("indexOfLastIndexed", () => {
            describe("empty", () => {
                test("direct",     () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (NaN)", () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-∞)",  () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("from (-1)",  () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (0)",   () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("from (1)",   () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("from (+∞)",  () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (NaN)",   () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, NaN,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-∞)",    () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, -Infinity,),).toThrow(EmptyCollectionHolderException,),)
                test("to (-1)",    () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, -1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (0)",     () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, 0,),).toThrow(EmptyCollectionHolderException,),)
                test("to (1)",     () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, 1,),).toThrow(EmptyCollectionHolderException,),)
                test("to (+∞)",    () => expect(() => new instance(EMPTY,).indexOfLastIndexed(callbackAsFail0, null, Infinity,),).toThrow(EmptyCollectionHolderException,),)
            },)
            describe("boolean callbacks", () => {
                ...
                describe.each(falseCallbacks,)("false: %s", ({value: it,},) => {
                    test("1 field",  () => expect(() => new instance(A,).indexOfLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("2 fields", () => expect(() => new instance(AB,).indexOfLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                    test("4 fields", () => expect(() => new instance(ABCD,).indexOfLastIndexed(it,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                },)
            },)
            describe("1 field", () => {
                test('a',     () => expect(new instance(A,).indexOfLastIndexed(callbackIsAAlt,),).toBe(0,),)
                test('e',     () => expect(() => new instance(A,).indexOfLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test("even",  () => expect(new instance(A,).indexOfLastIndexed(callbackIsEven,),).toBe(0,),)
                test("odd",   () => expect(() => new instance(A,).indexOfLastIndexed(callbackIsOdd,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                test('0',     () => expect(new instance(A,).indexOfLastIndexed(callbackIs0,),).toBe(0,),)
                test('4',     () => expect(() => new instance(A,).indexOfLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("2 fields", () => {
                ...
                test('e',     () => expect(() => new instance(AB,).indexOfLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',     () => expect(() => new instance(AB,).indexOfLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("4 fields", () => {
                ...
                test('e',     () => expect(() => new instance(ABCD,).indexOfLastIndexed(callbackIsEAlt,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('4',     () => expect(() => new instance(ABCD,).indexOfLastIndexed(callbackIs4,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-1",   () => expect(() => new instance(ABAB,).indexOfLastIndexed(callbackIsEven, -1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test('2',    () => expect(new instance(ABAB,).indexOfLastIndexed(callbackIsEven, 2,),).toBe(2,),)
                test('3',    () => expect(() => new instance(ABAB,).indexOfLastIndexed(callbackIsEven, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            ...
            describe("from + to", () => {
                ...
                test("1, 1", () => expect(() => new instance(ABAB,).indexOfLastIndexed(callbackIsAAlt, 1, 1,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
                ...
                test("3, 3", () => expect(() => new instance(ABAB,).indexOfLastIndexed(callbackIsAAlt, 3, 3,),).toThrow(CollectionHolderIndexOutOfBoundsException,),)
            },)
        },)
        describe("indexOfLastIndexedOrNull", () => {
            describe("empty", () => {
