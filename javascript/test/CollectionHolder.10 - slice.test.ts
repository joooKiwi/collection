...
import {emptyCollectionHolder, everyExtensionMethodInstances, everyInstances, everyIterableInstances} from "./value/instances"
...
describe("CollectionHolderTest (slice)", () => {
    ...
    describe.each(everyExtensionMethodInstances,)("%s", ({value: {instance,},},) => {
        describe("slice",                                () => expect(instance.slice(),)                                                                    .toBe(emptyCollectionHolder,),)
        describe("slice (range)",                        () => expect(instance.sliceWithARange(),)                                                          .toBe(emptyCollectionHolder,),)
        describe("slice (array)",                        () => expect(instance.sliceWithArray(EMPTY,),)                                                     .toBe(emptyCollectionHolder,),)
        describe("slice (set)",                          () => expect(instance.sliceWithSet(new Set(),),)                                                   .toBe(emptyCollectionHolder,),)
        describe("slice (collection holder)",            () => expect(instance.sliceWithCollectionHolder(new CollectionHolderFromArray(EMPTY,),),)          .toBe(emptyCollectionHolder,),)
        describe("slice (minimalist collection holder)", () => expect(instance.sliceWithMinimalistCollectionHolder(new CollectionHolderFromArray(EMPTY,),),).toBe(emptyCollectionHolder,),)
        describe("slice (collection iterator)",          () => expect(instance.sliceWithCollectionIterator(new CollectionIteratorFromArray(EMPTY,),),)      .toBe(emptyCollectionHolder,),)
        describe("slice (iterator)",                     () => expect(instance.sliceWithIterator(EMPTY[Symbol.iterator](),),)                               .toBe(emptyCollectionHolder,),)
        describe("slice (iterable)",                     () => expect(instance.sliceWithIterable(EMPTY,),)                                                  .toBe(emptyCollectionHolder,),)
    },)},)
    ...
    describe.each(everyInstances,)("%s", ({value: {instance, type,},},) => {
        ...
        describe.each(everyIterableInstances,)("by indices: %s", ({value: iterable,},) => {
            describe("empty", () => {
                test("none", () => expect(new instance(EMPTY,).slice(new iterable(EMPTY,),),).toBe(emptyCollectionHolder,),)
                test('0',    () => expect(new instance(EMPTY,).slice(new iterable(_0,),),)   .toBe(emptyCollectionHolder,),)
                test("01",   () => expect(new instance(EMPTY,).slice(new iterable(_01,),),)  .toBe(emptyCollectionHolder,),)
                test("0123", () => expect(new instance(EMPTY,).slice(new iterable(_0123,),),).toBe(emptyCollectionHolder,),)
            },)
            describe("1 field", () => {
                test("none", () => expect(      new instance(A,)                                          .slice(new iterable(EMPTY,),),)       .toBe(emptyCollectionHolder,),)
                test('0',    () => expect(      new instance(A,)                                          .slice(new iterable(_0,),).toArray(),).toStrictEqual(A,),)
            ...
            describe("2 fields", () => {
                test("none", () => expect(      new instance(AB,)                                          .slice(new iterable(EMPTY,),),)        .toBe(emptyCollectionHolder,),)
                test('0',    () => expect(      new instance(AB,)                                          .slice(new iterable(_0,),).toArray(),) .toStrictEqual(A,),)
                test('1',    () => expect(      new instance(AB,)                                          .slice(new iterable(_1,),).toArray(),) .toStrictEqual(B,),)
                ...
                test("01",   () => expect(      new instance(AB,)                                          .slice(new iterable(_01,),).toArray(),).toStrictEqual(AB,),)
            ...
            describe("4 fields", () => {
                test("none", () => expect(      new instance(ABCD,)                                          .slice(new iterable(EMPTY,),),)          .toBe(emptyCollectionHolder,),)
                test('0',    () => expect(      new instance(ABCD,)                                          .slice(new iterable(_0,),).toArray(),)   .toStrictEqual(A,),)
                test('1',    () => expect(      new instance(ABCD,)                                          .slice(new iterable(_1,),).toArray(),)   .toStrictEqual(B,),)
                test('2',    () => expect(      new instance(ABCD,)                                          .slice(new iterable(_2,),).toArray(),)   .toStrictEqual(C,),)
                test('3',    () => expect(      new instance(ABCD,)                                          .slice(new iterable(_3,),).toArray(),)   .toStrictEqual(D,),)
                ...
                test("01",   () => expect(      new instance(ABCD,)                                          .slice(new iterable(_01,),).toArray(),)  .toStrictEqual(AB,),)
                ...
                test("0123", () => expect(      new instance(ABCD,)                                          .slice(new iterable(_0123,),).toArray(),).toStrictEqual(ABCD,),)
        ...
        describe("by range", () => {
            describe("empty", () => {
                test("direct",     () => expect(new instance(EMPTY,).slice(),)                .toBe(emptyCollectionHolder,),)
                test("from (NaN)", () => expect(new instance(EMPTY,).slice(NaN,),)            .toBe(emptyCollectionHolder,),)
                test("from (-∞)",  () => expect(new instance(EMPTY,).slice(-Infinity,),)      .toBe(emptyCollectionHolder,),)
                test("from (-1)",  () => expect(new instance(EMPTY,).slice(-1,),)             .toBe(emptyCollectionHolder,),)
                test("from (0)",   () => expect(new instance(EMPTY,).slice(0,),)              .toBe(emptyCollectionHolder,),)
                test("from (1)",   () => expect(new instance(EMPTY,).slice(1,),)              .toBe(emptyCollectionHolder,),)
                test("from (+∞)",  () => expect(new instance(EMPTY,).slice(Infinity,),)       .toBe(emptyCollectionHolder,),)
                test("to (NaN)",   () => expect(new instance(EMPTY,).slice(null, NaN,),)      .toBe(emptyCollectionHolder,),)
                test("to (-∞)",    () => expect(new instance(EMPTY,).slice(null, -Infinity,),).toBe(emptyCollectionHolder,),)
                test("to (-1)",    () => expect(new instance(EMPTY,).slice(null, -1,),)       .toBe(emptyCollectionHolder,),)
                test("to (0)",     () => expect(new instance(EMPTY,).slice(null, 0,),)        .toBe(emptyCollectionHolder,),)
                test("to (1)",     () => expect(new instance(EMPTY,).slice(null, 1,),)        .toBe(emptyCollectionHolder,),)
                test("to (+∞)",    () => expect(new instance(EMPTY,).slice(null, Infinity,),) .toBe(emptyCollectionHolder,),)
            },)
            describe("1 field", () => {
                test('0', () => expect(      new instance(A,).slice(0,).toArray(),).toStrictEqual(A,),)
                test('4', () => expect(() => new instance(A,).slice(4,),)          .toThrow(IndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('0', () => expect(      new instance(AB,).slice(0,).toArray(),).toStrictEqual(AB,),)
                test('1', () => expect(      new instance(AB,).slice(1,).toArray(),).toStrictEqual(B,),)
                test('4', () => expect(() => new instance(AB,).slice(4,),)          .toThrow(IndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                test('0', () => expect(      new instance(ABCD,).slice(0,).toArray(),).toStrictEqual(ABCD,),)
                test('1', () => expect(      new instance(ABCD,).slice(1,).toArray(),).toStrictEqual(BCD,),)
                test('2', () => expect(      new instance(ABCD,).slice(2,).toArray(),).toStrictEqual(CD,),)
                test('3', () => expect(      new instance(ABCD,).slice(3,).toArray(),).toStrictEqual(D,),)
            ...
            describe("from", () => {
                ...
                test("-4",   () => expect(      new instance(ABCD,).slice(-4,).toArray(),).toStrictEqual(ABCD,),)
                test("-3",   () => expect(      new instance(ABCD,).slice(-3,).toArray(),).toStrictEqual(BCD,),)
                test("-2",   () => expect(      new instance(ABCD,).slice(-2,).toArray(),).toStrictEqual(CD,),)
                test("-1",   () => expect(      new instance(ABCD,).slice(-1,).toArray(),).toStrictEqual(D,),)
                test("0",    () => expect(      new instance(ABCD,).slice(0,).toArray(),) .toStrictEqual(ABCD,),)
                test("1",    () => expect(      new instance(ABCD,).slice(1,).toArray(),) .toStrictEqual(BCD,),)
                test("2",    () => expect(      new instance(ABCD,).slice(2,).toArray(),) .toStrictEqual(CD,),)
                test("3",    () => expect(      new instance(ABCD,).slice(3,).toArray(),) .toStrictEqual(D,),)
            ...
            describe("to", () => {
                ...
                test("-4",   () => expect(      new instance(ABCD,).slice(null, -4,).toArray(),).toStrictEqual(A,),)
                test("-3",   () => expect(      new instance(ABCD,).slice(null, -3,).toArray(),).toStrictEqual(AB,),)
                test("-2",   () => expect(      new instance(ABCD,).slice(null, -2,).toArray(),).toStrictEqual(ABC,),)
                test("-1",   () => expect(      new instance(ABCD,).slice(null, -1,).toArray(),).toStrictEqual(ABCD,),)
                test("0",    () => expect(      new instance(ABCD,).slice(null, 0,).toArray(),) .toStrictEqual(A,),)
                test("1",    () => expect(      new instance(ABCD,).slice(null, 1,).toArray(),) .toStrictEqual(AB,),)
                test("2",    () => expect(      new instance(ABCD,).slice(null, 2,).toArray(),) .toStrictEqual(ABC,),)
                test("3",    () => expect(      new instance(ABCD,).slice(null, 3,).toArray(),) .toStrictEqual(ABCD,),)
            ...
            describe("from + to", () => {
                ...
                test("0, 0",       () => expect(      new instance(ABCD,).slice(0, 0,).toArray(),).toStrictEqual(A,),)
                test("0, 1",       () => expect(      new instance(ABCD,).slice(0, 1,).toArray(),).toStrictEqual(AB,),)
                test("0, 2",       () => expect(      new instance(ABCD,).slice(0, 2,).toArray(),).toStrictEqual(ABC,),)
                test("0, 3",       () => expect(      new instance(ABCD,).slice(0, 3,).toArray(),).toStrictEqual(ABCD,),)
                test("0, 500",     () => expect(() => new instance(ABCD,).slice(0, 500,),)        .toThrow(IndexOutOfBoundsException,),)
                test("0, +∞",      () => expect(() => new instance(ABCD,).slice(0, Infinity,),)   .toThrow(ForbiddenIndexException,),)
                ...
                test("1, 1",       () => expect(      new instance(ABCD,).slice(1, 1,).toArray(),).toStrictEqual(B,),)
                test("1, 2",       () => expect(      new instance(ABCD,).slice(1, 2,).toArray(),).toStrictEqual(BC,),)
                test("1, 3",       () => expect(      new instance(ABCD,).slice(1, 3,).toArray(),).toStrictEqual(BCD,),)
                test("1, 500",     () => expect(() => new instance(ABCD,).slice(1, 500,),)        .toThrow(IndexOutOfBoundsException,),)
                test("1, +∞",      () => expect(() => new instance(ABCD,).slice(1, Infinity,),)   .toThrow(ForbiddenIndexException,),)
                ...
                test("2, 2",       () => expect(      new instance(ABCD,).slice(2, 2,).toArray(),).toStrictEqual(C,),)
                test("2, 3",       () => expect(      new instance(ABCD,).slice(2, 3,).toArray(),).toStrictEqual(CD,),)
                test("2, 500",     () => expect(() => new instance(ABCD,).slice(2, 500,),)        .toThrow(IndexOutOfBoundsException,),)
                test("2, +∞",      () => expect(() => new instance(ABCD,).slice(2, Infinity,),)   .toThrow(ForbiddenIndexException,),)
                ...
                test("3, 3",       () => expect(      new instance(ABCD,).slice(3, 3,).toArray(),).toStrictEqual(D,),)
                test("3, 500",     () => expect(() => new instance(ABCD,).slice(3, 500,),)        .toThrow(IndexOutOfBoundsException,),)
                test("3, +∞",      () => expect(() => new instance(ABCD,).slice(3, Infinity,),)   .toThrow(ForbiddenIndexException,),)
