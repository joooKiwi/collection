    ...
    describe.each(everyCollectionInstancesAndExtensionFunctionAsCollectionHolder,)("%s", ({value: {instance, isExtension, type,},},) => {
        ...
        describe("by range", () => {
            ...
            describe("1 field", () => {
                ...
                test('4', () => expect(() => new instance(A,).executeWhileHavingIndexesOnField(it => it.slice(4,),),).toThrow(IndexOutOfBoundsException,),)
            },)
            describe("2 fields", () => {
                test('0', () => expect(new instance(AB,).slice(0,).toArray(),).toEqual(AB,),)
                test('1', () => expect(new instance(AB,).slice(1,).toArray(),).toEqual(B,),)
                test('4', () => expect(() => new instance(AB,).executeWhileHavingIndexesOnField(it => it.slice(4,),),).toThrow(IndexOutOfBoundsException,),)
            },)
            describe("4 fields", () => {
                ...
                test('4', () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(4,),),).toThrow(IndexOutOfBoundsException,),)
            },)
            ...
            describe("from", () => {
                ...
                test("-500", () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(-500,),),).toThrow(IndexOutOfBoundsException,),)
                test("-6",   () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(-6,),),).toThrow(IndexOutOfBoundsException,),)
                test("-5",   () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(-5,),),).toThrow(IndexOutOfBoundsException,),)
            ...
            describe("to", () => {
                ...
                test("-500", () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, -500,),),).toThrow(IndexOutOfBoundsException,),)
                test("-6",   () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, -6,),),).toThrow(IndexOutOfBoundsException,),)
                test("-5",   () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, -5,),),).toThrow(IndexOutOfBoundsException,),)
                ...
                test("4",    () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, 4,),),).toThrow(IndexOutOfBoundsException,),)
                test("5",    () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, 5,),),).toThrow(IndexOutOfBoundsException,),)
                test("500",  () => expect(() => new instance(ABCD,).executeWhileHavingIndexesOnField(it => it.slice(null, 500,),),).toThrow(IndexOutOfBoundsException,),)
                test("+∞",   () => expect(() => new instance(ABCD,).slice(null, Infinity,),).toThrow(ForbiddenIndexException,),)
            },)
