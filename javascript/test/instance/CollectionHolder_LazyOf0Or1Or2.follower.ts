 ...
 */
export class CollectionHolder_LazyOf0Or1Or2Follower
    ...
    public override indexOfFirst(predicate: BooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): | 0 | 1 {
        this.indexOfFirst_amountOfCall++
        return super.indexOfFirst(predicate, from, to,)
    }

    public override indexOfFirstOrNull(predicate: BooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): NullOrNumber<| 0 | 1> {
        this.indexOfFirstOrNull_amountOfCall++
        return super.indexOfFirstOrNull(predicate, from, to,)
    }

    public override indexOfFirstIndexed(predicate: ReverseBooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): | 0 | 1 {
        this.indexOfFirstIndexed_amountOfCall++
        return super.indexOfFirstIndexed(predicate, from, to,)
    }

    public override indexOfFirstIndexedOrNull(predicate: ReverseBooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): NullOrNumber<| 0 | 1> {
        this.indexOfFirstIndexedOrNull_amountOfCall++
        return super.indexOfFirstIndexedOrNull(predicate, from, to,)
    }


    public override indexOfLast(predicate: BooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): | 0 | 1 {
        this.indexOfLast_amountOfCall++
        return super.indexOfLast(predicate, from, to,)
    }

    public override indexOfLastOrNull(predicate: BooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): NullOrNumber<| 0 | 1> {
        this.indexOfLastOrNull_amountOfCall++
        return super.indexOfLastOrNull(predicate, from, to,)
    }

    public override indexOfLastIndexed(predicate: ReverseBooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): | 0 | 1 {
        this.indexOfLastIndexed_amountOfCall++
        return super.indexOfLastIndexed(predicate, from, to,)
    }

    public override indexOfLastIndexedOrNull(predicate: ReverseBooleanCallback<string>, from?: NullableNumber, to?: NullableNumber,): NullOrNumber<| 0 | 1> {
    ...
    public override take(n: number,): | CollectionHolderOf2<string> | CollectionHolderOf1<string> | EmptyCollectionHolder {
    ...
    public override takeLast(n: number,): | CollectionHolderOf2<string> | CollectionHolderOf1<string> | EmptyCollectionHolder {
    ...
    public override drop(n: number,): | CollectionHolderOf2<string> | CollectionHolderOf1<string> | EmptyCollectionHolder {
    ...
    public override dropLast(n: number,): | CollectionHolderOf2<string> | CollectionHolderOf1<string> | EmptyCollectionHolder {
    ...
    public override toReverse(from?: NullableNumber, to?: NullableNumber,): | CollectionHolderOf2<string> | CollectionHolderOf1<string> | EmptyCollectionHolder {
    ...
    public override toIterator(): | CollectionIteratorOf2<string> | CollectionIteratorOf1<string> | EmptyCollectionIterator {
