...
/** A class to test the functionality of a {@link ArrayAsCollectionHolder} */
export class CollectionHolder_AdaptorOfArray<const T, >
    extends AbstractCollectionHolderForTest<T> {

    //#region -------------------- Fields --------------------

    /** The internal instance that is tested */
    public readonly instance: ArrayAsCollectionHolder<T>

    /** The {@link CollectionHolder_AdaptorOfArray.array array} encapsulated in a {@link Proxy} */
    ...
    public constructor(/** The array received in the constructor */ public readonly array: Array<T>,) {
        ...
        this.instance = new class CollectionHolder_CountingGetByArrayAdaptor
            extends ArrayAsCollectionHolder<T> {


            protected override get _reference(): Array<T> {
    ...
    public override firstIndexOf(element: T, from?: NullableNumber, to?: NullableNumber,): number { return this.instance.indexOf(element, from, to,) }
    public override firstIndexOfOrNull(element: T, from?: NullableNumber, to?: NullableNumber,): NullOrNumber { return this.instance.indexOfOrNull(element, from, to,) }
