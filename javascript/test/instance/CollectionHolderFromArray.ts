...
export class CollectionHolderFromArray<const T, >
    ...
    readonly #isEmpty
    readonly #isNotEmpty
    readonly #hasExactly1Element
    readonly #hasAtMost1Element
    readonly #hasAtLeast2Elements
    readonly #hasExactly2Elements
    readonly #hasAtMost2Elements

    public constructor(/** The array received in the constructor */ public readonly array: Array<T>,) {
        super()
        const size = this.#size = array.length
        this.#isEmpty = size === 0
    ...
    public override getFirst(): T {
        ...
        if (0 in array)
            return array[0]
        throw new Error(`The method “getFirst” was attempting to retrieve a non-existant value)`,)
    }

    public override getLast(): T {
        const array = this.array
        const lastIndex = this.#size - 1
        if (lastIndex in array)
            return array[lastIndex] as T
        throw new Error(`The method “getLast” was attempting to retrieve a non-existant value)`,)
    }
