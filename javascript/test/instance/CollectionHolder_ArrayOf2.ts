 ...
 */
export class CollectionHolder_ArrayOf2<const T,
    const T1 extends T = T,
    const T2 extends T = T, >
    extends AbstractCollectionHolderForTest<T> {

    /** The internal instance that is tested */
    public readonly instance: ArrayOf2AsCollectionHolder<T, T1, T2>

    public readonly array: readonly [T1, T2,]
    ...
    public constructor(public readonly value1: T1, public readonly value2: T2,) {
        ...
        this.instance = new class CollectionHolder_CountingGetOnLazyOf1Or2
            extends ArrayOf2AsCollectionHolder<T, T1, T2> {
