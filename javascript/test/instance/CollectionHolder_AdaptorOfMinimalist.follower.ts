...
/**
 * An inherited instance of {@link MinimalistAsCollectionHolder}
 * made to have the followed methods based on the specific non-aliased method
 */
export class CollectionHolder_AdaptorOfMinimalistFollower
    extends MinimalistAsCollectionHolder<string>
    ...
    public constructor() { super(new MinimalistCollectionHolderFromArray(ABCD,),) }
