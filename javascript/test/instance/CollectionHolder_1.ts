...
import type {Array, MutableNumberKeyMap, MutableSet, Nullable, NullableNumber, NullableString, NullOr, NullOrZeroNumber, NumberArray, NumberKeyMap, NumberSet, Set} from "@joookiwi/type"
...
/**
 * A class to test the functionality of a {@link CollectionHolderOf1}
 *
...
export class CollectionHolder_1<const T, >
    ...
    public readonly instance: CollectionHolderOf1<T>

    public constructor(public readonly value: T,) {
        super()
        const $this = this
        this.instance = new class CollectionHolder_CountingGetOn1
    ...
    public override toMutableMap(): MutableNumberKeyMap<T, 0> { return this.instance.toMutableMap() }
