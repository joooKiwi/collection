...
/**
 * An inherited instance of {@link ArrayOf2AsCollectionHolder}
 * made to have the followed methods based on the specific non-aliased method
 */
export class CollectionHolder_ArrayOf2Follower
    extends ArrayOf2AsCollectionHolder<string, string>
    ...
    public override get<const I extends number, >(index: I,): DoubleValueFromIndex<I, string, string>
    ...
    public override getOrElse<const U, const I extends number, >(index: I, defaultValue: IndexWithReturnCallback<U>,): DoubleValueFromIndexOrElse<I, string, string, U>
