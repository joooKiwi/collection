...
/**
 * An inherited instance of {@link JsIteratorAsCollectionHolder}
 * made to have the followed methods based on the specific non-aliased method
 */
export class CollectionHolder_AdaptorOfJsIteratorFollower
    extends JsIteratorAsCollectionHolder<string>
    ...
    public constructor() { super(ABCD[Symbol.iterator](),) }
