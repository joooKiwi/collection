...
/**
 * An inherited instance of {@link JsIterableAsCollectionHolder}
 * made to have the followed methods based on the specific non-aliased method
 */
export class CollectionHolder_AdaptorOfJsIterableFollower
    extends JsIterableAsCollectionHolder<string>
