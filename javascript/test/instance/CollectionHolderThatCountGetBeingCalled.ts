...
import {toMapByCollectionHolder, toMapByMinimalistCollectionHolder}                                     from "../../src/method/toMap"
import {toMutableArrayByCollectionHolder, toMutableArrayByMinimalistCollectionHolder}                   from "../../src/method/toMutableArray"
import {toMutableMapByCollectionHolder, toMutableMapByMinimalistCollectionHolder}                       from "../../src/method/toMutableMap"
...
export class CollectionHolderThatCountGetBeingCalled<const out T, >
    ...
    public toLocaleString(locale?: NullableString,): string {
        return this.#isCollectionHolder
            ...
            : toLocaleStringByMinimalistCollectionHolder(this, locale,)
    }
    ...
    public toLocaleLowerCaseString(locale?: NullableString,): string {
        return this.#isCollectionHolder
            ...
            : toLocaleLowerCaseStringByMinimalistCollectionHolder(this, locale,)
    }
    ...
    public toLocaleUpperCaseString(locale?: NullableString,): string {
        return this.#isCollectionHolder
            ...
            : toLocaleUpperCaseStringByMinimalistCollectionHolder(this, locale,)
    }
