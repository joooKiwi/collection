...
export class CollectionHolder_FromUndefinedMinimalistExtensionFunction<const T, >
    ...
    public override get hasExactly1Element(): false {
        return hasExactly1ElementByMinimalistCollectionHolder(undefined,)
    }

    public override get hasAtMost1Element(): true {
        return hasAtMost1ElementByMinimalistCollectionHolder(undefined,)
    }


    public override get hasAtLeast2Elements(): boolean {
        return hasAtLeast2ElementsByMinimalistCollectionHolder(undefined,)
    }

    public override get hasExactly2Elements(): false {
        return hasExactly2ElementsByMinimalistCollectionHolder(undefined,)
    }

    public override get hasAtMost2Elements(): true {
        return hasAtMost2ElementsByMinimalistCollectionHolder(undefined,)
    }
