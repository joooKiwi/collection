 ...
 * @typeParam T The type
  */
export class CollectionHolder_ByViewer<const T, >
    extends AbstractCollectionHolderForTest<T> {

    /** The internal instance that is tested */
    public readonly instance: CollectionViewer<T, CollectionHolderFromArray<T>>
    ...
    public constructor(/** The array received in the constructor */ public readonly array: Array<T>,) {
        super()
        const $this = this
        this.instance = new class CollectionHolder_CountingGetByViewer
            extends CollectionViewer<T, CollectionHolderFromArray<T>> {
