...
/**
 * An inherited instance of {@link SetAsCollectionHolder}
 * made to have the followed methods based on the specific non-aliased method
 */
export class CollectionHolder_AdaptorOfSetFollower
    extends SetAsCollectionHolder<string>
    ...
    public constructor() { super(new Set(ABCD,),) }
