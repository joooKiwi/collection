...
describe("CollectionHolderTest (drop)", () => {
    ...
    describe("aliases", () => {
        ...
        describe("ArrayOf1AsCollectionHolder", () => {
            test("dropLast",             () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.dropLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("dropLastWhile",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.dropLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("dropLastWhileIndexed", () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.dropLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("skipLast",             () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.skipLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("skipLastWhile",        () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.skipLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("skipLastWhileIndexed", () => expect(new CollectionHolder_ArrayOf1Follower().execute(it => it.skipLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("CollectionHolderOf1", () => {
            test("dropLast",             () => expect(new CollectionHolder_1Follower().execute(it => it.dropLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("dropLastWhile",        () => expect(new CollectionHolder_1Follower().execute(it => it.dropLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("dropLastWhileIndexed", () => expect(new CollectionHolder_1Follower().execute(it => it.dropLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("skipLast",             () => expect(new CollectionHolder_1Follower().execute(it => it.skipLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("skipLastWhile",        () => expect(new CollectionHolder_1Follower().execute(it => it.skipLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("skipLastWhileIndexed", () => expect(new CollectionHolder_1Follower().execute(it => it.skipLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("LazyCollectionHolderOf1", () => {
            test("dropLast",             () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.dropLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("dropLastWhile",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.dropLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("dropLastWhileIndexed", () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.dropLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("skipLast",             () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.skipLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("skipLastWhile",        () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.skipLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("skipLastWhileIndexed", () => expect(new CollectionHolder_LazyOf1Follower().execute(it => it.skipLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
        },)
        ...
        describe("SetOf1AsCollectionHolder", () => {
            test("dropLast",             () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.dropLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("dropLastWhile",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.dropLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("dropLastWhileIndexed", () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.dropLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
            ...
            test("skipLast",             () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.skipLast(0,),)                           .drop_amountOfCall,)            .toBe(1,),)
            test("skipLastWhile",        () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.skipLastWhile(callbackAsFalse0,),)       .dropWhile_amountOfCall,)       .toBe(1,),)
            test("skipLastWhileIndexed", () => expect(new CollectionHolder_SetOf1Follower().execute(it => it.skipLastWhileIndexed(callbackAsFalse0,),).dropWhileIndexed_amountOfCall,).toBe(1,),)
        },)
    ...
    describe("get() being called", () => {
        ...
        describe("empty ~ collection (by minimalist)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
        },)
        describe("empty ~ collection (by normal)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(0,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(T) → boolean",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → boolean", () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail2,),) .amountOfCall,).toBe(0,),)
                test("(number) → boolean",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail1,),) .amountOfCall,).toBe(0,),)
                test("() → boolean",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(EMPTY,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFail0,),) .amountOfCall,).toBe(0,),)
            },)
        },)

        describe("1 field ~ collection (by minimalist)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(1,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(0,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(1,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(0,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
        },)
        describe("1 field ~ collection (by normal)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(1,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(0,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(1,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(0,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(1,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(1,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(1,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(1,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(A,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(1,),)
            },)
        },)

        describe("2 fields ~ collection (by minimalist)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(2,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(0,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.drop(3,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(2,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(0,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(3,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
        },)
        describe("2 fields ~ collection (by normal)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(2,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(0,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.drop(3,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(2,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(1,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(0,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLast(3,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(2,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(2,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(2,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(2,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(AB,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(2,),)
            },)
        },)

        describe("N fields ~ collection (by minimalist)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(4,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(3,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(3,),).amountOfCall,).toBe(1,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(4,),).amountOfCall,).toBe(0,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(5,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(4,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(3,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(3,),).amountOfCall,).toBe(1,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(4,),).amountOfCall,).toBe(0,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(5,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnMinimalist(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
        },)
        describe("N fields ~ collection (by normal)", () => {
            describe("drop", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(0,),).amountOfCall,).toBe(4,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(1,),).amountOfCall,).toBe(3,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(3,),).amountOfCall,).toBe(1,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(4,),).amountOfCall,).toBe(0,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.drop(5,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhile(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
            describe("dropWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)

            describe("dropLast", () => {
                test('0', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(0,),).amountOfCall,).toBe(4,),)
                test('1', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(1,),).amountOfCall,).toBe(3,),)
                test('2', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(2,),).amountOfCall,).toBe(2,),)
                test('3', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(3,),).amountOfCall,).toBe(1,),)
                test('4', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(4,),).amountOfCall,).toBe(0,),)
                test('5', () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLast(5,),).amountOfCall,).toBe(0,),)
            },)
            describe("dropLastWhile", () => {
                test("(T, number) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(T) → true",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue1,),) .amountOfCall,).toBe(4,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(T, number) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(T) → false",         () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhile(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
            describe("dropLastWhileIndexed", () => {
                test("(number, T) → true",  () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue2,),) .amountOfCall,).toBe(4,),)
                test("(number) → true",     () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue1,),) .amountOfCall,).toBe(0,),)
                test("() → true",           () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsTrue0,),) .amountOfCall,).toBe(0,),)
                test("(number, T) → false", () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse2,),).amountOfCall,).toBe(4,),)
                test("(number) → false",    () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse1,),).amountOfCall,).toBe(4,),)
                test("() → false",          () => expect(new CollectionHolder_GetBeingCalledOnNormal(ABCD,).executeWhileHavingIndexesOnField(it => it.dropLastWhileIndexed(callbackAsFalse0,),).amountOfCall,).toBe(4,),)
            },)
        },)
