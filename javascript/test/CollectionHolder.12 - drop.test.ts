...
import {LazyCollectionHolder_DropAlias}                                                                                                                                                                                                                                                                                                                                                             from "./instance/LazyCollectionHolder_DropAlias"
import {LazyCollectionHolder_DropLastAlias}                                                                                                                                                                                                                                                                                                                                                         from "./instance/LazyCollectionHolder_DropLastAlias"
import {LazyCollectionHolder_DropLastWhileAlias}                                                                                                                                                                                                                                                                                                                                                    from "./instance/LazyCollectionHolder_DropLastWhileAlias"
import {LazyCollectionHolder_DropLastWhileIndexedAlias}                                                                                                                                                                                                                                                                                                                                             from "./instance/LazyCollectionHolder_DropLastWhileIndexedAlias"
import {LazyCollectionHolder_DropWhileAlias}                                                                                                                                                                                                                                                                                                                                                        from "./instance/LazyCollectionHolder_DropWhileAlias"
import {LazyCollectionHolder_DropWhileIndexedAlias}                                                                                                                                                                                                                                                                                                                                                 from "./instance/LazyCollectionHolder_DropWhileIndexedAlias"
...
describe("CollectionHolderTest (drop)", () => {
    ...
    describe("aliases", () => {
        ...
        describe("LazyCollectionHolder", () => {
            test("skip",                 () => expect(new LazyCollectionHolder_DropAlias()                .execute(it => it.skip(0,),)                              .amountOfCall,).toBe(1,),)
            test("skipWhile",            () => expect(new LazyCollectionHolder_DropWhileAlias()           .execute(it => it.skipWhile(callbackAsTrue0,),)           .amountOfCall,).toBe(1,),)
            test("skipWhileIndexed",     () => expect(new LazyCollectionHolder_DropWhileIndexedAlias()    .execute(it => it.skipWhileIndexed(callbackAsTrue0,),)    .amountOfCall,).toBe(1,),)
            test("skipLast",             () => expect(new LazyCollectionHolder_DropLastAlias()            .execute(it => it.skipLast(0,),)                          .amountOfCall,).toBe(1,),)
            test("skipLastWhile",        () => expect(new LazyCollectionHolder_DropLastWhileAlias()       .execute(it => it.skipLastWhile(callbackAsTrue0,),)       .amountOfCall,).toBe(1,),)
            test("skipLastWhileIndexed", () => expect(new LazyCollectionHolder_DropLastWhileIndexedAlias().execute(it => it.skipLastWhileIndexed(callbackAsTrue0,),).amountOfCall,).toBe(1,),)
        },)
