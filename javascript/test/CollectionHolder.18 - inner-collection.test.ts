...
describe("CollectionHolderTest (inner-collection)", () => {
    ...
    describe("LazyCollectionHolder", () => {
        ...
        describe('3', () => {
            ...
            test("collection holder (by structure)",                 () => expect(new LazyCollectionHolder_InnerCollectionTest(new CollectionHolder_ByStructure(ABC,),)                .innerCollection,).toBeInstanceOf(CollectionHolderFromArray,),)
            ...
            test("late collection holder (by structure)",            () => expect(new LazyCollectionHolder_InnerCollectionTest(() => new CollectionHolder_ByStructure(ABC,),)          .innerCollection,).toBeInstanceOf(CollectionHolderFromArray,),)
        ...
        describe('4', () => {
            ...
            test("collection holder (by structure)",                 () => expect(new LazyCollectionHolder_InnerCollectionTest(new CollectionHolder_ByStructure(ABCD,),)                .innerCollection,).toBeInstanceOf(CollectionHolderFromArray,),)
            ...
            test("late collection holder (by structure)",            () => expect(new LazyCollectionHolder_InnerCollectionTest(() => new CollectionHolder_ByStructure(ABCD,),)          .innerCollection,).toBeInstanceOf(CollectionHolderFromArray,),)
