 ...
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiPredicate.html Java BiPredicate&lt;T, Integer&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Predicate.html Java Predicate&lt;T&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BooleanSupplier.html Java BooleanSupplier
 ...
 * @see RestrainedBooleanCallback
 * @see ReverseRestrainedBooleanCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiPredicate.html Java BiPredicate&lt;Integer, U&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/IntPredicate.html Java IntPredicate
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BooleanSupplier.html Java BooleanSupplier
 ...
 * @see ReverseBooleanCallback
 * @see ReverseRestrainedBooleanCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiFunction.html Java BiFunction&lt;T, U, R&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Predicate.html Java Predicate&lt;T&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BooleanSupplier.html Java BooleanSupplier
 * @see https://learn.microsoft.com/dotnet/api/system.func-3 C# Func&lt;T, int, bool&gt;
 * @see https://learn.microsoft.com/dotnet/api/system.func-2 C# Func&lt;T, bool&gt;
 ...
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Supplier.html Java Supplier&lt;R&gt;
 ...
 * @see ValueIndexWithReturnCallback
 * @see IndexValueWithReturnCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/IntFunction.html Java IntFunction&lt;R&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Supplier.html Java Supplier&lt;R&gt;
 ...
 * @see ValueIndexWithReturnCallback
 * @see IndexValueWithReturnCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/ObjIntConsumer.html Java ObjIntConsumer&lt;T&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Consumer.html Java Consumer&lt;T&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/lang/Runnable.html Java Runnable
 ...
 * @see ValueIndexWithReturnCallback
 * @see IndexValueWithReturnCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiConsumer.html Java BiConsumer&lt;Integer, T&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/IntConsumer.html Java IntConsumer
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/lang/Runnable.html Java Runnable
 ...
 * @see IndexValueCallback
 * @see IndexValueWithReturnCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiFunction.html Java BiFunction&lt;T, Integer, R&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Function.html Java Function&lt;T, R&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Supplier.html Java Supplier&lt;T&gt;
 ...
 * @see ValueIndexWithReturnCallback
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiFunction.html Java BiFunction&lt;T, U, R&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/IntFunction.html Java IntFunction
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Supplier.html Java Supplier&lt;T&gt;
 ...
 *
 * @note The arguments are optionals
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/BiFunction.html Java BiFunction&lt;T, Integer, String&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Function.html Java Function&lt;T, String&gt;
 * @see https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/util/function/Supplier.html Java Supplier&lt;String&gt;
