...
/**
 * A {@link CollectionHolder} having a {@link CollectionIterator} value associated to it, but lazily retrieved.
...
export class LazyIteratorAsCollectionHolder<const T = unknown,
    ...
    #lateIterator: () => REFERENCE
    #innerCollection?: IteratorAsCollectionHolder<T, REFERENCE>

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public constructor(lateIterator: () => & CollectionIterator<T> & REFERENCE,)
    public constructor(lateIterator: () => REFERENCE,) {
        super()
        this.#lateIterator = lateIterator
    }
     ...
     */
    protected get _innerCollection(): IteratorAsCollectionHolder<T, REFERENCE> {
        const value = this.#innerCollection
        if (value != null)
            return value

        const lateIterator = this.#lateIterator()
        this.#lateIterator = FAIL_CALLBACK // We do not need the callback anymore once the value has been retrieved
        return this.#innerCollection = new IteratorAsCollectionHolder(lateIterator,)
    }
    ...
    public override get isEmpty(): REFERENCE["isEmpty"] { return this._innerCollection.isEmpty }

    public override get isNotEmpty(): REFERENCE["isNotEmpty"] { return this._innerCollection.isNotEmpty }

    public override get hasExactly1Element(): REFERENCE["hasExactly1Element"] { return this._innerCollection.hasExactly1Element }

    public override get hasAtMost1Element(): REFERENCE["hasAtMost1Element"] { return this._innerCollection.hasAtMost1Element }

    public override get hasAtLeast2Elements(): REFERENCE["hasAtLeast2Elements"] { return this._innerCollection.hasAtLeast2Elements }

    public override get hasExactly2Elements(): REFERENCE["hasExactly2Elements"] { return this._innerCollection.hasExactly2Elements }

    public override get hasAtMost2Elements(): REFERENCE["hasAtMost2Elements"] { return this._innerCollection.hasAtMost2Elements }
