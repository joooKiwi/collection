 ...
 */
export class LazyMinimalistAsCollectionHolder<const T = unknown,
    ...
    #lateMinimalistCollectionHolder: () => REFERENCE
    #innerCollection?: MinimalistAsCollectionHolder<T, REFERENCE>

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public constructor(lateMinimalistCollectionHolder: () => & MinimalistCollectionHolder<T> & REFERENCE,)
    public constructor(lateMinimalistCollectionHolder: () => REFERENCE,) {
        super()
        this.#lateMinimalistCollectionHolder = lateMinimalistCollectionHolder
    }
     ...
     */
    protected get _innerCollection(): MinimalistAsCollectionHolder<T, REFERENCE> {
        const value = this.#innerCollection
        if (value != null)
            return value

        const lateMinimalistCollectionHolder = this.#lateMinimalistCollectionHolder()
        this.#lateMinimalistCollectionHolder = FAIL_CALLBACK // We do not need the callback anymore once the value has been retrieved
        return this.#innerCollection = new MinimalistAsCollectionHolder(lateMinimalistCollectionHolder,)
    }
