 ...
 * @extensionFunction
 */
export function filterNotIndexed<const T, const S extends T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * <b>not</b> matching the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filterNotIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>,): CollectionHolder<T>
export function filterNotIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>,) {
    if (collection == null)
 ...
 * @extensionFunction
 */
export function filterNotIndexedByArray<const T, const S extends T, >(collection: Nullable<Array<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * <b>not</b> matching the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filterNotIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>,): CollectionHolder<T>
export function filterNotIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>,) {
    if (collection == null)
        return EmptyCollectionHolder.get
