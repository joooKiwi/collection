 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedOrNull<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,): NullOrNumber {
    if (collection == null)
        return null
    if (to == null)
        if (from == null)
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedOrNullByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,): NullOrNumber {
    if (collection == null)
        return null
    if (to == null)
        if (from == null)
...
function __core0ByArray<const T, >(collection: Array<T>, predicate: ReverseBooleanCallback<T>,): NullOrNumber {
