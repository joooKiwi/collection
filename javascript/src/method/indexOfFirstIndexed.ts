 ...
 * @extensionFunction
 */
export function indexOfFirstIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | readonly T[]>, predicate: ReverseBooleanCallback<T>,): number
/**
 * Get the first index matching the {@link predicate}
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | readonly T[]>, predicate: ReverseBooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the first index matching the {@link predicate}
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | readonly T[]>, predicate: ReverseBooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfFirstIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | readonly T[]>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting index} and the end of the {@link collection}
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting} and the {@link to ending} index
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfFirstIndexedByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
        throw new NullCollectionException()
    if (to == null)
        if (from == null)
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting index} and the end of the {@link collection}
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting} and the {@link to ending} index
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstIndexedByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfFirstIndexedByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
        throw new NullCollectionException()
    if (to == null)
        if (from == null)
...
function __core0<const T, >(collection: | MinimalistCollectionHolder<T> | readonly T[], predicate: ReverseBooleanCallback<T>,): number {
...
function __core1<const T, >(collection: | MinimalistCollectionHolder<T> | readonly T[], predicate: ReverseBooleanCallback<T>, from: number,): number {
    if (isCollectionHolder<T>(collection,))
        return __core1ByCollectionHolder(collection, predicate, from,)
    if (isArray(collection,))
        return __core1ByArray(collection, predicate, from,)
...
function __core2<const T, >(collection: | MinimalistCollectionHolder<T> | readonly T[], predicate: ReverseBooleanCallback<T>, from: number, to: number,): number {
    if (isCollectionHolder<T>(collection,))
        return __core2ByCollectionHolder(collection, predicate, from, to,)
    if (isArray(collection,))
        return __core2ByArray(collection, predicate, from, to,)
...
function __coreWithNoFrom<const T, >(collection: | MinimalistCollectionHolder<T> | readonly T[], predicate: ReverseBooleanCallback<T>, to: number,): number {
    if (isCollectionHolder<T>(collection,))
        return __coreWithNoFromByCollectionHolder(collection, predicate, to,)
    if (isArray(collection,))
        return __coreWithNoFromByArray(collection, predicate, to,)
