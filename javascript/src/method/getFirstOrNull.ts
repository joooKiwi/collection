 ...
 * @extensionFunction
 */
export function getFirstOrNull<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>,): NullOr<T> {
    if (collection == null)
        return null
 ...
 * @extensionFunction
 */
export function getFirstOrNullByArray<const T, >(collection: Nullable<Array<T>>,): NullOr<T> {
    if (collection == null)
        return null
