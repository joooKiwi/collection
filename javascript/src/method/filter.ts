 ...
 * @extensionFunction
 */
export function filter<const T, const S extends T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: RestrainedBooleanCallback<T, S>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * matching only the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filter<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: BooleanCallback<T>,): CollectionHolder<T>
export function filter<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: BooleanCallback<T>,) {
    if (collection == null)
