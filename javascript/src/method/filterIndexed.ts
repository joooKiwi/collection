 ...
 * @extensionFunction
 */
export function filterIndexed<const T, const S extends T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>, constructorInstance?: Nullable<CollectionHolderConstructor<T>>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * matching only the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filterIndexed<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, constructorInstance?: Nullable<CollectionHolderConstructor<T>>,): CollectionHolder<T>
export function filterIndexed<const T, const S extends T, >(collection: Nullable<CollectionHolder<T>>, predicate: | ReverseRestrainedBooleanCallback<T, S> | ReverseBooleanCallback<T>, constructorInstance: Nullable<CollectionHolderConstructor<T>> = null,) {
    if (collection == null)
