 ...
 * @extensionFunction
 */
export function indexOfLastIndexed<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>, fromIndex: Nullable<number> = null, toIndex: Nullable<number> = null, limit: Nullable<number> = null,): NullOr<number> {
