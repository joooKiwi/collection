 ...
 * @extensionFunction
 */
export function indexOfLastIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>,): number
/**
 * Get the last index matching the {@link predicate}
 ...
 * @extensionFunction
 */
export function indexOfLastIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the last index matching the {@link predicate}
 * between the {@link from starting} and the {@link to ending} index
 *
 ...
 * @extensionFunction
 */
export function indexOfLastIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfLastIndexed<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
 ...
 * @extensionFunction
 */
export function indexOfLastIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>,): number
/**
 * Get the last index matching the {@link predicate}
 * between the {@link from starting index} and the end of the {@link collection}
 *
 ...
 * @extensionFunction
 */
export function indexOfLastIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the last index matching the {@link predicate}
 * between the {@link from starting} and the {@link to ending} index
 *
 ...
 * @extensionFunction
 */
export function indexOfLastIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfLastIndexedByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
        throw new NullCollectionException()
    if (to == null)
        if (from == null)
