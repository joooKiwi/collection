 ...
 * @extensionFunction
 */
export function hasNotOneWithIterable<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, values: Nullable<Iterable<T, unknown, unknown>>,): boolean {
    if (collection == null)
        return true
 ...
 * @extensionFunction
 */
export function hasNotOneWithIterableByArray<const T, >(collection: Nullable<Array<T>>, values: Nullable<Iterable<T, unknown, unknown>>,): boolean {
    if (collection == null)
        return true
