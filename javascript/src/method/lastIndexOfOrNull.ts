 ...
 * @extensionFunction
 */
export function lastIndexOfOrNull<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, element: T, from: NullableNumber = null, to: NullableNumber = null,): NullOrNumber {
    if (collection == null)
        return null
    if (to == null)
        if (from == null)
 ...
 * @extensionFunction
 */
export function lastIndexOfOrNullByArray<const T, >(collection: Nullable<Array<T>>, element: T, from: NullableNumber = null, to: NullableNumber = null,): NullOrNumber {
    if (collection == null)
        return null
    if (to == null)
        if (from == null)
