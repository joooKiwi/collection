 ...
 * @extensionFunction
 */
export function hasOneWithIterator<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, values: Nullable<Iterator<T, unknown, unknown>>,): boolean {
    if (collection == null)
        return false
 ...
 * @extensionFunction
 */
export function hasOneWithIteratorByArray<const T, >(collection: Nullable<Array<T>>, values: Nullable<Iterator<T, unknown, unknown>>,): boolean {
    if (collection == null)
        return false
