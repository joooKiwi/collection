 ...
 * @extensionFunction
 */
export function findLastIndexed<const T, const S extends T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>,): NullOr<S>
/**
 * Get the last element found or <b>null</b> if nothing was found
 *
 * @param collection The {@link Nullable nullable} {@link SimplisticCollectionHolder collection}
 ...
 * @extensionFunction
 */
export function findLastIndexed<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>,): NullOr<T>
export function findLastIndexed<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: ReverseBooleanCallback<T>,): NullOr<T> {
    if (collection == null)
        return null
