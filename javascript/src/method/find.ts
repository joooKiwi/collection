 ...
 * @extensionFunction
 */
export function find<const T, const S extends T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: RestrainedBooleanCallback<T, S>,): NullOr<S>
/**
 * Get the first element found or <b>null</b> if nothing was found
 *
 * @param collection The {@link Nullable nullable} {@link SimplisticCollectionHolder collection}
 ...
 * @extensionFunction
 */
export function find<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: BooleanCallback<T>,): NullOr<T>
export function find<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, predicate: BooleanCallback<T>,): NullOr<T> {
    if (collection == null)
        return null
