 ...
 * @extensionFunction
 */
export function lastIndexOf<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, element: T, fromIndex?: Nullable<number>, toIndex?: Nullable<number>, limit?: Nullable<number>,): NullOr<number>
/**
 * Get the <b>last</b> occurrence equivalent to the value received
 * or <b>null</b> if it was not in the current {@link collection}
 * from a range (if provided)
 ...
 * @extensionFunction
 */
export function lastIndexOf<const T, >(collection: Nullable<SimplisticCollectionHolder<T>>, element: unknown, fromIndex?: Nullable<number>, toIndex?: Nullable<number>, limit?: Nullable<number>,): NullOr<number>
export function lastIndexOf(collection: Nullable<SimplisticCollectionHolder>, element: unknown, fromIndex: Nullable<number> = null, toIndex: Nullable<number> = null, limit: Nullable<number> = null,): NullOr<number> {
