...
function __coreByMinimalistCollectionHolder<const T, >(collection: MinimalistCollectionHolder<T>, n: number,) {
    ...
    if (n > 0)
        if (n >= size)
            ...
            return new LazyArrayAsCollectionHolder(() => __getAll(collection, n,),)
    if (n <= -size)
        return EmptyCollectionHolder.get
    ...
    if (size === 2)
        return new LazyCollectionHolderOf2(() => new Couple(collection.get(0,), collection.get(1,),),)
    return new LazyArrayAsCollectionHolder(() => __getAll(collection, n2,),)
}
...
function __coreByCollectionHolder<const T, >(collection: CollectionHolder<T>, n: number,) {
    ...
    if (collection.hasExactly1Element)
        ...
        return new LazyCollectionHolderOf2(() => new Couple(collection.getFirst(), collection.getLast(),),)
    return new LazyArrayAsCollectionHolder(() => __getAll(collection, n + size,),)
}
...
function __coreByArray<const T, >(collection: Array<T>, n: number,) {
    ...
    if (n > 0)
        if (n >= size)
            ...
            return new LazyArrayAsCollectionHolder(() => __getAllByArray(collection, n,),)
    if (n <= -size)
        return EmptyCollectionHolder.get
    ...
    if (size === 2)
        return new LazyCollectionHolderOf2(() => new Couple(collection[0] as T, collection[1] as T,),)
    return new LazyArrayAsCollectionHolder(() => __getAllByArray(collection, n + size,),)
}
