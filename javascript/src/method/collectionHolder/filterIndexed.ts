...
import {__with0Argument, __with1Argument, __with2Argument} from "../filterIndexed"
...
export function filterIndexed<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: ReverseBooleanCallback<T>,) {
    if (collection == null)
