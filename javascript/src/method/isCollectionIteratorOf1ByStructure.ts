...
import type {KeyOfCollectionIteratorOf1} from "../type/keyOf"

/**
 * Tell that the value has the structure of a {@link CollectionIteratorOf1}
 *
 * @param value The value to identity
 * @see isCollectionIteratorOf1
 * @see MembersConstants.COLLECTION_ITERATOR_OF_1_MEMBERS
 * @doesNotValidateTheTypes
 */
export function isCollectionIteratorOf1ByStructure(value: unknown,): value is (& object & Record<KeyOfCollectionIteratorOf1, unknown>)
/**
 * Tell that the value has the structure of a {@link CollectionIteratorOf1}
 *
 * @param value The value to identity
 ...
 */
export function isCollectionIteratorOf1ByStructure<const T, const INSTANCE extends CollectionIteratorOf1<T> = CollectionIteratorOf1<T>, >(value: unknown,): value is INSTANCE
export function isCollectionIteratorOf1ByStructure(value: unknown,): boolean {
    if (value == null)
        return false
