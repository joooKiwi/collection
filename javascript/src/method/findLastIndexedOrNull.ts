 ...
 * @extensionFunction
 */
export function findLastIndexedOrNull<const T, const S extends T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>,): NullOr<S>
/**
 * Find the last element from the {@link predicate} in the {@link collection}
 * or <b>null</b> otherwise
 *
 ...
 * @extensionFunction
 */
export function findLastIndexedOrNull<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>,): NullOr<T>
export function findLastIndexedOrNull<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: ReverseBooleanCallback<T>,) {
    if (collection == null)
        return null
 ...
 * @extensionFunction
 */
export function findLastIndexedOrNullByArray<const T, const S extends T, >(collection: Nullable<Array<T>>, predicate: ReverseRestrainedBooleanCallback<T, S>,): NullOr<S>
/**
 * Find the last element from the {@link predicate} in the {@link collection}
 * or <b>null</b> otherwise
 *
 ...
 * @extensionFunction
 */
export function findLastIndexedOrNullByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>,): NullOr<T>
export function findLastIndexedOrNullByArray<const T, >(collection: Nullable<Array<T>>, predicate: ReverseBooleanCallback<T>,) {
    if (collection == null)
        return null
