 ...
 * @extensionFunction
 */
export function hasNotAllWithCollectionHolder<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, values: Nullable<CollectionHolder<T>>,): boolean {
 ...
 * @extensionFunction
 */
export function hasNotAllWithCollectionHolderByArray<const T, >(collection: Nullable<Array<T>>, values: Nullable<CollectionHolder<T>>,): boolean {
    if (values == null)
        return false
    if (values.isEmpty)
        return false
