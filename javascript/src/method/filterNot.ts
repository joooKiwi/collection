 ...
 * @extensionFunction
 */
export function filterNot<const T, const S extends T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: RestrainedBooleanCallback<T, S>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * __NOT__ matching the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filterNot<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>,): CollectionHolder<T>
export function filterNot<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>,) {
    if (collection == null)
...
export function filterNotByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: BooleanCallback<T>,) {
    ...
    if (predicate.length === 1)
        return new LazyArrayAsCollectionHolder(() => __with1Argument(collection, predicate as (value: T,) => boolean, size,),)
...
export function filterNotByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: BooleanCallback<T>,) {
    ...
    if (collection.isEmpty)
        return EmptyCollectionHolder.get
    if (predicate.length === 1)
        return new LazyArrayAsCollectionHolder(() => __with1Argument(collection, predicate as (value: T,) => boolean, collection.size,),)
    if (predicate.length >= 2)
 ...
 * @extensionFunction
 */
export function filterNotByArray<const T, const S extends T, >(collection: Nullable<Array<T>>, predicate: RestrainedBooleanCallback<T, S>,): CollectionHolder<S>
/**
 * Get a new {@link CollectionHolder}
 * __NOT__ matching the given {@link predicate}
 *
 ...
 * @extensionFunction
 */
export function filterNotByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>,): CollectionHolder<T>
export function filterNotByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>,) {
    if (collection == null)
        return EmptyCollectionHolder.get
    ...
    if (size === 0)
        return EmptyCollectionHolder.get
    if (predicate.length === 1)
        return new LazyArrayAsCollectionHolder(() => __with1ArgumentByArray(collection, predicate as (value: T,) => boolean, size,),)
    if (predicate.length >= 2)
