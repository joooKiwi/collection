 ...
 * @extensionFunction
 */
export function indexOfFirst<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>,): number
/**
 * Get the first index matching the {@link predicate}
 ...
 * @extensionFunction
 */
export function indexOfFirst<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the first index matching the {@link predicate}
 ...
 * @extensionFunction
 */
export function indexOfFirst<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfFirst<const T, >(collection: Nullable<| MinimalistCollectionHolder<T> | CollectionHolder<T> | Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
...
export function indexOfFirstByMinimalistCollectionHolder<const T, >(collection: Nullable<MinimalistCollectionHolder<T>>, predicate: BooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
        throw new NullCollectionException()
    if (to == null)
        if (from == null)
 ...
 * @extensionFunction
 */
export function indexOfFirstByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting index} and the end of the {@link collection}
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber,): number
/**
 * Get the first index matching the {@link predicate}
 * between the {@link from starting} and the {@link to ending} index
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber, to: NullableNumber,): number
export function indexOfFirstByArray<const T, >(collection: Nullable<Array<T>>, predicate: BooleanCallback<T>, from: NullableNumber = null, to: NullableNumber = null,) {
    if (collection == null)
        throw new NullCollectionException()
    if (to == null)
        if (from == null)
...
function __core0ByMinimalistCollectionHolder<const T, >(collection: MinimalistCollectionHolder<T>, predicate: BooleanCallback<T>,) {
...
function __core1ByMinimalistCollectionHolder<const T, >(collection: MinimalistCollectionHolder<T>, predicate: BooleanCallback<T>, from: number,) {
    const size = collection.size
    if (size === 0)
        throw new EmptyCollectionException()
    if (predicate.length === 1)
...
function __core1ByCollectionHolder<const T, >(collection: CollectionHolder<T>, predicate: BooleanCallback<T>, from: number,) {
    if (collection.isEmpty)
        throw new EmptyCollectionException()
...
function __core2ByMinimalistCollectionHolder<const T, >(collection: MinimalistCollectionHolder<T>, predicate: BooleanCallback<T>, from: number, to: number,) {
    const size = collection.size
    if (size === 0)
        throw new EmptyCollectionException()
...
function __core2ByCollectionHolder<const T, >(collection: CollectionHolder<T>, predicate: BooleanCallback<T>, from: number, to: number,) {
    if (collection.isEmpty)
        throw new EmptyCollectionException()
...
function __coreWithNoFromByMinimalistCollectionHolder<const T, >(collection: MinimalistCollectionHolder<T>, predicate: BooleanCallback<T>, to: number,) {
    const size = collection.size
    if (size === 0)
        throw new EmptyCollectionException()
    if (predicate.length === 1)
