 ...
 * @extensionFunction
 */
export function indexOfFirst<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: BooleanCallback<T>, fromIndex: Nullable<number> = null, toIndex: Nullable<number> = null,): NullOr<number> {
    if (collection == null)
        return null
