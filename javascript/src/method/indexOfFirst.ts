 ...
 * or <b>null</b> if it was not in the {@link MinimalistCollectionHolder collection}
...
/**
 * Get the first index matching the {@link predicate}
 * or <b>null</b> if it was not in the {@link CollectionHolder collection}
 * from a range (if provided)
 *
 ...
 * @extensionFunction
 */
export function indexOfFirstByCollectionHolder<const T, >(collection: Nullable<CollectionHolder<T>>, predicate: BooleanCallback<T>, fromIndex: Nullable<number> = null, toIndex: Nullable<number> = null, limit: Nullable<number> = null,): NullOr<number> {
    //#region -------------------- Early returns --------------------
