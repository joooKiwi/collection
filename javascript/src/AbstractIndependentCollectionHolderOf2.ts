 ...
 *
 * And it is independent of the children classes to avoid circular dependency.
 *
 * @typeParam T1 The 1st type (**mandatory**)
 * @typeParam T2 The 2nd type (**mandatory**)
 * @see AbstractCollectionHolderOf2
 * @see AbstractIndependentCollectionHolderOf1
 ...
 */
export abstract class AbstractIndependentCollectionHolderOf2<const T1,
    const T2, >
     ...
     */
    protected abstract _create1<const U, >(value: U,): CollectionHolderOf1<U>
     ...
     */
    protected abstract _createLazyArray(lateArray: () => Array<| T1 | T2>,): CollectionHolder<| T1 | T2>

    //#endregion -------------------- Create methods --------------------
    //#region -------------------- Value methods --------------------

    public override get 0(): T1 { return this.value1 }

    public override get 1(): T2 { return this.value2 }
