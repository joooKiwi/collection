...
/**
 * A {@link CollectionHolder} having a {@link Iterator Javascript Iterator} value associated to it, but lazily retrieved.
 ...
 * @typeParam REFERENCE The reference passed in the constructor (`Iterator<T, unknown, unknown>` by default)
 * @adaptor
 * @beta
 * @see JsIteratorAsCollectionHolder
 */
export class LazyJsIteratorAsCollectionHolder<const T = unknown,
    ...
    #innerCollection?: JsIteratorAsCollectionHolder<T, REFERENCE>

    //#endregion -------------------- Fields --------------------
    //#region -------------------- Constructor --------------------

    public constructor(lateIterator: () => & Iterator<T, unknown, unknown> & REFERENCE,)
     ...
     */
    protected get _innerCollection(): JsIteratorAsCollectionHolder<T, REFERENCE> {
        ...
        return this.#innerCollection = new JsIteratorAsCollectionHolder(lateIterator,)
    }
