...
import type {Array, Nullable, Set, UndefinedOr} from "@joookiwi/type"
...
export class SetOf2AsCollectionHolder<const T1 = unknown,
    ...
    public constructor(reference: & Set<| T1 | T2> & REFERENCE,)
    public constructor(reference: REFERENCE,) {
        ...
        const value1 = this.#value1 = iterator.next().value as T1
        const value2 = this.#value2 = iterator.next().value as T2
